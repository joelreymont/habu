...
: CA-JSON-EMPTY-FIELD ( ptr u8 n -- )
   JSON-WRITE:KEY s" " JSON-WRITE:STRING ;
...
: CA-JSON-DUP ( -- )
   ...
   s" repair_class" JSON-WRITE:KEY s" fix_source" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" verdict" JSON-WRITE:KEY s" rejected" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" word" JSON-WRITE:KEY CA-DUP-WORD$ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" token" JSON-WRITE:KEY CA-DUP-WORD$ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" token_index" JSON-WRITE:KEY 1 JSON-WRITE:U JSON-WRITE:COMMA
   s" file" JSON-WRITE:KEY CA-FILE-A@ CA-FILE-U @ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" line" JSON-WRITE:KEY 1 JSON-WRITE:U JSON-WRITE:COMMA
   s" column" JSON-WRITE:KEY 1 JSON-WRITE:U JSON-WRITE:COMMA
   s" byte_start" JSON-WRITE:KEY 0 JSON-WRITE:U JSON-WRITE:COMMA
   s" byte_end" JSON-WRITE:KEY CA-DUP-WORD$ nip JSON-WRITE:U JSON-WRITE:COMMA
   s" definition_source" JSON-WRITE:KEY CA-DUP-WORD$ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" declared_effect" JSON-WRITE:KEY s" unknown" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" declared_effect_source" JSON-WRITE:KEY s" unknown" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" inferred_effect" JSON-WRITE:KEY s" unknown" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" return_stack" JSON-WRITE:KEY
   JSON-WRITE:OBJECT-START
   s" expected" CA-JSON-EMPTY-FIELD JSON-WRITE:COMMA
   s" actual" CA-JSON-EMPTY-FIELD
   JSON-WRITE:OBJECT-END JSON-WRITE:COMMA
   s" suggestion" JSON-WRITE:KEY s" Rename the word or undefine the old definition before redefining it." JSON-WRITE:STRING
...
: CA-JSON-LEX-UNTERM ( -- )
   ...
   JSON-WRITE:OBJECT-START
   s" schema_version" JSON-WRITE:KEY 1 JSON-WRITE:U JSON-WRITE:COMMA
   s" code" JSON-WRITE:KEY s" E-UNTERMINATED-STRING" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" repair_class" JSON-WRITE:KEY s" fix_source" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" verdict" JSON-WRITE:KEY s" rejected" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" token" JSON-WRITE:KEY CA-SRC-A@ LINT-LEX:ERROR-BYTE@ + 2 JSON-WRITE:STRING JSON-WRITE:COMMA
   s" file" JSON-WRITE:KEY CA-FILE-A@ CA-FILE-U @ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" line" JSON-WRITE:KEY LINT-LEX:ERROR-LINE@ JSON-WRITE:U JSON-WRITE:COMMA
   s" column" JSON-WRITE:KEY LINT-LEX:ERROR-COL@ JSON-WRITE:U JSON-WRITE:COMMA
   s" byte_start" JSON-WRITE:KEY LINT-LEX:ERROR-BYTE@ JSON-WRITE:U JSON-WRITE:COMMA
   s" byte_end" JSON-WRITE:KEY LINT-LEX:ERROR-BYTE@ 2 + JSON-WRITE:U JSON-WRITE:COMMA
   s" suggestion" JSON-WRITE:KEY s" Close the string literal before the definition ends." JSON-WRITE:STRING
   JSON-WRITE:OBJECT-END
   JSON-WRITE:$ CA-ERR
   CA-LF$ CA-ERR ;
...
: CA-JSON-LEX-ROW ( -- )
   ...
   JSON-WRITE:OBJECT-START
   s" schema_version" JSON-WRITE:KEY 1 JSON-WRITE:U JSON-WRITE:COMMA
   s" code" JSON-WRITE:KEY s" E-MALFORMED-REGISTRY-ROW" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" repair_class" JSON-WRITE:KEY s" fix_source" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" verdict" JSON-WRITE:KEY s" rejected" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" token" JSON-WRITE:KEY CA-ROW-TOKEN$ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" file" JSON-WRITE:KEY CA-FILE-A@ CA-FILE-U @ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" line" JSON-WRITE:KEY LINT-LEX:ERROR-LINE@ JSON-WRITE:U JSON-WRITE:COMMA
   s" column" JSON-WRITE:KEY LINT-LEX:ERROR-COL@ JSON-WRITE:U JSON-WRITE:COMMA
   s" byte_start" JSON-WRITE:KEY LINT-LEX:ERROR-BYTE@ JSON-WRITE:U JSON-WRITE:COMMA
   s" byte_end" JSON-WRITE:KEY LINT-LEX:ERROR-BYTE@ CA-ROW-TOKEN-U + JSON-WRITE:U JSON-WRITE:COMMA
   s" suggestion" JSON-WRITE:KEY CA-ROW-SUGGESTION$ JSON-WRITE:STRING
   JSON-WRITE:OBJECT-END
   JSON-WRITE:$ CA-ERR
   CA-LF$ CA-ERR ;
