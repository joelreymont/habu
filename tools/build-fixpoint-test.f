...
: BFT-TEST-CHECKED-TARGET-IMAGE ( -- )
   ...
   BFT-READ-BUF u BFT-IMG-BUILD-I @ s" 0 set-check" BFT-FIND-AFTER dup BFT-FOUND BFT-HABU1OFF-I !
   BFT-READ-BUF u BFT-HABU1OFF-I @ s" : RPD@" BFT-FIND-AFTER dup BFT-FOUND BFT-HABU1-I !
   BFT-IMG-I @ BFT-IMG-BUILD-I @ < TTRUE
   BFT-IMG-BUILD-I @ BFT-HABU1OFF-I @ < TTRUE
   BFT-HABU1OFF-I @ BFT-HABU1-I @ < TTRUE ;
