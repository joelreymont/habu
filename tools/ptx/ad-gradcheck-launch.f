...
\
\ Ships to the device box and runs from the checkout there:
...
: AG-PACK ( ptr a ptr u8 -- ) {: src:ptr dst:ptr :}
   AGK 0 ?do  src i AG-F@ NARROW  dst i AG-F32!  loop ;

: AG-UNPACK ( ptr u8 ptr a -- ) {: src:ptr dst:ptr :}
   AGK 0 ?do  src i AG-F32@ WIDEN  dst i AG-F!  loop ;
...
\ ---- CUDA plumbing (canonical API; every rc checked) --------------------------
...
: AG-INIT ( -- )
   ...
   AG-DEV 0 >IDX CUDA:CU-DEVICE-GET CUDA:RC0
   AG-CTX AG-DEV @ >CUDA-DEV CUDA:CU-DEVICE-PRIMARY-CTX-RETAIN CUDA:RC0
   AG-CTX @ >CUDA-CTX CUDA:CU-CTX-SET-CURRENT CUDA:RC0
   AG-dX 16 >LEN CUDA:CU-MEM-ALLOC CUDA:RC0
   AG-dDY 16 >LEN CUDA:CU-MEM-ALLOC CUDA:RC0
   AG-dO 16 >LEN CUDA:CU-MEM-ALLOC CUDA:RC0
   AG-dY2 16 >LEN CUDA:CU-MEM-ALLOC CUDA:RC0
   AG-dO2 16 >LEN CUDA:CU-MEM-ALLOC CUDA:RC0
   AG-dO3 16 >LEN CUDA:CU-MEM-ALLOC CUDA:RC0
   AGK AG-KV ! ;

: AG-FINI ( -- )
   AG-dX @ >CUDA-DEVPTR CUDA:CU-MEM-FREE CUDA:RC0
   AG-dDY @ >CUDA-DEVPTR CUDA:CU-MEM-FREE CUDA:RC0
   AG-dO @ >CUDA-DEVPTR CUDA:CU-MEM-FREE CUDA:RC0
   AG-dY2 @ >CUDA-DEVPTR CUDA:CU-MEM-FREE CUDA:RC0
   AG-dO2 @ >CUDA-DEVPTR CUDA:CU-MEM-FREE CUDA:RC0
   AG-dO3 @ >CUDA-DEVPTR CUDA:CU-MEM-FREE CUDA:RC0
   AG-DEV @ >CUDA-DEV CUDA:CU-DEVICE-PRIMARY-CTX-RELEASE CUDA:RC0 ;

: AG-FWD-MOD! ( ptr u8 n ptr u8 n -- ) {: f:ptr fu:n kn:ptr knu:n :}
   f fu AG-PATH!
   AG-MF AG-PZ CUDA:CU-MODULE-LOAD CUDA:RC0
   kn knu AG-KN FFI:CSTR
   AG-FWD AG-MF @ >CUDA-MOD AG-KN CUDA:CU-MODULE-GET-FUNCTION CUDA:RC0 ;

: AG-BWD-MOD! ( ptr u8 n ptr u8 n -- ) {: b:ptr bu:n kn:ptr knu:n :}
   b bu AG-PATH!
   AG-MB AG-PZ CUDA:CU-MODULE-LOAD CUDA:RC0
   kn knu AG-KN FFI:CSTR
   AG-BWD AG-MB @ >CUDA-MOD AG-KN CUDA:CU-MODULE-GET-FUNCTION CUDA:RC0 ;
...
: AG-PAIR-CLOSE ( -- )
   AG-MF @ >CUDA-MOD CUDA:CU-MODULE-UNLOAD CUDA:RC0
   AG-MB @ >CUDA-MOD CUDA:CU-MODULE-UNLOAD CUDA:RC0 ;
...
: AG-FWD-RUN ( ptr a ptr a -- ) {: src:ptr dst:ptr :}
   ...
   AG-FWD @ >CUDA-FN 20 >LEN CUDA:CU-PARAM-SET-SIZE CUDA:RC0
   AG-FWD @ >CUDA-FN 0 >IDX  AG-dX 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 8 >IDX  AG-dO 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 16 >IDX AG-KV 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 1 1 CUDA:CU-LAUNCH-GRID CUDA:RC0
   CUDA:CU-CTX-SYNCHRONIZE CUDA:RC0
   AG-OUT AG-dO @ >CUDA-DEVPTR AGBYTES >LEN CUDA:CU-MEMCPY-DTOH CUDA:RC0
   AG-GUARD
...
: AG-BWD-RUN-FROM ( ptr a -- ) {: src:ptr :}   \ input-1 taken from src (x or y)
   ...
   AG-dO @ >CUDA-DEVPTR 0 AGK >COUNT CUDA:CU-MEMSET-D32 CUDA:RC0   \ scatter-add backwards accumulate: start from zero
   AG-BWD @ >CUDA-FN AGBLOCK 1 1 CUDA:CU-FUNC-SET-BLOCK-SHAPE CUDA:RC0
   AG-BWD @ >CUDA-FN 28 >LEN CUDA:CU-PARAM-SET-SIZE CUDA:RC0
   AG-BWD @ >CUDA-FN 0 >IDX  AG-dX 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 8 >IDX  AG-dDY 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 16 >IDX AG-dO 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 24 >IDX AG-KV 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 1 1 CUDA:CU-LAUNCH-GRID CUDA:RC0
   CUDA:CU-CTX-SYNCHRONIZE CUDA:RC0
   AG-OUT AG-dO @ >CUDA-DEVPTR AGBYTES >LEN CUDA:CU-MEMCPY-DTOH CUDA:RC0
   AG-GUARD
...
\ XSUBSUM z = x - Sum(x): the backward kernel text is GENERATED by the reverse
\ pass (AD-BACKWARD$ over the vjp.f table, ad-gen lowering) - not hand-written.
\ Its conservative ROW-SCATTER-ADD ending is why AG-BWD-RUN zeroes dxo first.
: AG-XSUBSUM-ENTRY ( -- )
   s" xsubsum-fwd.cubin" s" xsubsum-bwd.cubin" AG-PAIR!
   AG-DY-RND
...
: AG2-UPLOAD-XY ( -- )
   ...
   AG-dX @ >CUDA-DEVPTR AG-IN AGBYTES >LEN CUDA:CU-MEMCPY-HTOD CUDA:RC0
   AG-dY2 @ >CUDA-DEVPTR AG-DYB AGBYTES >LEN CUDA:CU-MEMCPY-HTOD CUDA:RC0 ;

: AG-READBACK ( n ptr a -- ) {: dev:n dst:ptr :}   \ poisoned DtoH into a host array
   AG-POISON
   AG-OUT dev >CUDA-DEVPTR AGBYTES >LEN CUDA:CU-MEMCPY-DTOH CUDA:RC0
   AG-GUARD
   AG-OUT dst AG-UNPACK ;
...
: AG2-FWD-RUN ( ptr a -- ) {: dst:ptr :}     \ AD2_FWD(x, y, out, k)
   ...
   AG2-UPLOAD-XY
   AG-FWD @ >CUDA-FN AGBLOCK 1 1 CUDA:CU-FUNC-SET-BLOCK-SHAPE CUDA:RC0
   AG-FWD @ >CUDA-FN 28 >LEN CUDA:CU-PARAM-SET-SIZE CUDA:RC0
   AG-FWD @ >CUDA-FN 0 >IDX  AG-dX 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 8 >IDX  AG-dY2 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 16 >IDX AG-dO 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 24 >IDX AG-KV 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 1 1 CUDA:CU-LAUNCH-GRID CUDA:RC0
   CUDA:CU-CTX-SYNCHRONIZE CUDA:RC0
...
: AG2-BWD-RUN ( -- )                         \ AD2_BWD(x, y, dz, dxo, dyo, k)
   ...
   AG2-UPLOAD-XY
   AG-DY AG-IN AG-PACK
   AG-dDY @ >CUDA-DEVPTR AG-IN AGBYTES >LEN CUDA:CU-MEMCPY-HTOD CUDA:RC0
   AG-BWD @ >CUDA-FN AGBLOCK 1 1 CUDA:CU-FUNC-SET-BLOCK-SHAPE CUDA:RC0
   AG-BWD @ >CUDA-FN 44 >LEN CUDA:CU-PARAM-SET-SIZE CUDA:RC0
   AG-BWD @ >CUDA-FN 0 >IDX  AG-dX 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 8 >IDX  AG-dY2 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 16 >IDX AG-dDY 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 24 >IDX AG-dO 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 32 >IDX AG-dO2 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 40 >IDX AG-KV 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 1 1 CUDA:CU-LAUNCH-GRID CUDA:RC0
   CUDA:CU-CTX-SYNCHRONIZE CUDA:RC0
...
: AGS-FWD-RUN ( ptr a -- ) {: dst:ptr :}     \ ADS_FWD(x, out, a, k)
   ...
   AG-dX @ >CUDA-DEVPTR AG-IN AGBYTES >LEN CUDA:CU-MEMCPY-HTOD CUDA:RC0
   AG-FWD @ >CUDA-FN AGBLOCK 1 1 CUDA:CU-FUNC-SET-BLOCK-SHAPE CUDA:RC0
   AG-FWD @ >CUDA-FN 24 >LEN CUDA:CU-PARAM-SET-SIZE CUDA:RC0
   AG-FWD @ >CUDA-FN 0 >IDX  AG-dX 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 8 >IDX  AG-dO 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 16 >IDX AG-AB 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 20 >IDX AG-KV 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 1 1 CUDA:CU-LAUNCH-GRID CUDA:RC0
   CUDA:CU-CTX-SYNCHRONIZE CUDA:RC0
   AG-dO @ dst AG-READBACK ;
...
: AGS-BWD-RUN ( -- )                         \ ADS_BWD(x, dz, dxo, dao, a, k)
   ...
   AG-dDY @ >CUDA-DEVPTR AG-DYB AGBYTES >LEN CUDA:CU-MEMCPY-HTOD CUDA:RC0
   AG-BWD @ >CUDA-FN AGBLOCK 1 1 CUDA:CU-FUNC-SET-BLOCK-SHAPE CUDA:RC0
   AG-BWD @ >CUDA-FN 40 >LEN CUDA:CU-PARAM-SET-SIZE CUDA:RC0
   AG-BWD @ >CUDA-FN 0 >IDX  AG-dX 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 8 >IDX  AG-dDY 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 16 >IDX AG-dO 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 24 >IDX AG-dO2 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 32 >IDX AG-AB 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 36 >IDX AG-KV 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 1 1 CUDA:CU-LAUNCH-GRID CUDA:RC0
   CUDA:CU-CTX-SYNCHRONIZE CUDA:RC0
   AG-dO @ AG-DXA AG-READBACK
...
: AGF-FWD-RUN ( ptr a -- ) {: dst:ptr :}     \ ADF_FWD(x, y, out, a, k)
   ...
   AG-FWD @ >CUDA-FN 8 >IDX  AG-dY2 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 16 >IDX AG-dO 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 24 >IDX AG-AB 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 28 >IDX AG-KV 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-FWD @ >CUDA-FN 1 1 CUDA:CU-LAUNCH-GRID CUDA:RC0
   CUDA:CU-CTX-SYNCHRONIZE CUDA:RC0
   AG-dO @ dst AG-READBACK ;
...
: AGF-BWD-RUN ( -- )                         \ ADF_BWD(x, dz, dxo, dyo, dao, a, k)
   ...
   AG-dDY @ >CUDA-DEVPTR AG-DYB AGBYTES >LEN CUDA:CU-MEMCPY-HTOD CUDA:RC0
   AG-BWD @ >CUDA-FN AGBLOCK 1 1 CUDA:CU-FUNC-SET-BLOCK-SHAPE CUDA:RC0
   AG-BWD @ >CUDA-FN 48 >LEN CUDA:CU-PARAM-SET-SIZE CUDA:RC0
   AG-BWD @ >CUDA-FN 0 >IDX  AG-dX 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 8 >IDX  AG-dDY 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 16 >IDX AG-dO 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 24 >IDX AG-dO2 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 32 >IDX AG-dO3 8 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 40 >IDX AG-AB 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 44 >IDX AG-KV 4 >LEN CUDA:CU-PARAM-SET-V CUDA:RC0
   AG-BWD @ >CUDA-FN 1 1 CUDA:CU-LAUNCH-GRID CUDA:RC0
   CUDA:CU-CTX-SYNCHRONIZE CUDA:RC0
   AG-dO @ AG-DXA AG-READBACK
   AG-dO2 @ AG-DYA AG-READBACK
