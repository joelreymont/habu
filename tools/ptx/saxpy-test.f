...
: PTXT-RUN-SOFTMAX-FB-SPAWN ( -- n n n )
   ...
   ENGINE-CANDIDATE:PATH$ >LEN  PTXT-OUT PTXT-CAP >LEN  PTXT-ERR PTXT-CAP >LEN  PTXT-TIMEOUT-MS >MS  RUN-ARGV-CAPTURE
   PTXT-CAPTURE>N ;
...
T-RESET
s" PTXT-SAXPY-OUTPUT" T-LABEL
PTXT-SAXPY-OUTPUT
s" PTXT-OPS-CG-OUTPUT" T-LABEL
PTXT-OPS-CG-OUTPUT
s" PTXT-ONCE-CG-OUTPUT" T-LABEL
PTXT-ONCE-CG-OUTPUT
s" PTXT-SOFTMAX-CG-OUTPUT" T-LABEL
PTXT-SOFTMAX-CG-OUTPUT
s" PTXT-SUM-CG-OUTPUT" T-LABEL
PTXT-SUM-CG-OUTPUT
s" PTXT-SUM1024-CG-OUTPUT" T-LABEL
PTXT-SUM1024-CG-OUTPUT
s" PTXT-MATMUL-CG-OUTPUT" T-LABEL
PTXT-MATMUL-CG-OUTPUT
s" PTXT-SMEM-CG-OUTPUT" T-LABEL
PTXT-SMEM-CG-OUTPUT
s" PTXT-SOFTMAX-BWD-CG-OUTPUT" T-LABEL
PTXT-SOFTMAX-BWD-CG-OUTPUT
s" PTXT-SOFTMAX-BWD-OPT-CG-OUTPUT" T-LABEL
PTXT-SOFTMAX-BWD-OPT-CG-OUTPUT
s" PTXT-SOFTMAX-FB-CG-OUTPUT" T-LABEL
PTXT-SOFTMAX-FB-CG-OUTPUT
s" PTXT-ADE-EXP-OUTPUT" T-LABEL
PTXT-ADE-EXP-OUTPUT
s" PTXT-ADE-XMSUB-OUTPUT" T-LABEL
PTXT-ADE-XMSUB-OUTPUT
s" PTXT-ADE-XDIVSUM-OUTPUT" T-LABEL
PTXT-ADE-XDIVSUM-OUTPUT
s" PTXT-ADE-SOFTMAX-OUTPUT" T-LABEL
PTXT-ADE-SOFTMAX-OUTPUT
s" PTXT-ADE-WRONG-OUTPUT" T-LABEL
PTXT-ADE-WRONG-OUTPUT
s" PTXT-ADE2-ELEM-OUTPUT" T-LABEL
PTXT-ADE2-ELEM-OUTPUT
s" PTXT-ADE2-STRUCT-OUTPUT" T-LABEL
PTXT-ADE2-STRUCT-OUTPUT
s" PTXT-ADE2-SCALAR-OUTPUT" T-LABEL
PTXT-ADE2-SCALAR-OUTPUT
s" PTXT-ADG-XSUBSUM-OUTPUT" T-LABEL
PTXT-ADG-XSUBSUM-OUTPUT
s" PTXT-ADG-REJECTS" T-LABEL
PTXT-ADG-REJECTS
s" PTXT-ADG-EXPGEN-OUTPUT" T-LABEL
PTXT-ADG-EXPGEN-OUTPUT
s" PTXT-SOFTMAX-ROWS-BWD-OUTPUT" T-LABEL
PTXT-SOFTMAX-ROWS-BWD-OUTPUT
s" PTXT-ADG-EXPSAVE-OUTPUT" T-LABEL
PTXT-ADG-EXPSAVE-OUTPUT
T-REPORT
