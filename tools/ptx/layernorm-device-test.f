...
: PACK4   ( ptr a ptr u8 -- ) {: src:ptr dst:ptr :}  RNK 0 ?do  src i T-GET F32:NARROW  dst i F32!  loop ;
: UNPACK4 ( ptr u8 ptr a -- ) {: src:ptr dst:ptr :}  RNK 0 ?do  src i F32@ F32:WIDEN  dst i T-SET  loop ;
