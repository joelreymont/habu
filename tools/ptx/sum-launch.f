...
: RS-LAUNCH ( -- )
   ...
   RS-DIN 32 >LEN CUDA:CU-MEM-ALLOC CUDA:RC0   RS-DIN @ >CUDA-DEVPTR CUDA-SCOPE:OWN-DEVPTR
   RS-DOUT 32 >LEN CUDA:CU-MEM-ALLOC CUDA:RC0  RS-DOUT @ >CUDA-DEVPTR CUDA-SCOPE:OWN-DEVPTR
...
: SUM-MAIN ( -- )
   ...
   RS-PUT  [: RS-SETUP RS-LAUNCH ;] CUDA-SCOPE:SCOPE   \ acquire+own+launch; scope unwinds ctx/module/buffers
   PTXTC:CLEAN
