...
: TEST-MAX-RANGES ( -- )
   s" @@ -9223372036854775807 +9223372036854775807 @@" HUNK-PARSE
   MAX-N T=
   s" @@ -1,9223372036854775807 +1,9223372036854775807 @@" HUNK-PARSE
   1 T= ;

: TEST-COMMIT-ID ( -- )
   s" 0123456789abcdef0123456789abcdef01234567" COMMIT-ID? TTRUE
   s" 0123456789abcdef0123456789abcdef0123456" COMMIT-ID? TFALSE
   s" 0123456789abcdef0123456789abcdef012345678" COMMIT-ID? TFALSE
   s" 0123456789abcdef0123456789abcdef0123456g" COMMIT-ID? TFALSE ;

: BAD-OLD-RANGE-OVERFLOW ( -- )
   s" @@ -9223372036854775807,2 +1 @@" HUNK-PARSE drop ;

: BAD-NEW-RANGE-OVERFLOW ( -- )
   s" @@ -1 +2,9223372036854775807 @@" HUNK-PARSE drop ;
...
: TEST-REJECTIONS ( -- )
   ...
   [: BAD-OLD-RANGE-OVERFLOW ;] s" BAD-OLD-RANGE-OVERFLOW" REJECT
   [: BAD-NEW-RANGE-OVERFLOW ;] s" BAD-NEW-RANGE-OVERFLOW" REJECT
   [: BAD-OFFSET-OVERFLOW ;] s" BAD-OFFSET-OVERFLOW" REJECT ;
...
: RUN ( -- )
   ...
   [: TEST-MAX-RANGES ;] catch s" TEST-MAX-RANGES" T-LABEL 0 T=
   [: TEST-COMMIT-ID ;] catch s" TEST-COMMIT-ID" T-LABEL 0 T=
   TEST-REJECTIONS
   T-REPORT ;
