...
: HBB-KEY-COMMON-SOURCES ( CONTENT-KEY:fold -- CONTENT-KEY:fold )
   ...
   s" src/core/util-effects.f" HBB-KEY-FILE+
   s" src/core/render-effects.f" HBB-KEY-FILE+
   s" src/core/checker-effects.f" HBB-KEY-FILE+
   s" src/core/lower-cert-effects.f" HBB-KEY-FILE+
