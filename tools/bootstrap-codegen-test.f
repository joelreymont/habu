...
: BCG-TEST-PREFIX-LIST-COMMON ( -- )
   ...
   s" PFX-COMMON LPROLES" s" PFX-COMMON LPSTRUCTURES" BCG-MUST-BEFORE
   ...
   s" PFX-COMMON LPEXECVECTOR" s" PFX-COMMON LPCOMBINATORS" BCG-MUST-BEFORE ;
...
: BCG-TEST-PREFIX-LIST-NATIVE ( -- )
   ...
   BCG-TEST-PREFIX-LIST-COMMON
   s" PFX-COMMON LPINCLUDE" BCG-MUST-LACK
