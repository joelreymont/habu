...
: CDT-TEST-NATIVE-INTERPRET ( -- )
   ...
   s" : EM-INTERPRET-NUMBER ( label -- )" CDT-MUST-HAVE
...
: CDT-TEST-NATIVE-COMPILE ( -- )
   ...
   s" : J-CASE ( -- )" CDT-MUST-HAVE
   s" : J-OF ( -- )" CDT-MUST-HAVE
   s" : J-ENDOF ( -- )" CDT-MUST-HAVE
   s" : J-ENDCASE ( -- )" CDT-MUST-HAVE
   s" LKWCASE 4 ['] J-CASE CFN-ENTRY" CDT-MUST-HAVE
   s" LKWOF 2 ['] J-OF CF-ENTRY" CDT-MUST-HAVE
   s" LKWENDOF 5 ['] J-ENDOF CF-ENTRY" CDT-MUST-HAVE
   s" LKWENDCASE 7 ['] J-ENDCASE CF-ENTRY" CDT-MUST-HAVE
...
: CDT-TEST-NATIVE-LOCAL ( -- )
   ...
   s" : C-LOCAL-REF-ARGS ( label label -- )" CDT-MUST-HAVE
   ...
   s" CLOC-MAIN LABEL@ B," 2 CDT-COUNT=
   s" CLOC-MAIN @ B ;" CDT-MUST-LACK
   s" CLOC-QOK LABEL@ LBL," CDT-MUST-HAVE
   s" CLOC-MEM LABEL@ LBL," CDT-MUST-HAVE ;
