...
31 constant COMMON-N               \ constructor namespace SHA helper retired
...
: SETUP ( -- )
   CLEANUP-RESET
   CAP MEM:BYTES-ALLOC-LEN MEM:ALLOC-BYTES drop OUT-A-FIELD !
   CAP MEM:BYTES-ALLOC-LEN MEM:ALLOC-BYTES drop ERR-A-FIELD !
