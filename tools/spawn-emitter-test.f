...
: SET-TEST-HELPERS ( -- )
   s" : SPAWN-DUP2-ACTION ( n n -- )" SET-MUST-HAVE
   s" : SPAWN-CHDIR-ACTION ( n n -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-FRAME3-ENTER ( -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-FRAME4-ENTER ( -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-ACTIONS-RESET ( n -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-STDIO-ACTIONS ( -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-ZERO-ADESC ( -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-FILL-ADESC ( -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-NULLABLE-ADESC ( n -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-FINISH ( n n -- )" SET-MUST-HAVE ;
...
: SET-TEST-DARWIN-WRAPPERS ( -- )
   s" 3 SPAWN-DARWIN-ACTIONS-RESET" 3 SET-COUNT=
   s" 4 SPAWN-DARWIN-ACTIONS-RESET" 1 SET-COUNT=
   s" BSP-SAD @ SPAWN-DARWIN-NULLABLE-ADESC" 3 SET-COUNT=
   s" 6 BSP-DN @ SPAWN-CHDIR-ACTION" SET-MUST-HAVE
