...
: SET-TEST-HELPERS ( -- )
   ...
   s" : SPAWN-DARWIN-ZERO-ATTR ( -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-ATTR-DEFAULTS ( -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-FILL-ADESC ( -- )" SET-MUST-HAVE
   s" : SPAWN-DARWIN-USE-ADESC ( -- )" SET-MUST-HAVE
...
: SET-TEST-HELPER-USES ( -- )
   ...
   s" SPAWN-DARWIN-ZERO-ATTR" 5 SET-COUNT=
   s" SPAWN-DARWIN-ATTR-DEFAULTS" 2 SET-COUNT=
   s" SPAWN-DARWIN-FILL-ADESC" 5 SET-COUNT=
   s" SPAWN-DARWIN-USE-ADESC" 5 SET-COUNT=
