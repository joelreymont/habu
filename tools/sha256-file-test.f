...
create SFT-CTX-A SHA256-CTX-U allot
create SFT-CTX-B SHA256-CTX-U allot
...
: SFT-TEST-CTX-PRESERVES ( -- )
   SHA256-RESET
   s" a" SHA256-UPDATE
   SFT-CTX-A SHA256-CTX-RESET
   SFT-CTX-A s" x" SHA256-CTX-UPDATE
   SFT-CTX-A SFT-DG-B SHA256-CTX-FINAL
   s" bc" SHA256-UPDATE
   SFT-DG-A SHA256-FINAL
   s" abc" SFT-DG-C SHA256
   SFT-DG-A 32 SFT-DG-C 32 T$= ;

: SFT-TEST-CTX-INTERLEAVE ( -- )
   SFT-CTX-A SHA256-CTX-RESET
   SFT-CTX-B SHA256-CTX-RESET
   SFT-CTX-A s" a" SHA256-CTX-UPDATE
   s" unrelated" SFT-DG-C SHA256
   SFT-CTX-B s" 12" SHA256-CTX-UPDATE
   SFT-CTX-A s" bc" SHA256-CTX-UPDATE
   SFT-CTX-B s" 3" SHA256-CTX-UPDATE
   SFT-CTX-A SFT-DG-A SHA256-CTX-FINAL
   SFT-CTX-B SFT-DG-B SHA256-CTX-FINAL
   s" abc" SFT-DG-C SHA256
   SFT-DG-A 32 SFT-DG-C 32 T$=
   s" 123" SFT-DG-C SHA256
   SFT-DG-B 32 SFT-DG-C 32 T$= ;
