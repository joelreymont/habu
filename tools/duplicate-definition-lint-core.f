...
: DDL-JSON-FINDING ( n -- ) {: first:n :}
   ...
   s" code" JSON-WRITE:KEY s" E-DUPLICATE-DEFINITION" JSON-WRITE:STRING JSON-WRITE:COMMA
   s" file" JSON-WRITE:KEY DDL-FILE-LABEL-A@ DDL-FILE-LABEL-U @ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" line" JSON-WRITE:KEY DDL-TOK-LINE @ JSON-WRITE:U JSON-WRITE:COMMA
   s" column" JSON-WRITE:KEY DDL-TOK-COL @ JSON-WRITE:U JSON-WRITE:COMMA
   s" byte_start" JSON-WRITE:KEY DDL-TOK-BYTE @ JSON-WRITE:U JSON-WRITE:COMMA
   s" byte_end" JSON-WRITE:KEY DDL-TOK-END JSON-WRITE:U JSON-WRITE:COMMA
   s" word" JSON-WRITE:KEY DDL-TOK$ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" first_file" JSON-WRITE:KEY first DDL-FILE$ JSON-WRITE:STRING JSON-WRITE:COMMA
   s" first_line" JSON-WRITE:KEY first DDL-LINE@ JSON-WRITE:U JSON-WRITE:COMMA
   s" first_column" JSON-WRITE:KEY first DDL-COL@ JSON-WRITE:U
   JSON-WRITE:OBJECT-END
   JSON-WRITE:$ DDL-OUT DDL-NL ;
