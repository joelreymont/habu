...
: COMMON-FILES ( -- )
   ...
   s" src/core/util-effects.f" PREFIX-FILE
   s" src/core/render-effects.f" PREFIX-FILE
   s" src/core/checker-effects.f" PREFIX-FILE
   s" src/core/lower-cert-effects.f" PREFIX-FILE
