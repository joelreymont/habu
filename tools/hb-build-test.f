...
: HBT-BUILD-REPL ( -- )
   ...
   HB-BUILD:REPORT$ JR:T-FALSE JR:T-FALSE JR:T-FALSE JR:T-TRUE JR:T-TRUE HBT-CHECK-REPORT ;
...
: HBT-REBUILD-REPL-CACHE ( -- )
   ...
   HBT-REPL-OUT FILE? TTRUE
   HB-BUILD:REPORT$ JR:T-TRUE JR:T-FALSE JR:T-FALSE JR:T-FALSE JR:T-FALSE HBT-CHECK-REPORT ;
...
: HBT-CLI-REPORT ( -- )
   ...
   rc 0 T=
   erru 0 T=
   HBT-OUT outu JR:T-TRUE JR:T-FALSE JR:T-FALSE JR:T-FALSE JR:T-FALSE HBT-CHECK-REPORT ;
...
: HBT-BUILD-AOT-OBJECT-PRODUCER ( -- )
   ...
   HB-BUILD:REPORT$ JR:T-FALSE JR:T-TRUE JR:T-FALSE JR:T-FALSE JR:T-FALSE HBT-CHECK-REPORT
   HBT-RUN-AOT
   HBT-REMOVE-ARTIFACT
   HBT-REMOVE-AOT-OUT
   BF-TMP-RESET ;
...
: HBT-BUILD-AOT-MAKER-HIT ( -- )
   ...
   HBB-MAKER-RUN @ 0 <> TTRUE
   HB-BUILD:REPORT$ JR:T-FALSE JR:T-FALSE JR:T-TRUE JR:T-FALSE JR:T-TRUE HBT-CHECK-REPORT
   HBT-REMOVE-ARTIFACT
   HBT-REMOVE-AOT-OUT
   HBT-AOT-SRC HBT-AOT-SRC$ WRITE-ALL
   BF-TMP-RESET ;
