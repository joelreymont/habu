...
: RNL-JSON-FINDING-AS ( n ptr u8 n ptr u8 n ptr u8 n -- )
   ...
   s" file" JSON-WRITE:KEY RNL-FILE-A@ RNL-FILE-U @ JSON-WRITE:STRING JSON-WRITE:COMMA
   ...
   s" byte_end" JSON-WRITE:KEY k RNL-TOK-END JSON-WRITE:U JSON-WRITE:COMMA
   s" word" JSON-WRITE:KEY k LINT-LEX:TOKEN JSON-WRITE:STRING JSON-WRITE:COMMA
   s" reason" JSON-WRITE:KEY why whyu JSON-WRITE:STRING JSON-WRITE:COMMA
   s" suggestion" JSON-WRITE:KEY fix fixu JSON-WRITE:STRING
   JSON-WRITE:OBJECT-END
   JSON-WRITE:$ RNL-OUT RNL-NL ;
