...
- `lib/cad-num-arithmetic-test.f` — CAD-NUM B5.2 arithmetic matrix: strict equality bounds, safe and overflowing index byte offsets, full-domain representable-product properties, the cast-free GPT-2 F32 composition shape, every original table boundary, and static role-swap rejection; focused direct-loaded gate home.
