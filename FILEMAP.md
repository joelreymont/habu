...
- `src/core/type-field.f` — sealed transactional shared field arena with nominal builder tokens and typed read-only reflection for STRUCTURE and payload ENUM.
...
- `test/type-field-suite.f` — focused shared field-arena transaction, reflection, owner, layout, source, growth, and rollback coverage.
