...
- `bench/llm/run-attempts-lib.f` — checked attempt-runner helpers for deterministic candidate round enumeration, test-bundle assembly, checker capture, and bundle stdin test execution.
- `bench/llm/run-attempts-test.f` — focused coverage for candidate enumeration, bundle assembly, checker capture, and test execution.
