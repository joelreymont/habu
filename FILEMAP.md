...
- `test/icode-capacity.f` — arm64 assembler label/fixup table boundary
  regression proving independent capacities, the retired 4096-fixup edge,
  active 8192-fixup edge, exact stored rows, and guarded overflow diagnostic.
