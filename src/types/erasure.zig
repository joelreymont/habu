...
pub const Eraser = struct {
    ...
    pub fn erase(self: *Eraser, node: *const Ir, ctx: *const ErasureCtx) !*const Ir {
        return switch (node.*) {
            ...
            .lt, .gt, .le, .ge, .num_eq,
            .eq, .eql, .equal,
            .cons, .append, .nth, .nthcdr, .member, .assoc,
            .member_eql, .member_equal, .assoc_eql, .assoc_equal,
            .find, .find_eq, .find_equal,
            .position, .position_eq, .position_equal,
            .count, .count_eq, .count_equal,
            .remove, .remove_eq, .remove_equal,
            .rplaca, .rplacd,
            .vec_ref, .str_ref, .str_concat, .str_eq,
            ...
            .car, .cdr, .not, .length, .reverse, .last,
            .consp, .symbolp, .numberp, .stringp, .vectorp,
            .closurep, .keywordp, .nilp, .listp, .atom,
            .characterp, .floatp,
            .zerop, .plusp, .minusp, .evenp, .oddp, .abs,
            .lognot,
            .vec_len, .str_len,
            .char_code, .code_char, .char_upcase, .char_downcase,
            .digit_char_p, .alpha_char_p,
            .print, .princ, .write_char,
            .intern, .sym_name, .boundp, .fboundp,
            .symbol_value, .symbol_function, .type_of,
            .string_upcase, .string_downcase, .string_to_list,
            .list_to_string,
            .assert_fixnum, .assert_cons, .assert_symbol,
            .assert_string, .assert_vector, .assert_closure,
            .assert_non_nil, .assert_list,
            .box_ref,
            .read_from_string, .load, .unread_char, .eval,
            .macroexpand, .parse_integer, .write_to_string,
            .read_file, .random, .error_user,
            .make_box,
            => |op| {
            ...
            .lit, .quote_sym, .quote, .global_ref,
            .read_char, .peek_char, .read, .gensym,
            => node,
