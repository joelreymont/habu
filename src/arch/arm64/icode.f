...
$420000 constant AOT-SECTION-CAP  \ src/habu/aot-decl.f AOT-SECTION:BYTES: the capture buffers ($41C801) rounded to the 64 KiB grain
$920000 constant CODE-CAP-BYTES   \ ADR-HI ($100000) + IBUFSZ ($400000) + AOT-SECTION-CAP ($420000)
