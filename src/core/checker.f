...
PRIM: PF-NO-VARIANT PE-N PE-OUT PRIM;
PRIM: PF-FIND PE-N PE-IN PE-N PE-IN PE-PTR-U8 PE-IN PE-N PE-IN  PE-N PE-OUT PE-F PE-OUT PRIM;
PRIM: PF-EACH PE-N PE-IN PE-N PE-IN PE-N PE-IN  PE-N PE-OUT PE-F PE-OUT PRIM;
PRIM: PF-FAM@ PE-N PE-IN  PE-N PE-OUT PRIM;
PRIM: PF-VAR@ PE-N PE-IN  PE-N PE-OUT PRIM;
PRIM: PF-NAME$ PE-N PE-IN  PE-PTR-U8 PE-OUT PE-N PE-OUT PRIM;
PRIM: PF-SCH@ PE-N PE-IN  PE-N PE-OUT PRIM;
PRIM: PF-SLOT@ PE-N PE-IN  PE-N PE-OUT PRIM;
PRIM: PF-CELLS@ PE-N PE-IN  PE-N PE-OUT PRIM;
PRIM: PF-BYTE-OFF@ PE-N PE-IN  PE-N PE-OUT PRIM;
PRIM: PF-BYTES@ PE-N PE-IN  PE-N PE-OUT PRIM;
PRIM: PF-ALIGN@ PE-N PE-IN  PE-N PE-OUT PRIM;
PRIM: PF-FLAGS@ PE-N PE-IN  PE-N PE-OUT PRIM;
