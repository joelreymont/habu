...
: EMIT-SOURCE
   LBL LBL LBL LBL LBL LBL LBL LBL LBL {: sc sdone sfail srl serr rl RD rpipe done :}   \ locals BEFORE the IF (frame footgun)
   STDIN? @ IF
      9 DATA ARGC-CELL LDR,  9 1 CMPI,  C-LE sc BCOND,
