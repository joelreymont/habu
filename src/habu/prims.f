...
\
\   EPRIM: dup   PE-A PE-IN  PE-A PE-OUT PE-A PE-OUT   EPRIM;
\   EPRIM: +     PE-N PE-IN PE-N PE-IN  PE-N PE-OUT  REF PRIM-REF:+  EPRIM;
\
...
\ - `REF` names a reference implementation in checked Habu, which a parity gate
\   runs beside each backend's body.
\
...
EPRIM: dup   PE-A PE-IN  PE-A PE-OUT PE-A PE-OUT EPRIM;
EPRIM: drop  PE-A PE-IN EPRIM;
EPRIM: swap  PE-A PE-IN PE-B PE-IN  PE-B PE-OUT PE-A PE-OUT EPRIM;
EPRIM: over  PE-A PE-IN PE-B PE-IN  PE-A PE-OUT PE-B PE-OUT PE-A PE-OUT EPRIM;
EPRIM: nip   PE-A PE-IN PE-B PE-IN  PE-B PE-OUT EPRIM;
EPRIM: tuck  PE-A PE-IN PE-B PE-IN  PE-B PE-OUT PE-A PE-OUT PE-B PE-OUT EPRIM;
EPRIM: rot   PE-A PE-IN PE-B PE-IN PE-C PE-IN  PE-B PE-OUT PE-C PE-OUT PE-A PE-OUT EPRIM;
EPRIM: -rot  PE-A PE-IN PE-B PE-IN PE-C PE-IN  PE-C PE-OUT PE-A PE-OUT PE-B PE-OUT EPRIM;
EPRIM: 2dup  PE-A PE-IN PE-B PE-IN  PE-A PE-OUT PE-B PE-OUT PE-A PE-OUT PE-B PE-OUT EPRIM;
EPRIM: 2drop PE-A PE-IN PE-B PE-IN EPRIM;
EPRIM: 2swap PE-A PE-IN PE-B PE-IN PE-C PE-IN PE-D PE-IN
            PE-C PE-OUT PE-D PE-OUT PE-A PE-OUT PE-B PE-OUT EPRIM;
EPRIM: 2over PE-A PE-IN PE-B PE-IN PE-C PE-IN PE-D PE-IN
            PE-A PE-OUT PE-B PE-OUT PE-C PE-OUT PE-D PE-OUT PE-A PE-OUT PE-B PE-OUT EPRIM;

EPRIM: +      PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
...
EPRIM: *      PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: and    PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: and    PE-F PE-IN PE-F PE-IN  PE-F PE-OUT EPRIM;
EPRIM: or     PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: or     PE-F PE-IN PE-F PE-IN  PE-F PE-OUT EPRIM;
EPRIM: xor    PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: xor    PE-F PE-IN PE-F PE-IN  PE-F PE-OUT EPRIM;
EPRIM: 1+     PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: 1+     PE-PTR-A PE-IN  PE-PTR-A PE-OUT EPRIM;
EPRIM: 1-     PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: 1-     PE-PTR-A PE-IN  PE-PTR-A PE-OUT EPRIM;
EPRIM: negate PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: invert PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: 0=     PE-A PE-IN  PE-F PE-OUT EPRIM;
EPRIM: 0<     PE-N PE-IN  PE-F PE-OUT EPRIM;
EPRIM: =      PE-N PE-IN PE-N PE-IN  PE-F PE-OUT EPRIM;
...
EPRIM: >=     PE-PTR-A PE-IN PE-PTR-A PE-IN  PE-F PE-OUT EPRIM;
EPRIM: /      PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: mod    PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: /mod   PE-N PE-IN PE-N PE-IN  PE-N PE-OUT PE-N PE-OUT EPRIM;
EPRIM: abs    PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: min    PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: max    PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: lshift PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: rshift PE-N PE-IN PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: cells  PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: cell+  PE-PTR-A PE-IN  PE-PTR-A PE-OUT EPRIM;
EPRIM: cell+  PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: chars  PE-N PE-IN  PE-N PE-OUT EPRIM;
EPRIM: char+  PE-PTR-A PE-IN  PE-PTR-A PE-OUT EPRIM;
EPRIM: char+  PE-N PE-IN  PE-N PE-OUT EPRIM;
...
EPRIM: +!         PE-N PE-IN PE-PTR-N PE-IN EPRIM;
...
EPRIM: count      PE-PTR-U8 PE-IN  PE-PTR-U8 PE-OUT PE-N PE-OUT EPRIM;
...
EPRIM: data-base      PE-PTR-A PE-OUT EPRIM;
