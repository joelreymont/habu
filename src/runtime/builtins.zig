...
pub const BuiltinSymbols = struct {
    ...
    sym_simple_error: Value,
    sym_simple_condition: Value,
    sym_warning: Value,
    sym_simple_warning: Value,
    sym_serious_condition: Value,
    sym_cell_error: Value,
    sym_unbound_variable: Value,
    sym_undefined_function: Value,
    sym_arithmetic_error: Value,
    sym_division_by_zero: Value,
    sym_control_error: Value,
    sym_parse_error: Value,
    sym_stream_error: Value,
    sym_file_error: Value,
    ...
    pub fn init(heap: *Heap) !BuiltinSymbols {
        return BuiltinSymbols{
            ...
            .sym_function_cell = try heap.intern("%FUNCTION-CELL"),
            ...
            .sym_simple_error = try heap.intern("simple-error"),
            .sym_simple_condition = try heap.intern("simple-condition"),
            .sym_warning = try heap.intern("warning"),
            .sym_simple_warning = try heap.intern("simple-warning"),
            .sym_serious_condition = try heap.intern("serious-condition"),
            .sym_cell_error = try heap.intern("cell-error"),
            .sym_unbound_variable = try heap.intern("unbound-variable"),
            .sym_undefined_function = try heap.intern("undefined-function"),
            .sym_arithmetic_error = try heap.intern("arithmetic-error"),
            .sym_division_by_zero = try heap.intern("division-by-zero"),
            .sym_control_error = try heap.intern("control-error"),
            .sym_parse_error = try heap.intern("parse-error"),
            .sym_stream_error = try heap.intern("stream-error"),
            .sym_file_error = try heap.intern("file-error"),
