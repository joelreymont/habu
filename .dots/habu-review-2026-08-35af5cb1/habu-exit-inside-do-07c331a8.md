...
Current review D04, 2026-09-13: source reconfirmed at51546316/current integration (CF-EXIT10962, empty CF-UNLOOP10968, CF-I/J11003–11012; JIT J-EXIT has no loop cleanup). The August pause/approval request above is historical; the user has authorized completion. No delivered current fix or active exit-unloop agent is known. Required tests include enclosing-loop/repeated calls and quotation-boundary i/j, both tiers, preserving valid unloop exit. Claim: unassigned pending a compiler correctness lane.
