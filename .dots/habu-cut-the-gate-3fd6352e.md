...
Parked 2026-09-16 (release first): commit 1 (shared content-keyed cold engine, 44323336) landed on the line; commits 2-4 (split native-window-owner into nine suites, aot-wide-format into four, longest suites first: 0a0ba873, cc6a8495, 5f58fb7c, plus the uncommitted gate-stdlib-cases split parked as c5a13a5e on 2026-09-17; the workspace is retired and the commits live by id) are unverified scheduling changes awaiting a quiet-machine A/B gate; the per-suite timing table is in LESSONS.md. Next CPU win: the optimizing writer is recompiled for every image write (about 260 s per gate).
