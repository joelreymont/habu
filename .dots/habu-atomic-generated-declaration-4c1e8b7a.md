...
Files: a new narrowly owned core transaction module after the checker hook,
...
`FILEMAP.md`, and `TRUSTED.md` only for a proved missing typed boundary.
...
suites; typed-local, trust, package, host, filemap, and dot lints.
...
Claim: agent=decl_txn_impl workspace=.jj-ws/habu-atomic-generated-declaration-4c1e8b7a machine=spark
