...
GROOMED 2026-08-04 (dot-groom). Dangling blocker repointed. habu-tensor-core-mma-11f23a94, which
owns the raw MMA codegen this schedule integration sits on, is no longer in the graph: commit
5374f8b2f "Close MMA parity dots; mint wave-2 saturation dot" closed it and minted
habu-mma-wave-2-4d7594e7, which has since been closed and archived as well. The MMA codegen
dependency is therefore satisfied and nothing blocks this dot; the Model CAD schedule-to-plan
integration it describes is still unowned.
