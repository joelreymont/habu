---
title: Factor Darwin spawn emitters
status: active
priority: 2
issue-type: task
created-at: "\"2026-06-25T12:19:43.517014+02:00\""
---

Finding F04. Evidence: docs/factorization-review.md:32; src/habu/habu1.f:473. Root cause: BSPAWNIO/BSPAWNARGVIO/BSPAWNARGVENVIO/BSPAWNARGVENVCWDIO duplicate Darwin frame setup, file actions, descriptor zeroing, posix_spawn, success/failure handling, and cleanup. Fix: factor shared Darwin spawn helpers; wrappers should only map arity/register inputs. Why: spawn ABI boundaries are too risky to maintain as copy-expanded words. Validate on macOS with process tests and full native gate.

## Handoff Context

Moved from root `CONTEXT.md` on 2026-06-26. The conversation history is not
required; use this dot plus committed docs and current tree as authority.
...
- Historical pushed tip from the original handoff: `3194ef7666ae6da4340d2be39a385f763d0b873c`
- Historical commit subject from the original handoff: `Clean engine/imgdump stack effects`
