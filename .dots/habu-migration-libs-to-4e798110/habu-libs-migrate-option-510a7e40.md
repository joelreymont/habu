...
schema, `MATCH` order, physical width, and all 125 consumer files
byte-identically. The future lowering hash records the frozen field name
...
lints, exact 125-file unchanged census, and scratch mutation kills for arm
