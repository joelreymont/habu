...
Claim: agent=mmaparity workspace=none (device lane - sole zed owner; local commits only via the standard worker workspace if kernel-source changes emerge: .jj-ws/fable-mmapar)
