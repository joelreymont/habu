...
LIKELY DELETES WITH THE BUFFERS-AT-STARTUP LANDING (2026-08-18): when the payload ships no scratch, the zeroing has no subject at all. Verify post-landing, then close as superseded rather than re-aiming.
