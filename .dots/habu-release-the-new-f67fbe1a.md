...
Claim: alder, .jj-ws/alder-buffer-grow from hazel/integration 9ea66539.
Hazel released lib/byte-buffer.f and lib/byte-buffer-test.f for validation
before allocation and a fixture proving that no new mapping survives refusal.
