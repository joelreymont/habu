...
GROOMED 2026-08-04 (dot-groom). Dangling blocker repointed. habu-mirror-defer-is-4461fe23 is
no longer in the graph: it was closed and archived by commit 845ee68ce "Goal 7939a157: close
stage0 defer/is lane", so that stage-0 defer/is mirror is landed and the dependency is
satisfied. The other named dependencies in this contract
(habu-mirror-checker-defer-6a8a366e, habu-engine-pre-trust-77410827) still exist and are
untouched.
