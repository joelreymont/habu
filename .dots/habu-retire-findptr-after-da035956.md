...
Claim: agent=findptr workspace=.jj-ws/fable-findptr machine=spark (owns retiring FINDPTR in src/habu/aot-closure.f + its unit-test rewrite + CODELEN rows same-commit)
