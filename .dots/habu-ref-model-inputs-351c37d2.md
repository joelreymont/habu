...
Claim: agent=slotref workspace=.jj-ws/fable-slotref machine=spark (owns maki/cad.f translation emit + cad tests + the 12-block acceptance in gptblock-attn-test.f; mha lane owns mha.f + new attention files - disjoint; blrange owns src/habu - disjoint)
