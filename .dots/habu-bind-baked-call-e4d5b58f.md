...
Landed 2026-09-16 18:20 as a duplicate of b4f39957: sites bound to record indices at emit (8-byte rows, no boot lookup, three structural checks, exit 82 by name on a mismatch); 49,752 bytes of content, 2.58 M fewer instructions at start (about 207 per site), B2 == C2. Closes on the next batch gate.
