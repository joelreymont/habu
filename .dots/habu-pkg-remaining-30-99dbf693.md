...
Claim: agent=pkg-remaining workspace=.jj-ws/habu-pkg-remaining-30-99dbf693 (exclusions: fs.f, fs-mutate.f stay with the safe-filesystem recovery lane; process-pty family stays with the PTY lane)
