...
Claim: agent=gateloud workspace=.jj-ws/fable-gateloud machine=spark (owns the gate-engine loud-death hardening: test/gate-engine.f/-lib.f + red-first synthetic 256-throw)
