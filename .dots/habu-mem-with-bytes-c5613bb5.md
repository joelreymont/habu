...
Claim: agent=withbytes workspace=.jj-ws/fable-withbytes machine=spark (owns MEM:WITH-BYTES + shared frame extraction decision: lib/memory.f + possibly a new shared scope-frame lib module cuda-scope consumes + tests + manifest)
