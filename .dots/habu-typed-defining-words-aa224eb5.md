...
confirmed as box noise. REMAINING on this dot (~31 sites, unclaimed): DTC-EVAL
via a typed defining-word capability, and the private FFI pointer boundary plus
the named checked provenance mints (MMAP>PTR, VA>PTR, N>CODE-PTR, null-ptr role
et al.).
