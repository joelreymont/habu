...
Claim: agent=rmsrope workspace=.jj-ws/fable-rmsrope machine=spark (owns lib/ptx new kernel files + tools/ptx checks; GPU verification on the GB10 - sm_121a goldens, Orin rows owed later; THE session timing lane if timing is measured)
