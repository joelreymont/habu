...
Claim: agent=sealpar workspace=.jj-ws/fable-sealpar machine=spark (small engine lane: src/core/checker.f seal lists + a seal-negative test; merge coordination: census/CODELEN rows re-measured at merge like every engine lane today)
