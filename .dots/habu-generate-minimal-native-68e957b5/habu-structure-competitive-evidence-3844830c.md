...
blocks:
  - habu-migrate-competitive-schemas-bca000ec
...
Dependency review 2026-07-21: the competitive schema migration owns the row declaration and wire-compatible field spelling. The common immutable MEM borrow owns bounded retained access. This leaf consumes both and must not create parallel declaration or storage authority.
