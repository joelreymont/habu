...
Claim: agent=emitred workspace=.jj-ws/fable-emitred machine=spark (owns the EMIT-REDUCE SMEM WAR-hazard fence + perf-row re-measure + device gradcheck re-runs)
