...
Claim: agent=cpasync2 workspace=.jj-ws/fable-cpasync2 (the typestate capability itself - owns src/core/checker.f + type-family.f + lib/ptx/tile-pipe.f this session)
