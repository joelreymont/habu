...
Evidence 2026-07-15: snapshot head ca5b51f2 passes the fresh build-fixpoint snapshot build/boot/load fixture. Disposable staged-order head 2a1f081d (duplicated core chain 7bd9e13b::a90d185f on ca5b51f2; never publish) passes bootstrap-codegen, build-fixpoint-test, and `snap --force` with `snapshot image OK: candidate validated`. The Habu stepper on that fresh `hb-new` printed live DATA base 4672924418048, HERE 4672934175946, USIGS 4672933115342, and HIDX effect base 4672933115342: the restored checker owner equals live USIGS and lies inside `[DATA,HERE)`, not the dead snapshot DATA mapping.
