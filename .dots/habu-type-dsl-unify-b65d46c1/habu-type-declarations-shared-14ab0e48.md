...
Claim: agent=declevents-mac workspace=.jj-ws/habu-type-declarations-shared-14ab0e48 (owns the NEW src/core declaration-event module + its tests + FILEMAP/load rows, building on the landed sealed TYPE-FIELD arena. Previous spark claim agent=declevents verified stranded 2026-07-21: no commits exist from that lane, spark is on nanoGPT/engine lanes, and Joel confirmed the type chain is Mac-owned.)
