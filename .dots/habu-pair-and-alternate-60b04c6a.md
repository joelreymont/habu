...
Second consumer (2026-08-06): the fork json-read-perf ratchet group flakes under gate load with varying assert subsets — it needs the same paired-delta/quiet-window treatment this dot specifies for the codegen workload timings. Treat both in one design.

Claim: agent=timing workspace=.jj-ws/habu-pair-and-alternate-60b04c6a
