...
## Audit refresh (2026-07-06, head 1eb3b5d3, maki-type-families lane)
...
(SAXPY/SOFTMAX-ROWS within 1 ULP; maki trains 3 SGD epochs on the GPU). Remaining
scope: the GENERAL tensor-op selection/lowering seam (arbitrary elementwise ops,
softmax, matmul dispatch from maki tensors).
