...
Exact write set: `maki/infer/model-config.f`, `maki/infer/model-config-test.f`, `maki/infer/gpt2-tensor-test.f`, `maki/infer/gpt2-prepare-test.f`, and `maki/infer/gpt2-payload-test.f`. No parser, device loader, compatibility surface, lint, documentation, or unrelated configuration cleanup belongs here.
