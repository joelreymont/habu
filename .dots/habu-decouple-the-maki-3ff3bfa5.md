...
Claim: agent=decouple workspace=.jj-ws/fable-decouple machine=spark (owns maki/maki.f eval/train.f checkpoint-test.f adamw-test.f pos-embed-test.f + library fixtures; extroles lane owns spec.f/extent*.f - do not touch; maki/test.f registration append-only, merge risk accepted)
