...
Claim: agent=modeldev workspace=.jj-ws/fable-modeldev machine=spark (owns arch-probe wiring for maki/lower/model-device.f + the softmax-gradcheck audit fold-in habu-fix-softmax-gradcheck-a2020d85 - one landing closes both dots)
