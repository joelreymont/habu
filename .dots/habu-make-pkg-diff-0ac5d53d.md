...
Verify: bin/hb --load tools/package-diff-lint-test.f, the measured survey above rerun on the changed tree, typed-local-diff-lint and package-diff-lint on the exact diff, and host-lint.
