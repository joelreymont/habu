...
Claim: agent=rank0 workspace=.jj-ws/fable-rank0 machine=spark (owns maki/extent-tensor.f + spec/spec-test dispatch points; trainer files and lib/ptx belong to other running lanes)
