...
spill-lowering dot", and the lowering it delivered is in the tree at
src/compiler/native/spill.f (package A64SPILL). The dependency is satisfied; nothing blocks
this dot now.
