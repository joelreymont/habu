...
Capacity-order acceptance: every `BPE:OPEN` call uses the frozen named capacity constants in order, and a mutation swapping distinct vocabulary and merge capacities fails through this real table-builder entry. No state getter or allocator-observation seam exists solely for this check.
