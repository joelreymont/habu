...
- Dep: docs/maki/onnx.md + corrected M6 forward kernels (habu-fix-ptx-collective-997cfcce) + maki tensor types.

Claim: agent=onnxdev workspace=.jj-ws/fable-devgold
