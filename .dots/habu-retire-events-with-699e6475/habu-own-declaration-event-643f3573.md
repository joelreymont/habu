...
Blocker resolved (2026-07-26 metadata wave): habu-own-product-field-86660116 landed as 91b1bbd5be7d (Own product-field lifecycle in TYPE-FIELD-OWNER) and was closed and archived, so this dot is unblocked; the blocker row was removed when the archived id stopped resolving.
