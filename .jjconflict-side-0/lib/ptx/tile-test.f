...
s" PTX-GOOD-MASK-SUBDIV {: s :} s GRID-CTX {: g :} s g LOAD s g LOAD -. s g LOAD /." CHECK! -1 T=
s" PTX-BAD-MASK-SUB {: s :} s GRID-CTX {: g1 :} s GRID-CTX {: g2 :} s g1 LOAD s g2 LOAD -." PTX-CHECK-REJECTS
s" PTX-GOOD-FMA-MASK {: s a :} s GRID-CTX {: g :} a s g LOAD s g LOAD FMA." CHECK! -1 T=
s" PTX-BAD-FMA-MASK {: s a :} s GRID-CTX {: g1 :} s GRID-CTX {: g2 :} a s g1 LOAD s g2 LOAD FMA." PTX-CHECK-REJECTS
s" PTX-GOOD-SCATTER-ADD {: s :} s GRID-CTX {: g :} s g LOAD s g SCATTER-ADD" CHECK! -1 T=
s" PTX-BAD-SCATTER-ADD-MASK {: s :} s GRID-CTX {: g1 :} s GRID-CTX {: g2 :} s g1 LOAD s g2 SCATTER-ADD" PTX-CHECK-REJECTS
...
s" PTX-GOOD-ONCE {: s :} s GRID-CTX-ONCE {: g :} s g LOAD-ONCE s g STORE-ONCE" CHECK! -1 T=
...
s" PTX-BAD-MK-SPAN-LONE ( ptr<space-global,f32> ptr<space-global,f32> u32 u32 -- ) {: p q n m :} p n MK-SPAN {: x :} q m MK-SPAN {: y :} x GRID-CTX y swap LOAD drop" PTX-CHECK-REJECTS
