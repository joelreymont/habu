...
Closed 2026-07-26: landed as 9b1dad8d6e88 on master@origin. Six payload cells named from the file own accessor/serialization vocabulary; name-to-slot registry pins added because swap mutations proved value round-trips blind to field reorders in accessor-less full-mode ENUMs; registry facts (kind, width, variant order, ctor package) pinned unchanged.
