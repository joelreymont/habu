...
Closed 2026-07-26: landed on master@origin in the move #30 train as 1ed5836ae585 "Migrate extent tensor-kind to compact ENUM". Ruling R1 pinned: live-registry kind assertion (TK-ENUM) survives hostile text decoys; census baseline re-recorded with the exact two-row delta proven separable from scratch-ordinal renumbering.
