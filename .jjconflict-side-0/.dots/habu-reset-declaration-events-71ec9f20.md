...
close-reason: Absorbed into habu-guard-declaration-event-2b0f3e79, which makes REG-RESTORE the sole atomic registry-and-event reset helper instead of adding another scattered reset.
---
