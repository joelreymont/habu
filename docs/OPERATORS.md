...
**Total Operators**: 210 (182 core + 28 c[ad]r combinations)
**Test Coverage**: 493 compiler tests (100% passing)
...
Summary:
- **Arithmetic** (38): +, -, *, /, mod, rem, min, max, abs, 1+, 1-, signum, gcd, lcm, isqrt, integer-length, expt, square, neg, log2, cube, double, half, avg, range, quot, reciprocal, sqr, lerp, median3, map-range, nearest-multiple, triangle-number, factorial, fibonacci, next-power-of-2, prev-power-of-2, pentagonal-number, hexagonal-number
...
**Total: 182 core operators + 28 c[ad]r combinations = 210 operators**
