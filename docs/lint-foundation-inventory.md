...
- `tools/diag-origin-core.f`, `tools/diag-origin.f`,
  `tools/check-all-errors-core.f`, and `tools/check-all-errors.f` load this
  foundation for source-origin diagnostics.
