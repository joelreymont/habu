...
- **File:** `../hoist/src/backends/aarch64/emit.zig` (emitLdr)
...
- **File:** habu `src/jit/backend.zig` (IrTranslator.cachedIconst)
...
- **File:** hoist `../hoist/src/codegen/compile.zig` (jump handler)  
...
- **File:** hoist `../hoist/src/regalloc/linear_scan.zig`
...
- **File:** hoist `../hoist/src/codegen/compile.zig` or regalloc
