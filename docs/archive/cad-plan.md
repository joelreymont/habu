> **ARCHIVED 2026-07-18.** Superseded by `MODEL-CAD-V2-PLAN.md` on 2026-07-11.
> The living measured record (compute-bound campaign, §8.1) now lives in
> `docs/compute-campaign.md`. History only — do not edit.
