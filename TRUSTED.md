...
| N>VARIANT | `n -- TYPE-FIELD:variant-id` | Private mint after variant lookup or committed-row validation. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| SCHEMA>N | `TYPE-FIELD:schema-id -- n` | Private projection of a validated schema-root role. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| N>SCHEMA | `n -- TYPE-FIELD:schema-id` | Private mint after schema-root bounds validation. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| SLOT>N | `TYPE-FIELD:slot -- n` | Private projection of a nonnegative layout slot role. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| N>SLOT | `n -- TYPE-FIELD:slot` | Private mint after slot validation or committed-row lookup. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| CELLS>N | `TYPE-FIELD:cell-count -- n` | Private projection of a nonnegative field cell-count role. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| N>CELLS | `n -- TYPE-FIELD:cell-count` | Private mint after cell-count validation or committed-row lookup. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| BYTE-OFF>N | `TYPE-FIELD:byte-off -- n` | Private projection of a nonnegative byte-offset role. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| N>BYTE-OFF | `n -- TYPE-FIELD:byte-off` | Private mint after byte-offset validation or committed-row lookup. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| BYTE-SIZE>N | `TYPE-FIELD:byte-size -- n` | Private projection of a nonnegative byte-size or destination-capacity role. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| N>BYTE-SIZE | `n -- TYPE-FIELD:byte-size` | Private mint after byte-size validation or committed-row lookup. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| ALIGN>N | `TYPE-FIELD:alignment -- n` | Private projection of a validated power-of-two alignment role. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| N>ALIGN | `n -- TYPE-FIELD:alignment` | Private mint after alignment validation or committed-row lookup. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| FLAGS>N | `TYPE-FIELD:field-flags -- n` | Private projection of field flags constrained to the public and byte mask. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| N>FLAGS | `n -- TYPE-FIELD:field-flags` | Private mint for named flag constructors or committed-row lookup. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| SOURCE-ID>N | `TYPE-FIELD:source-id -- n` | Private projection of a nonnegative source-id role. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| N>SOURCE-ID | `n -- TYPE-FIELD:source-id` | Private mint after source-id validation or committed-row lookup. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| SOURCE-OFF>N | `TYPE-FIELD:source-off -- n` | Private projection of a nonnegative source-offset role. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| N>SOURCE-OFF | `n -- TYPE-FIELD:source-off` | Private mint after source-offset validation or committed-row lookup. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
| SOURCE-LEN>N | `TYPE-FIELD:source-len -- n` | Private projection of a nonnegative source-length role. | `test/type-field-suite.f` | src/core/type-field.f | 2026-07-17 |
...
src/core/type-field.f:N>FAMILY prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:VARIANT>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>VARIANT prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:SCHEMA>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>SCHEMA prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:SLOT>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>SLOT prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:CELLS>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>CELLS prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:BYTE-OFF>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>BYTE-OFF prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:BYTE-SIZE>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>BYTE-SIZE prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:ALIGN>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>ALIGN prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:FLAGS>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>FLAGS prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:SOURCE-ID>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>SOURCE-ID prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:SOURCE-OFF>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>SOURCE-OFF prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:SOURCE-LEN>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>SOURCE-LEN prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:VIS>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>VIS prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:COUNT>N prim-axiom habu-epic-one-structure-04f9804f
src/core/type-field.f:N>COUNT prim-axiom habu-epic-one-structure-04f9804f
...
src/core/type-field.f:RAW-FAMILY-RESOLVE stdlib-boundary habu-epic-one-structure-04f9804f
src/core/type-field.f:RAW-FAMILY-PKG$ stdlib-boundary habu-epic-one-structure-04f9804f
