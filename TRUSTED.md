...
| SM-EMIT | `n n n n -- ` | STRUCTURE generator seam: consumes the live declaration token, family, field-range start, and count; every provisional schema read is revalidated by DECL-EVENT before the sealed mutation rebuilds roots and generates MAKE/UNMAKE. | `test/structure-make-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/structure-make.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
