...
| F64>BITS | `r -- n` | Shared IEEE-754 boundary: reinterpret one Habu f64 cell as its exact bit pattern so checked F32, F16, and BF16 encoders can implement field extraction and round-to-nearest-even. | `lib/ieee754-test.f`, `lib/float32-test.f`, `lib/ptx/header-test.f` | lib/ieee754.f | 2026-07-21 | stdlib-boundary | habu-infer-gpt-2-412c6f04 |
| BITS>F64 | `n -- r` | Shared IEEE-754 boundary: reinterpret an exact binary64 bit construction as a Habu float, including signed zero, normals, gradual underflow, infinity, and NaN payloads. | `lib/ieee754-test.f`, `lib/float32-test.f`, `lib/ptx/header-test.f` | lib/ieee754.f | 2026-07-21 | stdlib-boundary | habu-infer-gpt-2-412c6f04 |
