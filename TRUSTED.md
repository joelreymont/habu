...
| TBL>BLOCK | `WSTORE:table -- WSTORE:table ptr n` | Reads the block address back out of a live sealed table without consuming it, so U32-LE@? can validate a nominal slot and read its row. Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
...
| BUF>REC | `WSTORE:buffer -- WSTORE:buffer ptr n` | Reads the record address back out of a live buffer owner without consuming it, so the allocated arm can validate its full four-byte window and read the value. Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
...
| BOFF>N | `CAD-NUM:byte-off -- n` | Private WSTORE proof-erasure projection: reads a validated byte offset for native row storage and native table-row address arithmetic. No public inverse, so offset and extent roles cannot swap (the byte-buffer.f BLEN>N discipline). | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| BLEN>N | `CAD-NUM:byte-len -- n` | Private WSTORE proof-erasure projection: reads a validated byte extent for native row and owner-record storage. No public inverse (the byte-buffer.f BLEN>N discipline). | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
