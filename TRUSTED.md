...
| BLOCK>BYTES | `ptr n -- ptr u8` | Byte view of a SAFET session/census block, needed for the name arena, the unescape scratch and the block release. Applied only to an address one of the owner leaves above just produced, and package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-25 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
