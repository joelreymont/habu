...
| ST.ALLOCATOR | `ptr a -- ptr [ ptr a n n -- ptr a ]` | Aggregate coordinator-state field cast: recovers the allocator quotation type stored and checked by INIT from its mixed-layout state record. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/declaration-transaction.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| ST.DIAGNOSTIC | `ptr a -- ptr [ n n -- ]` | Aggregate coordinator-state field cast: recovers the diagnostic quotation type stored and checked by INIT from its mixed-layout state record. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/declaration-transaction.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| ROW.SNAPSHOT | `ptr a -- ptr [ n -- n ]` | Aggregate participant-row field cast: gives the snapshot slot its declared callback effect without splitting one failure-atomic row into parallel allocations. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/declaration-transaction.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| ROW.PREPARE | `ptr a -- ptr [ n -- n ]` | Aggregate participant-row field cast: gives the prepare slot its declared callback effect without splitting one failure-atomic row into parallel allocations. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/declaration-transaction.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| ROW.COMMIT | `ptr a -- ptr [ n -- n ]` | Aggregate participant-row field cast: gives the commit slot its declared callback effect without splitting one failure-atomic row into parallel allocations. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/declaration-transaction.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| ROW.ROLLBACK | `ptr a -- ptr [ n -- n ]` | Aggregate participant-row field cast: gives the rollback slot its declared callback effect without splitting one failure-atomic row into parallel allocations. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/declaration-transaction.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| ROW.RELEASE | `ptr a -- ptr [ -- ]` | Aggregate participant-row field cast: gives the release slot its declared total zero-input zero-output callback effect without splitting one failure-atomic row into parallel allocations. | `test/generated-declaration-transaction-suite.f`, `test/declaration-release-inventory.f`, `test/run.f` | src/core/declaration-transaction.f | 2026-07-25 | stdlib-boundary | habu-make-txn-release-c9892c89 |
| TABLE-ARENA-GROW | `ptr a n n -- ptr a` | Coordinator arena boundary: grows the single aggregate participant-row table so allocator failure leaves table identity, capacity, count, and allocation high-water unchanged. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/declaration-transaction.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| CATCH-DIAGNOSTIC | `n n [ n n -- ] -- ` | Supplemental-diagnostic boundary: invokes the instance diagnostic under `catch` and discards a diagnostic failure so it cannot replace the primary or cleanup error. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/declaration-transaction.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| INSTALL-DECLARATION-RUNNER | `-- ` | Sealed pre-hook bridge: installs the coordinator quotation in the legacy declaration runner defer and arms it after all coordinator state and the checker participant are initialized. | `test/generated-declaration-transaction-suite.f`, `test/type-decl-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| ARM-GROW | `ptr a n n -- ptr a` | Constructor-participant arena boundary: grows the one armed-family cell per declaration nesting level; raw relocating-memory grow the checker cannot model. Called only from SNAPSHOT, which is the phase allowed to allocate, so the later phases and the total RELEASE only read and write an existing cell. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| FAM-PUBLIC? | `n -- bool` | Type-family registry read: forwards to the pre-hook `TFAM-PUBLIC?` for the visibility half of the generation gate; a private family exports nothing and derives no constructor package. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| FAM-SUM? | `n -- bool` | Type-family registry read: forwards to the pre-hook `TFAM-SUM?` for the full-mode half of the ENUM kind gate. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| FAM-ENUM? | `n -- bool` | Type-family registry read: forwards to the pre-hook `TFAM-ENUM?` for the compact-mode half of the ENUM kind gate; both modes generate so the front end matches the legacy definer the global-token cutover replaces. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| FAM-VAR-START | `n -- n` | Type-family registry read: forwards to the pre-hook `TFAM-VAR-START@` for the first variant row of the family being generated. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| FAM-VAR-COUNT | `n -- n` | Type-family registry read: forwards to the pre-hook `TFAM-VAR-COUNT@` for the variant-count half of the generation gate and the generated set size. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| CTOR-COLLIDE | `n n n -- ` | Generator gate: forwards to the pre-hook `TDECL-DERIVE-COLLIDE`, which rejects a variant spelled like a word the same DERIVE clause generates; the checker cannot type the sealed pre-hook generator from a post-hook checked body. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| CTOR-REQUIRE | `n n n -- ` | Generator gate: forwards to the pre-hook `TDECL-DERIVE-REQUIRE`, which proves every payload role is derivably comparable. It reads committed SUMV and TYPE-FIELD rows, which is why it runs at ORDER 820 rather than in the declaration body. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| CTOR-PUBLISH | `n n n -- ` | Constructor-metadata seam: forwards to the pre-hook `TDECL-CTOR-PUBLISH`, which derives the family constructor package and stamps it on every variant row. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| CTOR-PROVIDER | ` -- n [ n n n -- n ] [ n n n n -- n ] [ n n n -- n ]` | Payload-provider seam: forwards to the pre-hook `TDECL-SUMV-PROVIDER`, the committed payload view the legacy definers pass. Valid here because DECL-EVENT commits at ORDER 800 and has already promoted this declaration field rows past `PF-COMMIT-N`. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| CTOR-GEN | `n [ n n n -- n ] [ n n n n -- n ] [ n n n -- n ] n -- n` | Generator entry: forwards to the pre-hook `TDECL-CTOR-WORDS-BODY`, which renders, evaluates, certifies and seals one family whole constructor set and clears the pending authority on every exit. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
| PEND-CLEAR | ` -- ` | Pending-constructor authority reset: forwards to the pre-hook `CTOR-PEND-CLEAR`. Establishes the empty queue a declaration must start from and restores it after a generation failure; three plain stores, so the rollback and release paths stay total. | `test/enum-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-25 | stdlib-boundary | habu-enum-generate-named-1f3261a3 |
...
| RP-BODY@ | ` -- ptr u8 n` | Replayed-declaration body-buffer read (package `DECL-REPLAY`): answers the buffer as a typed span, which is what lets the whitespace token scan above it stay ordinary checked Habu. Same span boundary as `RP-HEAD!`. | `test/enum-decl-suite.f`, `test/structure-decl-suite.f`, `test/decl-replay-verify-source.f`, `test/run.f` | src/core/generated-declaration.f | 2026-07-26 | stdlib-boundary | habu-cut-global-enum-56ca54e2 |
| EV | `ptr u8 n -- ` | Declaration-probe boundary: `evaluate` over caller-supplied declaration source so the probe drives the real front end rather than a model of it. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| TRY | `ptr u8 n -- n` | Declaration-probe boundary: evaluates the declaration under `catch` so a rejected declaration is reported as a stage outcome instead of ending the probe. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| FAM-FIND | `ptr u8 n -- n bool` | Type-family registry read: resolves the probed family tail in the active package through the pre-hook `TFAM-SIG-RESOLVE`. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| FAM-VAR-START | `n -- n` | Type-family registry read: forwards to the pre-hook `TFAM-VAR-START@` for the first variant row to render. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| FAM-VAR-COUNT | `n -- n` | Type-family registry read: forwards to the pre-hook `TFAM-VAR-COUNT@` for the number of constructors to render. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| FAM-SLOTS | `n -- n` | Type-family registry read: forwards to the pre-hook `TFAM-SLOTS@`; the payload slot count is what decides how many zero pads a rendered constructor body carries. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| FAM-PUBLIC? | `n -- bool` | Type-family registry read: forwards to the pre-hook `TFAM-PUBLIC?`; a private family renders with an empty constructor package, which the probe reports rather than hides. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| PROVIDER | ` -- n [ n n n -- n ] [ n n n n -- n ] [ n n n -- n ]` | Payload-provider seam: forwards to the pre-hook `TDECL-SUMV-PROVIDER` so the probe reads the same committed view the production generator reads. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| CAPTURE | `n [ n n n -- n ] [ n n n n -- n ] [ n n n -- n ] n -- ` | Generator stage boundary: forwards to the pre-hook `TDPV-CAPTURE` so the payload-view stage can be caught and reported on its own. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| PLAN-BEGIN | ` -- ` | Generator stage boundary: forwards to the pre-hook `TDPLAN-BEGIN` to start a fresh plan buffer for the render stage. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| PLAN-ROWS | ` -- n` | Plan-buffer read: forwards to the pre-hook `TDPLAN-N` so the probe can dump exactly the rows the render stage produced. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| PLAN-DEF$ | `n -- ptr u8 n` | Plan-buffer read: forwards to the pre-hook `TDPLAN-DEF$` to read one rendered definition back as text. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| RENDER-ONE | `n n -- ` | Generator stage boundary: forwards to the pre-hook `TDECL-CTOR-WORD` so rendering can be caught separately from evaluation. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| PEND-CLEAR | ` -- ` | Pending-constructor authority reset: forwards to the pre-hook `CTOR-PEND-CLEAR` so the probe leaves no queued authority behind on any exit. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| VAR-CTOR-SYM | `n -- n` | Variant-registry read: forwards to the pre-hook `SUMV-CTOR-SYM@`. A non-zero constructor symbol means the family already generated, which is the condition the probe refuses to re-render rather than trip sumtype.f own duplicate-name guard. | `test/enum-decl-suite.f`, `test/run.f` | tools/decl-gen-probe.f | 2026-07-25 | test-metaprog | habu-enum-generate-named-1f3261a3 |
| FRAME-GROW | `ptr a n n -- ptr a` | Dictionary-participant arena boundary: grows one aggregate savepoint table holding dictionary-record, code, and data high-waters for nested declaration transactions. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration-dictionary.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| DICTIONARY-DP! | `ptr a -- ` | Dictionary rollback boundary: restores the native data-dictionary pointer paired with checked `ndict!` and `cp!` after the savepoint is proven above the sealed engine watermark. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration-dictionary.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| ARENA-GROW | `ptr a n n -- ptr a` | Protection-participant arena boundary: grows staged wordlist and nesting-baseline storage; checked PREPARE proves irreversible registry capacity before the last ordered COMMIT publishes any staged wordlist. | `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/generated-declaration-protection.f | 2026-07-21 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
...
| SM-EMIT-ROWS | `n n n n -- ` | STRUCTURE registration seam: consumes the live declaration token, family, field-range start, and count; every provisional schema read is revalidated by DECL-EVENT before the sealed mutation rebuilds roots, adds the make/unmake variant rows, sets the variant range, and stamps the constructor package. Split from the word rendering below so a replayed declaration (`tools/check-core.f`, `src/habu/verify-source.f`) can register a STRUCTURE without defining anything — those rows are how a later `FAMILY:MAKE` in the same source resolves, so they are registration, not generation. | `test/structure-make-suite.f`, `test/structure-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/structure-make.f | 2026-07-26 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| SM-EMIT-WORDS | `n -- ` | STRUCTURE generation seam: forwards to the pre-hook `TDECL-PROD-WORDS`, which renders, evaluates, certifies and seals the MAKE/UNMAKE pair. This is the only step a replayed declaration skips, and the mutation that removes that gate reds the STRUCTURE and verify-source parity suites. | `test/structure-make-suite.f`, `test/structure-decl-suite.f`, `test/generated-declaration-transaction-suite.f`, `test/run.f` | src/core/structure-make.f | 2026-07-26 | stdlib-boundary | habu-atomic-generated-declaration-4c1e8b7a |
| FAM-DECL | `ptr u8 n n ptr u8 n n n -- n` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-DECL` (register the product family with case/duplicate/arity/kind gates); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| FAM-LAYOUT! | `n n -- ` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-LAYOUT!` (set the family layout policy from the POLICY clause); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| FAM-EQ! | `n -- ` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-DERIVE-EQ!` (mark the family as deriving equality); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| FAM-HASH! | `n -- ` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-DERIVE-HASH!` (mark the family as deriving hash); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| FAM-FLD-RANGE! | `n n n -- ` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-FLD-RANGE!` (bind the family field range at close); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| FAM-SLOTS! | `n n -- ` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-SLOTS!` (bind the product cell width at close); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| FAM-PUBLIC? | `n -- bool` | Type-family registry read seam: forwards to the pre-hook `TFAM-PUBLIC?` (family visibility, for the DERIVE guard); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| FAM-ARITY@ | `n -- n` | Type-family registry read seam: forwards to the pre-hook `TFAM-ARITY@` (family arity, for the DERIVE guard); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
...
| PKG-MODE@ | `-- n` | Checker package-scope seam: reads the sealed pre-hook `CHECKER-PACKAGE-MODE` cell (active visibility for a declaration); the checker cannot type sealed-cell access from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| CANON? | `ptr u8 n -- bool` | Name-token seam: forwards to the pre-hook `TF-CANON?` (lowercase canonical family-tail check); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| GRAMMAR-KW? | `ptr u8 n -- bool` | Name-token seam: forwards to the pre-hook `TF-GRAMMAR-KEYWORD?` (reserved grammar-keyword check for a family name); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| CONTROL-KW? | `ptr u8 n -- bool` | Name-token seam: forwards to the pre-hook `TYPE-NAME:CONTROL?`, the single owner of the control-word list (`if`, `then`, `do`, `match`, …) that no declaration name may spell; the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-26 | stdlib-boundary | habu-cut-global-enum-56ca54e2 |
| CON-CODE | `ptr u8 n -- n` | Type-token seam: forwards to the pre-hook `CON-OF` (concrete-type name to con code, 0 if unknown); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
...
| DV-HASH | `-- n` | Named-constant seam: reads the sealed pre-hook derive feature code `DRV-HASH` (recorded on the DERIVE event); the checker cannot resolve the sealed constant from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| PKG-PUBLIC | `-- n` | Named-constant seam: reads the sealed pre-hook `CHECKER-PACKAGE-PUBLIC` visibility code (top-level declarations are public); the checker cannot resolve the sealed constant from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SD-SCH-CON | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-CON` (build a concrete-con field schema node); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SD-SCH-PARAM | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-PARAM` (build a positional-parameter field schema node); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SD-SCH-PTR | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-PTR` (build a `ptr T` field schema node); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SD-SCH-APP | `n n n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-APP` (build a nested-family application field schema node); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SCH-ROOT+ | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-ROOT+` (append a field schema root, returning its index); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SCH-ROOT@ | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-ROOT@` (read the node at a schema-root index, for width); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SCH-APP? | `n -- bool` | Schema-node seam: forwards to the pre-hook `SCHEMA-APP?` (is a node a family application, for width); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SCH-A@ | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-A@` (node A slot = applied family id, for width); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SCH-OWNS-LINEAR? | `n -- bool` | Schema-node seam: forwards to the pre-hook `TFCL-NODE?` (does this node reach a linear value), the single authority the linearity accounting already trusts; asked in `RESOLVE-TYPE`'s ptr branch so a field spelled as a pointer to a linear owner is refused at the declaration door. The checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-26 | stdlib-boundary | habu-checker-enum-payload-9e1ae6cc |
| FLAGS-NONE | `-- n` | Named-constant seam: reads the sealed pre-hook `PF-FLAGS-NONE` field-record layout flag; the checker cannot resolve the sealed constant from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| TK-PROD | `-- n` | Named-constant seam: reads the sealed pre-hook `TK-PRODUCT` family-kind code (STRUCTURE registers a product); the checker cannot resolve the sealed constant from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| PEND! | `ptr u8 n -- ` | One-token pushback: stores a `ptr u8 n` token span into plain cells; round-tripping a byte pointer through a cell is not typeable without ptr-field modeling the checker cannot express here. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| PEND@ | `-- ptr u8 n` | One-token pushback: reads the stored `ptr u8 n` token span back from plain cells; recovering a byte-pointer role from a cell is not typeable without ptr-field modeling the checker cannot express here. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| FAM-DECL | `ptr u8 n n ptr u8 n n n -- n` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-DECL` (register the enum family — `TK-SUM` for a full declaration, `TK-ENUM` for a compact one — with the case/duplicate/arity/kind gates); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| FAM-LAYOUT! | `n n -- ` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-LAYOUT!` (set the family layout policy from the POLICY clause); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| FAM-EQ! | `n -- ` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-DERIVE-EQ!` (mark the family as deriving equality); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| FAM-HASH! | `n -- ` | Type-family registry mutation seam: forwards to the pre-hook `TFAM-DERIVE-HASH!` (mark the family as deriving hash); the checker cannot type the sealed pre-hook registry word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
...
| PKG-MODE@ | `-- n` | Checker package-scope seam: reads the sealed pre-hook `CHECKER-PACKAGE-MODE` cell (active visibility for a declaration); the checker cannot type sealed-cell access from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| CANON? | `ptr u8 n -- bool` | Name-token seam: forwards to the pre-hook `TF-CANON?` (lowercase canonical family-tail check); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| GRAMMAR-KW? | `ptr u8 n -- bool` | Name-token seam: forwards to the pre-hook `TF-GRAMMAR-KEYWORD?` (reserved grammar-keyword check for a family name); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| CONTROL-KW? | `ptr u8 n -- bool` | Name-token seam: forwards to the pre-hook `TYPE-NAME:CONTROL?`, the single owner of the control-word list (`if`, `then`, `do`, `match`, …) that no declaration name may spell; the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-26 | stdlib-boundary | habu-cut-global-enum-56ca54e2 |
| CON-CODE | `ptr u8 n -- n` | Type-token seam: forwards to the pre-hook `CON-OF` (concrete-type name to con code, 0 if unknown); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| SUMV-N@ | `-- n` | Variant-cursor read seam: reads the sealed pre-hook `SUMV-N` variant high-water (the variant range start captured at open); the checker cannot type sealed-cell access from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
...
| DV-HASH | `-- n` | Named-constant seam: reads the sealed pre-hook derive feature code `DRV-HASH` (recorded on the DERIVE event); the checker cannot resolve the sealed constant from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| PKG-PUBLIC | `-- n` | Named-constant seam: reads the sealed pre-hook `CHECKER-PACKAGE-PUBLIC` visibility code (top-level declarations are public); the checker cannot resolve the sealed constant from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| ED-SCH-CON | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-CON` (build a concrete-con field schema node); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| ED-SCH-PARAM | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-PARAM` (build a positional-parameter field schema node); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| ED-SCH-PTR | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-PTR` (build a `ptr T` field schema node); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| ED-SCH-APP | `n n n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-APP` (build a nested-family application field schema node); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| SCH-ROOT+ | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-ROOT+` (append a field schema root, returning its index); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| SCH-ROOT@ | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-ROOT@` (read the node at a schema-root index, for width); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| SCH-APP? | `n -- bool` | Schema-node seam: forwards to the pre-hook `SCHEMA-APP?` (is a node a family application, for width); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| SCH-A@ | `n -- n` | Schema-node seam: forwards to the pre-hook `SCHEMA-A@` (node A slot = applied family id, for width); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| SCH-OWNS-LINEAR? | `n -- bool` | Schema-node seam: forwards to the pre-hook `TFCL-NODE?` (does this node reach a linear value), the single authority the linearity accounting already trusts; asked in `RESOLVE-TYPE`'s ptr branch so a variant payload spelled as a pointer to a linear owner is refused at the declaration door. The checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-26 | stdlib-boundary | habu-checker-enum-payload-9e1ae6cc |
| FLAGS-NONE | `-- n` | Named-constant seam: reads the sealed pre-hook `PF-FLAGS-NONE` field-record layout flag; the checker cannot resolve the sealed constant from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| TK-SUM-K | `-- n` | Named-constant seam: reads the sealed pre-hook `TK-SUM` family-kind code (a full ENUM registers a named-variant tagged sum); the checker cannot resolve the sealed constant from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| TK-ENUM-K | `-- n` | Named-constant seam: reads the sealed pre-hook `TK-ENUM` family-kind code (a compact ENUM registers a payloadless enum); the checker cannot resolve the sealed constant from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| PEND! | `ptr u8 n -- ` | One-token pushback: stores a `ptr u8 n` token span into plain cells; round-tripping a byte pointer through a cell is not typeable without ptr-field modeling the checker cannot express here. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| PEND@ | `-- ptr u8 n` | One-token pushback: reads the stored `ptr u8 n` token span back from plain cells; recovering a byte-pointer role from a cell is not typeable without ptr-field modeling the checker cannot express here. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
...
| CU-MEM-HOST-REGISTER | `n len n -- rc` | Exact CUDA `cuMemHostRegister_v2` binding: host address by value, byte size, flags; registers an mmap'd host mapping for device access (UMA weight-residency probe). | `maki/infer/residency-probe.f` | lib/ptx/cuda-driver.f | 2026-07-21 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| CU-MEM-HOST-GET-DEVICE-POINTER | `ptr a n n -- rc` | Exact CUDA `cuMemHostGetDevicePointer_v2` binding: fixes the output to one writable cell, host address by value, flags. | `maki/infer/residency-probe.f` | lib/ptx/cuda-driver.f | 2026-07-21 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| CU-MEM-HOST-UNREGISTER | `n -- rc` | Exact CUDA `cuMemHostUnregister` binding: host address by value; releases a prior host registration. | `maki/infer/residency-probe.f` | lib/ptx/cuda-driver.f | 2026-07-21 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| N>PTR | `n -- ptr u8` | Reinterprets the `mmap` numeric result as a typed byte pointer so the safetensors loader can read a checkpoint zero-copy; the checker cannot express this syscall-result refinement. Package-private to SAFET-MAP, which owns every file-mapping syscall in the loader. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-25 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| MINT-SESSION | `ptr u8 -- SAFET:session` | Mints the linear load-session owner from the private block that SAFET:OPEN just allocated. A session token IS its block, so the leaf is an identity; the checker cannot express "this pointer is a freshly initialised SAFET block". Package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-25 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| SESSION>BLOCK | `SAFET:session -- SAFET:session ptr n` | Reads the block address back out of a live session owner without consuming it, so checked session words can address their own fields. Package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-25 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TAKE-SESSION | `SAFET:session -- ptr n` | Consumes a session owner and yields its block for disposal; the single crossing that ends a session's life, used only by SAFET:CLOSE. Package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-25 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| SESSION>CENSUS | `SAFET:session -- SAFET:census` | Publishes a fully validated session as an immutable census owner over the same block. The block is unchanged, so this is an identity retype the checker cannot express; SAFET:DETACH validates the publication precondition before calling it. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-25 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| CENSUS>BLOCK | `SAFET:census -- SAFET:census ptr n` | Reads the block address back out of a live census owner without consuming it, so every checked census reader addresses its own census. Package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-25 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TAKE-CENSUS | `SAFET:census -- ptr n` | Consumes a census owner and yields its block for disposal; the single crossing that ends a census's life, used only by SAFET:RELEASE. Package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-25 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| MINT-MAPPING | `ptr u8 -- SAFET:mapping` | Mints the linear file-mapping owner from the three-cell record that SAFET:PARSE reserved and SAFET:DETACH-MAPPING just moved. A mapping token IS its record, so the leaf is an identity; the checker cannot express "this pointer is a freshly filled SAFET mapping record". Package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| MAPPING>REC | `SAFET:mapping -- SAFET:mapping ptr n` | Reads the record address back out of a live mapping owner without consuming it, so WITH-MAPPING can address its own base and length. Package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TAKE-MAPPING | `SAFET:mapping -- ptr n` | Consumes a mapping owner and yields its record for disposal; the single crossing that ends a mapping's life, used only by SAFET:UNMAP-MAPPING. Package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| BLOCK>BYTES | `ptr n -- ptr u8` | Byte view of a SAFET session/census block or mapping record, needed for the name arena, the unescape scratch and the block release. Applied only to an address one of the owner leaves above just produced, and package-private to SAFET. | `maki/infer/safetensors-test.f` | maki/infer/safetensors.f | 2026-07-25 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| RP-N>PTR | `n -- ptr u8` | Reinterprets the host mapping numeric address as a byte pointer for the HtoD populate copy in the residency probe; the checker cannot express this address refinement. | `maki/infer/residency-probe.f` | maki/infer/residency-probe.f | 2026-07-21 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| MINT-CFG-PROOF | `-- cfg-proof` | Private model-config mint: the proof token sealing a validated `MDLCFG:mcfg`, minted only as `MDLCFG:BUILD`'s final act after every field-class validation and the cfgkey fold, so a raw n cannot forge an mcfg and no partially validated value ever carries a key (rev-4 correction 2; the maki/typestate.f `MINT-BUILD-PROOF` shape). | `maki/infer/model-config-test.f` | maki/infer/model-config.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| MINT-PROV-PROOF | `-- prov-proof` | Private provenance mint: the proof token sealing a `MODELPROV:mprov`, minted only as `MODELPROV:PIN`'s final act after every input class is validated, the tensor artifact is digested and matched, and the preimage is folded, so a raw four-cell value cannot pose as a provenance pin. Its family is distinct from `MDLCFG:cfg-proof`, which is what keeps the artifact-set and behavioral-configuration identity domains from collapsing (the maki/typestate.f `MINT-BUILD-PROOF` shape). | `maki/infer/model-provenance-test.f` | maki/infer/model-provenance.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| PLEN>N | `CAD-NUM:byte-len -- n` | Private MODELPROV proof-erasure projection: reads the validated artifact-path length back into the bare cell that the core NUL-terminating path primitive (`src/core/util.f` PATHZ, via SHA256-FILE-HEX) still consumes. Taking the role in PIN's signature is what makes an unvalidated length statically unable to reach that primitive; this leaf is the single audited crossing back, one line before the call, with no public inverse (the byte-buffer.f BLEN>N discipline). | `maki/infer/model-provenance-test.f` | maki/infer/model-provenance.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| MINT-TBUILDER | `ptr u8 -- WSTORE:tbuilder` | Mints the linear table-builder owner from the block WSTORE:TABLE-NEW just allocated. A builder token IS its block, so the leaf is an identity; the checker cannot express "this pointer is a freshly initialised WSTORE block". Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TB>BLOCK | `WSTORE:tbuilder -- WSTORE:tbuilder ptr n` | Reads the block address back out of a live builder without consuming it, so SLOT! and SEAL can address the slot rows. Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TB>TABLE | `WSTORE:tbuilder -- WSTORE:table` | Publishes a fully populated builder as the immutable sealed table over the same block. The block is unchanged, so this is an identity retype the checker cannot express; WSTORE:SEAL validates full population before calling it. Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TBL>BLOCK | `WSTORE:table -- WSTORE:table ptr n` | Reads the block address back out of a live sealed table without consuming it, so WITH-SLOT can read one row. Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TAKE-TABLE | `WSTORE:table -- ptr n` | Consumes a table owner and yields its block for disposal; the single crossing that ends a table's life, used only by DISPOSE's table free. Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| MINT-BUFFER | `ptr u8 -- WSTORE:buffer` | Mints the linear buffer owner from the two-cell record WSTORE:BUFFER just allocated. A buffer token IS its record, so the leaf is an identity; the checker cannot express "this pointer is a freshly filled WSTORE buffer record". Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| BUF>REC | `WSTORE:buffer -- WSTORE:buffer ptr n` | Reads the record address back out of a live buffer owner without consuming it, so the allocated arm can serve a sub-span. Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TAKE-BUFFER | `WSTORE:buffer -- ptr n` | Consumes a buffer owner and yields its record for disposal; the single crossing that ends a buffer's life, used only by DISPOSE's buffer free. Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| BLK>BYTES | `ptr n -- ptr u8` | Byte view of a WSTORE table block or buffer record for the MEM release path, applied only to an address one of the owner leaves above just produced. Package-private to WSTORE (the SAFET BLOCK>BYTES shape). | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| MINT-RESIDENT | `ptr u8 -- WSTORE:resident` | Mints the single-cell residency handle from the store's own table block, which HOLD has just filled. Builder, table and resident are ONE allocation retyped in turn, so this is the same identity retype SEAL performs and the checker cannot express "this pointer is a filled WSTORE residency block". Package-private to WSTORE. Retires with the pointer-lifetime/region-type capability, habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TAKE-RESIDENT | `WSTORE:resident -- ptr n` | Consumes a residency handle and yields its block so RESIDENT-DISPOSE can read the parked arm and rebuild the store; the single crossing that ends a resident's life. Package-private to WSTORE. Retires with habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| MAP>N | `SAFET:mapping -- n` | Parks the mapped arm's file-mapping owner in the residency block as one raw cell. A DEFLINEAR carries no fields, so a single-cell owner cannot be stored as a typed value; a store cannot be a record field either, because a compound field may not transitively contain a linear owner (habu-checker-enum-payload-9e1ae6cc). From this crossing until N>MAP the checker cannot see the mapping, so "owned exactly once" is held by WSTORE's structure — one park site in HOLD's mapped arm, one recovery site in RESIDENT-DISPOSE, no accessor — and by the SAFET:LIVE-OWNERS and SAFET-MAP:LIVE assertions the suite makes around every transaction. Package-private to WSTORE, no public inverse. Retires with the linear-scope combinator habu-checker-linear-scope-6218899c. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| N>MAP | `n -- SAFET:mapping` | Reads the parked file-mapping owner back out of the residency block so RESIDENT-DISPOSE can rebuild the mapped store and hand it to DISPOSE. The sole inverse of MAP>N and reachable only from the one word that ends a resident's life, so a mapping cannot be recovered twice. Package-private to WSTORE. Retires with habu-checker-linear-scope-6218899c. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| BUF>N | `WSTORE:buffer -- n` | Parks the allocated arm's buffer owner in the residency block as one raw cell, for the same reason as MAP>N and with the same loss of checker visibility; WSTORE:LIVE is what makes a stranded buffer record observable. Package-private to WSTORE, no public inverse. Retires with habu-checker-linear-scope-6218899c. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| N>BUF | `n -- WSTORE:buffer` | Reads the parked buffer owner back out of the residency block so RESIDENT-DISPOSE can rebuild the allocated store. The sole inverse of BUF>N and reachable only from that one word. Package-private to WSTORE. Retires with habu-checker-linear-scope-6218899c. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| BOFF>N | `CAD-NUM:byte-off -- n` | Private WSTORE proof-erasure projection: reads a validated byte-offset's raw cell for row storage and span arithmetic, which still consume a bare `n`. No public inverse, so offset and extent roles cannot swap (the byte-buffer.f BLEN>N discipline). | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| BLEN>N | `CAD-NUM:byte-len -- n` | Private WSTORE proof-erasure projection: reads a validated byte-extent's raw cell for row storage and span arithmetic, which still consume a bare `n`. No public inverse (the byte-buffer.f BLEN>N discipline). | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| ABLEN>N | `CAD-NUM:alloc-byte-len -- n` | Private WSTORE proof-erasure projection: reads a validated allocation extent's raw cell into the buffer record; the release path re-types it through MEM:BYTES-ALLOC-LEN. No public inverse. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| PARK | `[ ptr u8 n -- n ] -- ` | Parks the WITH-SLOT user body xt in the package frame cell: a quotation cannot read the caller's locals, so the body crosses to the WITH-MAPPING body through a cell (the lib/memory.f WB-CUR pattern). Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| RUN-PARKED | `ptr u8 n -- ` | Executes the parked WITH-SLOT body over one slot sub-span and records its scalar result; executing an xt read back from a cell is outside checker typing (the lib/memory.f WB-RUN-CUR pattern). Package-private to WSTORE. | `maki/infer/weight-store-test.f` | maki/infer/weight-store.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| MINT-LAYER-PROOF | `-- layer-proof` | Private GPT2TENSOR mint: the proof token sealing an authenticated `GPT2TENSOR:layer-id`, minted only inside the sole constructor `LAYER-ID` after the index range check and the cfgkey capture, so a raw n cannot forge a layer identity and MDLCFG's proof cannot substitute (rev-4 identity design; the `MINT-CFG-PROOF` shape). | `maki/infer/gpt2-tensor-test.f` | maki/infer/gpt2-tensor.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| MINT-PREP | `ptr u8 -- GPT2TX:prep` | Mints the linear prepared-bind owner from the block GPT2TX:PREPARE just allocated. A prep token IS its block, so the leaf is an identity; the checker cannot express "this pointer is a freshly filled GPT2TX block" (the WSTORE MINT-TBUILDER shape). Package-private to GPT2TX. Retires with the pointer-lifetime/region-type capability, habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| PREP>BLOCK | `GPT2TX:prep -- GPT2TX:prep ptr n` | Reads the block address back out of a live prep without consuming it, so the package-private projections can read nlayer and the captured cfgkey. Package-private to GPT2TX. Retires with habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TAKE-PREP | `GPT2TX:prep -- ptr n` | Consumes a prep owner and yields its block for disposal; the single crossing that ends a prep's life, used only by GPT2TX:ABORT. Package-private to GPT2TX. Retires with habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| BLK>BYTES | `ptr n -- ptr u8` | Byte view of a GPT2TX prep block for the MEM release path, applied only to an address the prep owner leaves just produced. Package-private to GPT2TX (the WSTORE BLK>BYTES shape). Retires with habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| CENSUS>N | `SAFET:census -- n` | Parks the moved census token in the prep block as a raw cell. A DEFLINEAR carries no fields and an ENUM payload field cannot name a record that transitively holds a linear field (habu-checker-enum-payload-9e1ae6cc), so a bundle of linear children is not expressible as a checked value today. From this crossing until N>CENSUS the checker cannot see the census, so "owned exactly once" is held by GPT2TX's structure — one mint site, one exit site, no accessor — and by the SAFET:LIVE-OWNERS leak assertions, not by the type system. Package-private to GPT2TX, no public inverse. Retires with the linear-scope combinator habu-checker-linear-scope-6218899c. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| N>CENSUS | `n -- SAFET:census` | Reads the parked census token back out of the prep block so GPT2TX:ABORT can release it. The sole inverse of CENSUS>N and reachable only from the one word that ends a prep's life, so a census cannot be recovered twice. Package-private to GPT2TX. Retires with habu-checker-linear-scope-6218899c. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| TABLE>N | `WSTORE:table -- n` | Parks the sealed slot table in the prep block as a raw cell, for the same reason as CENSUS>N and with the same loss of checker visibility; the WSTORE:LIVE counter is what makes a stranded table observable. Package-private to GPT2TX, no public inverse. Retires with habu-checker-linear-scope-6218899c. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| N>TABLE | `n -- WSTORE:table` | Reads the parked table back out of the prep block so GPT2TX:ABORT can give it to WSTORE:TABLE-DISPOSE. The sole inverse of TABLE>N and reachable only from that one word. Package-private to GPT2TX. Retires with habu-checker-linear-scope-6218899c. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| MINT-CHECKED | `ptr u8 -- GPT2TX:checked-prep` | Mints the compared-prep owner from the same block the prep occupied, after GPT2TX:CHECK has matched the captured identity and replaced the census cell with the moved file mapping. A prep and a checked prep ARE one block retyped, so the leaf is an identity; the checker cannot express "this pointer is a compared GPT2TX block". Package-private to GPT2TX. Retires with the pointer-lifetime/region-type capability, habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TAKE-CHECKED | `GPT2TX:checked-prep -- ptr n` | Consumes a compared prep and yields its block; the single crossing that ends a checked prep's life, reached only from GPT2TX:ABORT-CHECKED and GPT2TX:COMMIT-MAPPED. Package-private to GPT2TX. Retires with habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| MAPPING>N | `SAFET:mapping -- n` | Parks the file mapping GPT2TX:CHECK moved out of the census in the checked-prep block as a raw cell, the same discipline and the same cost as the census and table crossings above: a DEFLINEAR carries no fields, so a single-cell owner cannot be stored as a typed value. From this crossing until N>MAPPING the checker cannot see the mapping, so "owned exactly once" is held by GPT2TX's structure - one park site in CHECK, one recovery site in each of the two exits, no accessor - and by the SAFET:LIVE-OWNERS and SAFET-MAP:LIVE assertions the suite makes around every transaction. Package-private to GPT2TX, no public inverse. Retires with the linear-scope combinator habu-checker-linear-scope-6218899c. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| N>MAPPING | `n -- SAFET:mapping` | Reads the parked file mapping back out of a checked-prep block, so GPT2TX:ABORT-CHECKED can unmap it or GPT2TX:COMMIT-MAPPED can hand it to the mapped store constructor. The sole inverse of MAPPING>N and reachable only from those two exits, so one mapping cannot be recovered twice. Package-private to GPT2TX. Retires with habu-checker-linear-scope-6218899c. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| MINT-CHECKED-ALLOC | `ptr u8 -- GPT2TX:checked-prep-alloc` | Mints the allocated arm's compared-prep owner from the same block the prep occupied, after GPT2TX:CHECK-ALLOC has matched the captured identity. Unlike the mapped arm's MINT-CHECKED nothing in the block has been replaced - CHECK-ALLOC moves no resource, so the census cell still holds the census the commit will copy from. A prep and its allocated witness ARE one block retyped, so the leaf is an identity; the checker cannot express "this pointer is a compared GPT2TX block". Package-private to GPT2TX. Retires with the pointer-lifetime/region-type capability, habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| TAKE-CHECKED-ALLOC | `GPT2TX:checked-prep-alloc -- ptr n` | Consumes an allocated-arm compared prep and yields its block; the single crossing that ends such a witness's life, reached only from GPT2TX:ABORT-CHECKED-ALLOC and GPT2TX:COMMIT-ALLOCATED. Package-private to GPT2TX. Retires with habu-checker-ptr-lifetime-f59d1e9d. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | stdlib-boundary | habu-epic-gb10-uma-391d12e8 |
| BUFFER>N | `WSTORE:buffer -- n` | Parks the owned weight arena's buffer in a GPT2TX package cell for the stretch of COMMIT-ALLOCATED where later steps still run under `catch`. Forced by the same gap as MAPPING>N: a caught quotation must be stack-neutral, so a linear owner minted by one guarded step cannot be handed to the next as a value. One park site (BUF-STEP) and one recovery site per exit - the unwind rung CA-BUF-BACK and the success path's store construction - with no accessor, and the WSTORE:LIVE assertions the suite makes after every forced-failure leg are what observe it. Package-private to GPT2TX, no public inverse. Retires with the linear-scope combinator habu-checker-linear-scope-6218899c. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| N>BUFFER | `n -- WSTORE:buffer` | Reads the parked weight-arena buffer back out of the GPT2TX package cell, so COMMIT-ALLOCATED's unwind can dispose it through WSTORE:BUFFER-DISPOSE or its success path can hand it to the allocated store constructor. The sole inverse of BUFFER>N and reachable only from those two sites, so one buffer cannot be recovered twice. Package-private to GPT2TX. Retires with habu-checker-linear-scope-6218899c. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
| MINT-MDL-PROOF | `-- mdl-proof` | Mints the bound model's private-mint proof, an arity-0 nominal family whose only constructor is this leaf (the MDLCFG:MINT-CFG-PROOF shape). It is what makes GPT2TX:gpt2-model unforgeable from outside the package: a raw n in the proof slot is a checker reject, so only the commit path can produce a model. Package-private to GPT2TX. Scope of the guarantee, shared with MDLCFG:cfg-proof and maki/typestate.f ART:built: the proof answers "did GPT2TX mint this?" and never "has it been altered since?" - the generated UNMAKE is public, so a holder of a real model can extract the WSTORE:resident and dispose it behind MODEL-DISPOSE's back, or rebuild the record with a forged depth or cfgkey carrying the original proof. Both holes are pinned as ACCEPT candidates from outside the package in the gpt2-bind-test.f GPT2TX-DR section and retire with the sealed-destructure capability, habu-checker-sealed-destructure-d967fc03. | `maki/infer/gpt2-bind-test.f` | maki/infer/gpt2-bind.f | 2026-07-26 | prim-axiom | habu-epic-gb10-uma-391d12e8 |
...
| CAPTURE-ON | `n -- ` | Declaration-diagnostic capture boundary (package `DECL-DIAG`): selects the prose or JSON leg and points the diagnostic channel at this module's buffer, through the same `DIAG-JSON!` / `DIAG-BUFFER!` pair `tools/check-core.f`'s `CHK-DECL-CAPTURE` uses, so a suite asserts on the production capture channel instead of a test-local copy. That is channel parity, not an end-to-end run of the check tool over a unified declaration. The buffer is a `create` region, which a checked body cannot type as a `ptr u8` span. | `test/enum-decl-suite.f`, `test/structure-decl-suite.f`, `test/run.f` | test/decl-diag-capture.f | 2026-07-26 | test-metaprog | habu-checker-certify-unified-5d56fe73 |
| CAPTURE-OFF | ` -- ` | Releases the capture and restores the prose leg, the same `DIAG-BUFFER-OFF` plus `DIAG-JSON!` pair `CHK-DECL-FLUSH` ends with. | `test/enum-decl-suite.f`, `test/structure-decl-suite.f`, `test/run.f` | test/decl-diag-capture.f | 2026-07-26 | test-metaprog | habu-checker-certify-unified-5d56fe73 |
| CAPTURED$ | ` -- ptr u8 n` | Answers the captured diagnostic bytes through `DIAG-BUFFER$`, the same reader `CHK-DECL-FLUSH` hands to the check error stream. | `test/enum-decl-suite.f`, `test/structure-decl-suite.f`, `test/run.f` | test/decl-diag-capture.f | 2026-07-26 | test-metaprog | habu-checker-certify-unified-5d56fe73 |
| TWX-XPAD-DROP-BUNDLE | `clxg<clx2> n -- n` | Drops the just-measured `clxg<clx2>` layout bundle and keeps the cell count, in the positive-extra runtime depth-parity probe (LOWER-WIDTH-ASYM-FAILCLOSED). The checker cannot express dropping or sizing a multi-cell layout value, so this straight-line `>r 2drop 2drop drop r>` (certified width 5) is the sole trusted step; its declared `clxg<clx2> n -- n` effect keeps the whole `XPAD-WTHREE-W` call site checked (the mark, build via checked `CLXG-THREE`, and depth delta are all checked). | `test/type-ctor-suite.f` | test/type-ctor-suite.f | 2026-07-24 | test-metaprog | habu-fail-closed-on-0ab1e401 |
| TWX-XPG-CHECK | `xpg<xpginr> -- ` | Reads the `xpg<xpginr>` wide parametric-STRUCTURE bundle's cells top-to-bottom (z, b, a) and asserts their values in declaration order, in the tagless-arithmetic runtime content/width proof (TAGLESS-ARITH-KEEPS-FAILCLOSED). A GENERIC family's wide UNMAKE is a separate checker gap (its fixed one-cell-per-param stored effect `xpg<a>` cannot consume a concrete wide input), so the bundle's cells cannot be recovered in checked code; this straight-line `3 T= 2 T= 1 T=` reads them directly and is the sole trusted step. Its declared `xpg<xpginr> --` effect keeps the whole `XPGW-RT` call site checked (the build via the compiled generated ctor `XPGW-MK` and the surrounding canary are checked); the canary equality after the call proves exact consumption. The generic-wide UNMAKE capability that retires this boundary is tracked by the owning dot. | `test/type-ctor-suite.f` | test/type-ctor-suite.f | 2026-07-24 | test-metaprog | habu-instantiate-wide-generic-075aced1 |
...
| SRC-A-FIELD | `-- ptr ptr u8` | Plain-ENUM census: types the `ptr u8` slot holding the file buffer the allocator returned, the `ptr-field` boundary a checked body cannot express for a stored span. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| BASE-A-FIELD | `-- ptr ptr u8` | Plain-ENUM census: the same stored-span boundary for the baseline file buffer. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FILE-A-FIELD | `-- ptr ptr u8` | Plain-ENUM census: the same stored-span boundary for the label of the file being scanned. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| OUT$ | `-- ptr u8 n` | Plain-ENUM census: reads the accumulated report out of a `create` region, which is not a typed span in a checked body. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| OUT-C | `n -- ` | Plain-ENUM census: appends one byte to the report region, raising rather than truncating when it is full. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| BUILD$ | `-- ptr u8 n` | Plain-ENUM census: reads the reconstructed declaration text out of its `create` region before handing it to `evaluate`. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| BUILD-C | `n -- ` | Plain-ENUM census: appends one byte to the reconstructed declaration, raising when it is full. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| PKG$ | `-- ptr u8 n` | Plain-ENUM census: reads the scratch package name a site is replayed into. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| PKG-C | `n -- ` | Plain-ENUM census: appends one byte to the scratch package name, raising when it is full. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| BASE$ | `-- ptr u8 n` | Plain-ENUM census: reads the loaded baseline bytes for the whole-report comparison. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| EV | `ptr u8 n -- ` | Plain-ENUM census: `evaluate` is how a reconstructed declaration reaches the global ENUM keyword, which is the whole point of the tool; `evaluate` is banned inside checked bodies (UNSAFE-TOK?). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| TRY | `ptr u8 n -- n` | Plain-ENUM census: runs one reconstructed declaration under `catch` so a rejected site is recorded rather than ending the census. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| DIAG-CAPTURE | `-- ` | Plain-ENUM census: routes the declaration diagnostic into a buffer around the rejects the front-end proof provokes on purpose, so a clean run says nothing on stderr; same capture channel `tools/check-core.f` uses. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| DIAG-RELEASE | `-- ` | Plain-ENUM census: restores normal diagnostic output after the provoked reject. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FAM-RESOLVE | `ptr u8 n ptr u8 n -- n bool` | Plain-ENUM census: resolves the replayed family by scratch package and tail through the sealed pre-hook `TFAM-SIG-RESOLVE`. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FAM-KIND | `n -- n` | Plain-ENUM census: reads the registered family kind (`TFAM-KIND@`) for the record. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FAM-VIS | `n -- n` | Plain-ENUM census: reads the registered family visibility (`TFAM-VIS@`). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FAM-WIDTH | `n -- n` | Plain-ENUM census: reads the family payload width (`TFAM-WIDTH@`). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FAM-POLICY | `n -- n` | Plain-ENUM census: reads the family layout policy (`TFAM-LAYOUT-POLICY@`). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FAM-EQ? | `n -- bool` | Plain-ENUM census: reads the derived-equality flag (`TFAM-DERIVE-EQ?`). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FAM-HASH? | `n -- bool` | Plain-ENUM census: reads the derived-hash flag (`TFAM-DERIVE-HASH?`). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FAM-VAR-START | `n -- n` | Plain-ENUM census: reads the family's first variant row id (`TFAM-VAR-START@`). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| FAM-VAR-COUNT | `n -- n` | Plain-ENUM census: reads the family's variant count (`TFAM-VAR-COUNT@`). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| VAR-NAME$ | `n -- ptr u8 n` | Plain-ENUM census: reads one variant's registered tail (`SUMV-NAME$`). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| VAR-TAG | `n -- n` | Plain-ENUM census: reads one variant's tag (`SUMV-TAG@`), which is what a silently reordered or dropped variant would move. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| VAR-CTOR-PKG$ | `n -- ptr u8 n` | Plain-ENUM census: reads the constructor package stamped on one variant row (`SUMV-CTOR-PKG$`), the identity a later `FAMILY:VARIANT` resolves through. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| VAR-CTOR-SYM | `n -- n` | Plain-ENUM census: reads whether a constructor word was actually generated for one variant (`SUMV-CTOR-SYM@`). | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| NUM$ | `-- ptr u8 n` | Plain-ENUM census: reads the decimal text built backwards in a `create` region. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| NUM-PUT | `n -- ` | Plain-ENUM census: writes one decimal digit into that region, right to left. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-core.f | 2026-07-26 | builder-emit | habu-cut-global-enum-56ca54e2 |
| SRC$ | `-- ptr u8 n` | Census fixtures: reads the hostile fixture source out of a `create` region. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-test.f | 2026-07-26 | test-metaprog | habu-cut-global-enum-56ca54e2 |
| SRC-C | `n -- ` | Census fixtures: appends one byte to the fixture source, raising when it is full. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-test.f | 2026-07-26 | test-metaprog | habu-cut-global-enum-56ca54e2 |
| PATH$ | `-- ptr u8 n` | Census fixtures: reads the scratch fixture path. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-test.f | 2026-07-26 | test-metaprog | habu-cut-global-enum-56ca54e2 |
| PATH! | `ptr u8 n -- ` | Census fixtures: stores the scratch fixture path into a `create` region. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-test.f | 2026-07-26 | test-metaprog | habu-cut-global-enum-56ca54e2 |
| ROOT$ | `-- ptr u8 n` | Census fixtures: reads the scratch directory the fixture file lives in. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-test.f | 2026-07-26 | test-metaprog | habu-cut-global-enum-56ca54e2 |
| ROOT! | `ptr u8 n -- ` | Census fixtures: stores that scratch directory. | `tools/enum-census-test.f`, `test/run.f` | tools/enum-census-test.f | 2026-07-26 | test-metaprog | habu-cut-global-enum-56ca54e2 |
...
| WB-REL-CUR | `--` | Private `MEM:WITH-BYTES` frame op: releases the current mapping via `MEM:RELEASE-BYTES`, reading the fat pointer and length from off-stack frame state (the fat pointer cannot be re-typed through a bare cell read). A successful release consumes that owner state; a repeated call remains callable but fails because the consumed owner carries zero release length. A failed release leaves the owner intact so the caller can retry before the outer frame is restored. | `lib/memory-test.f` | lib/memory.f | 2026-07-21 | stdlib-boundary | habu-epic-type-habu-a34713f0 |
...
| F64>BITS-RAW | `r -- n` | Private IEEE-754 boundary: reinterpret one Habu f64 cell as its exact bit pattern behind the checked public `IEEE754:F64>BITS` wrapper. | `lib/ieee754-test.f`, `lib/float32-test.f`, `lib/ptx/header-test.f` | lib/ieee754.f | 2026-07-22 | stdlib-boundary | habu-infer-gpt-2-412c6f04 |
| BITS>F64-RAW | `n -- r` | Private IEEE-754 boundary: reinterpret an exact binary64 bit construction as a Habu float behind the checked public `IEEE754:BITS>F64` wrapper. | `lib/ieee754-test.f`, `lib/float32-test.f`, `lib/ptx/header-test.f` | lib/ieee754.f | 2026-07-22 | stdlib-boundary | habu-infer-gpt-2-412c6f04 |
...
| RAW>DECL | `n -- decl` | Private R7 stage mint: seeds a declared Model IR object; the only public entry is `CADMODEL:DECLARE`, so a raw n cannot forge a stage. | `maki/typestate-test.f` | maki/typestate.f | 2026-07-13 | prim-axiom | habu-epic-model-cad-70b629a9 |
| RAW>ELAB | `n -- elab` | Private R7 stage mint: the elaborated-model witness, minted only by `CADMODEL:ELABORATE` from a `CADMODEL:decl`. | `maki/typestate-test.f` | maki/typestate.f | 2026-07-13 | prim-axiom | habu-epic-model-cad-70b629a9 |
| RAW>SOLVED | `n -- solved` | Private R7 stage mint: the type/shape-solved witness, minted only by `TIR:SOLVE` from a `CADMODEL:elab`. | `maki/typestate-test.f` | maki/typestate.f | 2026-07-13 | prim-axiom | habu-epic-model-cad-70b629a9 |
...
| BLEN>N | `CAD-NUM:byte-len -- n` | Private BUF proof-erasure projection: reads a validated `byte-len`'s raw cell to store the buffer capacity/length header cell, to size the allocation, and to drive the byte-copy and byte-pointer arithmetic, which still consume a bare `n`. BUF-private, no public export; there is no public inverse, so length and offset roles cannot swap. Retire when TVK-RAW (`habu-nominal-storage-raw-a3430ef2`) lets the header/copy primitives take the nominal role directly. | `lib/byte-buffer-test.f` | lib/byte-buffer.f | 2026-07-21 | prim-axiom | habu-build-exact-modular-44f4c2dc |
...
test/structure-decl-suite.f:TRY test-metaprog habu-structure-parse-typed-c5a01e1f
test/structure-decl-suite.f:FAMID test-metaprog habu-structure-parse-typed-c5a01e1f
test/structure-decl-suite.f:FAM-POLICY@ test-metaprog habu-structure-parse-typed-c5a01e1f
test/structure-decl-suite.f:FAM-EQ? test-metaprog habu-structure-parse-typed-c5a01e1f
test/structure-decl-suite.f:FAM-HASH? test-metaprog habu-structure-parse-typed-c5a01e1f
test/structure-decl-suite.f:FAM-SLOTS@ test-metaprog habu-structure-parse-typed-c5a01e1f
test/structure-decl-suite.f:SCH-ROOT@ test-metaprog habu-structure-parse-typed-c5a01e1f
test/structure-decl-suite.f:SCH-TAG@ test-metaprog habu-structure-parse-typed-c5a01e1f
test/structure-decl-suite.f:SCH-A@ test-metaprog habu-structure-parse-typed-c5a01e1f
...
test/decl-replay-verify-source.f:F-WIDTH test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:F-POLICY test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:F-EQ test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:F-HASH test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:F-VSTART test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:F-VCOUNT test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:F-FCOUNT test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:V-NAME$ test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:V-TAG test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:V-PKG$ test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:V-SYM test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:R-FAM test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:R-VAR test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:R-NAME$ test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:R-SCH test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:R-SLOT test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:R-CELLS test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:R-TOTAL test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:VS-LOAD test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:SRC-C test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:SRC$ test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:VSTRY test-metaprog habu-cut-global-enum-56ca54e2
test/decl-replay-verify-source.f:FAM-FIND test-metaprog habu-cut-global-enum-56ca54e2
test/enum-decl-suite.f:RP-EV test-metaprog habu-cut-global-enum-56ca54e2
test/enum-decl-suite.f:RP-TRY test-metaprog habu-cut-global-enum-56ca54e2
test/enum-decl-suite.f:RP-FORCE-OPEN test-metaprog habu-cut-global-enum-56ca54e2
test/enum-decl-suite.f:RP-FORCE-CLOSE test-metaprog habu-cut-global-enum-56ca54e2
...
test/structure-decl-suite.f:FAM-FLD-COUNT test-metaprog habu-cut-global-enum-56ca54e2
test/structure-decl-suite.f:FAM-PRODUCT? test-metaprog habu-cut-global-enum-56ca54e2
test/structure-decl-suite.f:DICT-RECS test-metaprog habu-cut-global-enum-56ca54e2
test/enum-decl-suite.f:EV test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:TRY test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:FAMID test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:F-ENUM? test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:F-SUM? test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:F-VAR-START test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:F-VAR-COUNT test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:F-FLD-COUNT test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:F-WIDTH test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:F-POLICY@ test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:F-EQ? test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:F-HASH? test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:SV-NAME$ test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:SV-TAG@ test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:SV-SCH-COUNT@ test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:SV-FAM@ test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:SCH-ROOT@ test-metaprog habu-enum-parse-full-39c0dc1b
test/enum-decl-suite.f:SCH-TAG@ test-metaprog habu-enum-parse-full-39c0dc1b
...
test/type-ctor-suite.f:SUM-DECL test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PROD-DECL test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:LAST-FAM test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:GEN-FAMILY test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:CAPTURE test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:RENDER-CTOR test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:SUMV-PROV test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PAY-COUNT test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PAY-ROOT test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PAY-CELLS test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:ROOT-N test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:VAR-START test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:FAM-DECL test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PKG-PUBLIC test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:SUM-KIND test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:CON-CODE test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:SCH-CON test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:SCH-ROOT+ test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:SUMV-COUNT test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:FLD-COUNT test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:CELL-BYTES test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:VAR-RANGE! test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:FLD-RANGE! test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:SLOTS! test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:CTOR-PUBLISH test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PEND-CLEAR test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:CAND-START test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:CAND-DONE test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PLAN-BEGIN test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PLAN-ROWS test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PLAN-WORD$ test-metaprog habu-constructor-pass-payload-78c7069d
test/type-ctor-suite.f:PLAN-DEF$ test-metaprog habu-constructor-pass-payload-78c7069d
...
prim - prot-wid-room - pe-n pe-out
...
pprim type-field tx-depth - pe-n pe-out
