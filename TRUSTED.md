...
| TQX>QS | `n -- tdqp:qslot` | Runtime adapter proves qualified nominal scalar construction through the checked declaration path. | `test/type-decl-suite.f`, `test/run.f` | test/type-decl-suite.f | 2026-07-17 |
