...
| PR-PARSE-RESP | `--` | Recovery boundary around model response parsing; invalid structured output falls back to raw text. | `bench/llm/drive-array-habu-repair-test.f`, `bench/llm/drive-forth-test.f`, `test/run.f` | bench/llm/parse-resp-lib.f:206 | 2026-06-21 |
