...
| PROT-WID-CTOR? | `ptr u8 n -- bool` | Late-bound constructor-name predicate used while registering generated constructor package WIDs; xref loads before the TFAM predicate is present in the recovery stage, so this boundary only dispatches to `TFAM-CTOR-WORD?` before `prot-wid-add`. | `test/type-ctor-suite.f`, `test/seal-package.f` | src/habu/xref.f | 2026-07-07 |
...
src/habu/xref.f:PROT-WID-CTOR? builder-emit habu-tfam-8-generated-f89a7ae9
