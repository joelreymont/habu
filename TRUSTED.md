...
| LOW? | `n -- bool` | Type-token seam: forwards to the pre-hook `LOWER?` (lowercase-letter check for a single-char field type); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
...
| SD-MARK | `-- ` | Registry rollback snapshot: raw reads of the REG-PROTECT name-sealed registry cursors the event module does not own (family, string pool, param pool, variant pool, layout pool, schema node/root pools) into module cells; the checker cannot type sealed-cell access from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
| SD-RESTORE | `-- ` | Registry rollback snapshot: raw writes restoring the REG-PROTECT name-sealed registry cursors to the SD-MARK snapshot on reject; the checker cannot type sealed-cell access from a post-hook checked body. | `test/structure-decl-suite.f`, `test/run.f` | src/core/structure-decl.f | 2026-07-21 | stdlib-boundary | habu-structure-parse-typed-c5a01e1f |
...
| LOW? | `n -- bool` | Type-token seam: forwards to the pre-hook `LOWER?` (lowercase-letter check for a single-char field type); the checker cannot type the sealed pre-hook word from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
...
| ED-MARK | `-- ` | Registry rollback snapshot: raw reads of the REG-PROTECT name-sealed registry cursors the event module does not own (family, string pool, param pool, variant pool, layout pool, schema node/root pools) into module cells; the checker cannot type sealed-cell access from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
| ED-RESTORE | `-- ` | Registry rollback snapshot: raw writes restoring the REG-PROTECT name-sealed registry cursors to the ED-MARK snapshot on reject; the checker cannot type sealed-cell access from a post-hook checked body. | `test/enum-decl-suite.f`, `test/run.f` | src/core/enum-decl.f | 2026-07-21 | stdlib-boundary | habu-enum-parse-full-39c0dc1b |
