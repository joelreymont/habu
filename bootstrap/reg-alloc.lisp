...
(defun ir-tag-name (sym)
  ...
  (cond
    ...
    ((eql sym #x1F) "STR-LIT")
    ((eql sym #x20) "KW-LIT")
    ((eql sym #x21) "KEYWORDP")
    ((eql sym #x22) "LAMBDA-IR")
    ((eql sym #x23) "FUNCALL-IR")
    ((eql sym #x24) "SETQ-IR")
    ((eql sym #x25) "LENGTH")
    ((eql sym #x26) "STRING-EQ")
    ((eql sym #x27) "SYMBOL-NAME")
    ((eql sym #x28) "MAKE-VECTOR")
    ((eql sym #x29) "VECTOR-REF")
    ((eql sym #x2A) "VECTOR-SET")
    ((eql sym #x2B) "VECTOR-LENGTH")
    ((eql sym #x2C) "QUOTE-SYM")
    ((eql sym #x2D) "EQL")
    ((eql sym #x2E) "GET-TAG")
    ((eql sym #x2F) "MAKE-STRING-FROM-VECTOR")
    ((eql sym #x30) "MAKE-SYMBOL-FROM-STRING")
    ((eql sym #x31) "ERROR")
    ((eql sym #x32) "SET-TAG")
    ((eql sym #x33) "LOGNOT")
    ((eql sym #x34) "KEYWORD-NAME")
    ;; Call-related (from habu0.lisp h0-compile)
    ((eql sym #x40) "CALL-FN")
    ((eql sym #x41) "CALL-BUILTIN")
    ((eql sym #x42) "TAIL-CALL-FN")
    ((eql sym #x43) "SETCAR-IR")
    ((eql sym #x44) "SETCDR-IR")
    ((eql sym #x45) "WHILE-IR")
    ((eql sym #x46) "DOLIST-IR")
    ((eql sym #x47) "CMP-NE")
    (t "")))
