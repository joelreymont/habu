...
(defun mmap-heap-init-code (heap-size)
  ...
  (let* ((half-heap-size (ash (- heap-size +gc-heap-data-offset+) -1))
    ...
    (append
     ...
     (arm64:str :x10 :gc :offset +gc-space-flag-offset+)  ; x10 still 0
     ...
     (arm64:str :x9 :gc :offset +gc-symbol-table-offset+)  ; x9 still 6 (nil)
