...
variable LKWPACKAGE variable LKWPUBLIC variable LKWPRIVATE variable LKWENDPACKAGE variable LKWSEMIPACKAGE
...
: EMIT-INTERPRET-WORDS ( n n -- ) {: lmain lundef :}
   ...
   lmain LKWENDPACKAGE 11 ['] C-END-PACKAGE CF-ENTRY
