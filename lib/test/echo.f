...
: CAPTURED-LINES ( -- )
   1 GT-OUT-SINK drop PROC-OUT-LEN LINES-FD
   2 GT-ERR-SINK drop PROC-ERR-LEN LINES-FD ;

: CAPTURED-REST ( -- )
   1 GT-OUT-SINK drop PROC-OUT-LEN REMAINDER-FD
   2 GT-ERR-SINK drop PROC-ERR-LEN REMAINDER-FD ;
