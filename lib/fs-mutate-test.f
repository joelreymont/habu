...
create FMT-CLEANUP-BUF FS-PATH-CAP allot
...
: FMT-CLEANUP-PATH ( -- ptr u8 n )
   FMT-CLEANUP-BUF FMT-CLEANUP-U @ ;
...
: FMT-CLEANUP! ( -- )
   FMT-ROOT$ s" cleanup.txt" FMT-CLEANUP-BUF JOIN-PATH FMT-CLEANUP-U ! ;
