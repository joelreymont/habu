...
: FS-TEST-PATHS! ( -- )
   ...
   FS-TEST-BASE s" executable-link" FS-TEST-LINK-BUF FS-TEST-LINK-U FS-TEST-PATH! ;
...
: FS-TEST-EXECUTABLE ( -- )
   ...
   FS-TEST-EMPTY-PATH CHMOD-X
   FS-TEST-EMPTY-PATH EXECUTABLE? FS-TEST-TRUE
   FS-TEST-EMPTY-PATH FS-TEST-LINK-PATH MAKE-SYMLINK
   FS-TEST-LINK-PATH CLEANUP+
   FS-TEST-LINK-PATH SYMLINK? FS-TEST-TRUE
   FS-TEST-LINK-PATH EXECUTABLE? FS-TEST-TRUE
   FS-TEST-BIG-PATH EXECUTABLE? FS-TEST-FALSE
   FS-TEST-ROOT EXECUTABLE? FS-TEST-FALSE
   s" ." EXECUTABLE? FS-TEST-FALSE
