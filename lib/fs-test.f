...
: FS-TEST-SAFE-PATHS ( -- )
   T-RESET
   s" a" FS:CHECK-SAFE-PATH
   s" a/b" FS:CHECK-SAFE-PATH
   s" /a/b" FS:CHECK-SAFE-PATH
   s" /" FS:CHECK-SAFE-PATH
   s" a/b" 0 FS:COMPONENT-END 1 FS-TEST=
   s" a/b" 2 FS:COMPONENT-END 3 FS-TEST=
   s" a/b" FS:PATH-START 0 FS-TEST=
   s" /a/b" FS:PATH-START 1 FS-TEST=
   [: s" a" -1 FS:COMPONENT-END drop ;] E-FS-PATH TTHROWSQ
   [: s" a" 2 FS:COMPONENT-END drop ;] E-FS-PATH TTHROWSQ
   [: s" " FS:CHECK-SAFE-PATH ;] E-FS-PATH TTHROWSQ
   [: s" ." FS:CHECK-SAFE-PATH ;] E-FS-PATH-UNSAFE TTHROWSQ
   [: s" .." FS:CHECK-SAFE-PATH ;] E-FS-PATH-UNSAFE TTHROWSQ
   [: s" a/./b" FS:CHECK-SAFE-PATH ;] E-FS-PATH-UNSAFE TTHROWSQ
   [: s" a/../b" FS:CHECK-SAFE-PATH ;] E-FS-PATH-UNSAFE TTHROWSQ
   [: s" a//b" FS:CHECK-SAFE-PATH ;] E-FS-PATH-UNSAFE TTHROWSQ
   [: s" a/" FS:CHECK-SAFE-PATH ;] E-FS-PATH-UNSAFE TTHROWSQ
   [: s" //a" FS:CHECK-SAFE-PATH ;] E-FS-PATH-UNSAFE TTHROWSQ
   T-FAILURES 0 FS-TEST= ;
