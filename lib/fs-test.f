...
: FS-TEST-THROWS ( -- )
   T-RESET
   ['] FS-TEST-PATH-TOO-LONG E-FS-PATH TTHROWS
   ['] FS-TEST-JOIN-TOO-LONG E-FS-CAPACITY TTHROWS
   ['] FS-TEST-JOIN-NEG-PARENT E-FS-PATH TTHROWS
   ['] FS-TEST-CAP-TOO-LONG E-FS-CAPACITY TTHROWS
   ['] FS-TEST-MISSING-STAT E-FS-STAT TTHROWS
   ['] FS-TEST-MISSING-WALK E-FS-STAT TTHROWS
   ['] FS-TEST-DEEP-WALK E-FS-DEPTH TTHROWS
   ['] FS-TEST-MISSING-READ E-FS-OPEN TTHROWS
   ['] FS-TEST-READ-TOO-LARGE E-FS-CAPACITY TTHROWS
   ['] FS-TEST-WRITE-DIR E-FS-OPEN TTHROWS
   ['] FS-TEST-APPEND-DIR E-FS-OPEN TTHROWS
   ['] FS-TEST-WRITE-MISSING-PARENT E-FS-OPEN TTHROWS
   ['] FS-TEST-APPEND-MISSING-PARENT E-FS-OPEN TTHROWS
