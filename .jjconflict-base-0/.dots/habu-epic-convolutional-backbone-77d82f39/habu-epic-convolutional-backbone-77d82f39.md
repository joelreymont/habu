...
blocks:
  - habu-epic-vision-localization-cb23c422
---

Sequencing: third in line - the core type-system epics come first, then the ViT
vision epic this one builds on (the blocker above), then this convolutional
phase.
