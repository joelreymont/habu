...
: REPORT-METRICS ( n n n -- )
   ...
   s" bytes=" type by FMT:.U s"  flops=" type fl FMT:.U cr
   s" GB/s_x1000=" type gbs FMT:.U s"  mem_roof_util_x1000=" type memu FMT:.U cr
   s" GFLOP/s_x1000=" type gflops FMT:.U s"  fp32_roof_util_x1000=" type fpu FMT:.U cr ;
