  ...
  (cond
    ...
    ((nc-has-tag ir 'cons-ir)
     (let* ((xs (nc-temp-slot td))
            ...
            (i1 (nc-str-offset 24 31 xs))
            (i2 (nc-str-offset 0 31 cs))
            (i3 (nc-ldr-offset 24 31 xs))
            (i4 (nc-mov-reg 1 0))
            (i5 (nc-ldr-offset 0 31 cs))
            (i6 (nc-ldr-offset 9 19 0))
            (i7 (nc-blr 9))
            (r1 (append i1 cc))
            (r2 (append r1 i2))
            (r3 (append r2 i3))
    ...
    ((nc-has-tag ir 'car-ir)
     (let* ((ac (nc-codegen (cadr ir) rtaddrs fnoffs td))
            (i1 (nc-ldr-offset 9 19 8))
            (i2 (nc-blr 9))
            (r1 (append ac i1)))
       (append r1 i2)))
    ((nc-has-tag ir 'cdr-ir)
     (let* ((ac (nc-codegen (cadr ir) rtaddrs fnoffs td))
            (i1 (nc-ldr-offset 9 19 16))
            (i2 (nc-blr 9))
            (r1 (append ac i1)))
       (append r1 i2)))
    ((nc-has-tag ir 'if-ir)
     (let* ((tc (nc-codegen (cadr ir) rtaddrs fnoffs td))
            ...
            (i1 (nc-movz 1 0))
            (i2 (nc-cmp-reg 0 1))
            (i3 (nc-b-cond (nc-cond-eq) (* (+ thl 1) 4)))
            (i4 (nc-b-offset (* ell 4)))
            (r1 (append tc i1))
            (r2 (append r1 i2))
            (r3 (append r2 i3))
            (r4 (append r3 thc))
