...
: DISPATCH-ID ( n -- )
   case
      ...
      ID-CHECK-CLI of GSI-CHECK-CLI endof
      ...
      ID-LINT-LIBS-PTX of GSI-LINT-LIBS-PTX endof
      ID-LINT-LIBS-PTX-NEG of GSI-LINT-LIBS-PTX-NEG endof
      ID-LINT-LIBS-PTX-TOOL of GSI-LINT-LIBS-PTX-TOOL endof
      ID-LINT-ARTIFACTS-FAST of GSI-LINT-ARTIFACTS-FAST endof
      ID-REPAIR of GENG-REPAIR-SLICE endof
      ID-FIXTURES of GENG-FIXTURES-SLICE endof
      ID-RUNTIME of GENG-RUNTIME-SLICE endof
      ID-VALIDATE of GENG-VALIDATE-SLICE endof
      ID-DIAG-REPAIR of GDX-REPAIR-SLICE endof
      ID-DIAG-UNDEF-PRIMARY of GDX-UNDEF-PRIMARY-SLICE endof
      ID-DIAG-ALL-STRICT of GDX-ALL-STRICT-SLICE endof
      ID-DIAG-FILE-UNSAFE of GDX-FILE-UNSAFE-SLICE endof
      ID-DICTIONARY of GD-MAIN endof
