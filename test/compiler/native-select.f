...
: SELECTED ( -- IR-BUILD:module )
   ...
   CC m A64-BUILDER NO-PLACES A64SEL:SELECT ;

: SELECTED-POOL ( -- IR-BUILD:module )
   CC BB A64SEL:BIND-SOURCE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER POOLED A64SEL:SELECT ;

: SELECTED-POOL-FP ( -- IR-BUILD:module )
   CC BB A64SEL:BIND-SOURCE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER POOLED-FP A64SEL:SELECT ;

: SELECTED-POOL-FN ( n -- IR-BUILD:module )
   {: n:n :}
   CC BB A64SEL:BIND-SOURCE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER n POOLED-FN A64SEL:SELECT ;
...
: NO-BIND-BODY ( IR-CTX:ctx -- )
   ...
   BUILD-SQUARE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER NO-PLACES A64SEL:SELECT drop ;
...
: SELECTED-HABU ( n n -- IR-BUILD:module )
   ...
   CC BB A64SEL:BIND-SOURCE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER in out HABU-CONV A64SEL:SELECT ;
...
: SELECTED-POOL-SLOTS ( n n -- IR-BUILD:module )
   ...
   CC BB A64SEL:BIND-SOURCE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER in out POOLED-SLOTS A64SEL:SELECT ;
...
: CALL-REG-BODY ( IR-CTX:ctx -- )
   ...
   CC BB A64SEL:BIND-SOURCE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER CALL-REG-CONV A64SEL:SELECT drop ;
...
: CALL-NOFRAME-BODY ( IR-CTX:ctx -- )
   ...
   CC BB A64SEL:BIND-SOURCE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER 1 1 CALL-NOFRAME-CONV A64SEL:SELECT drop ;
...
: CALL-NONE-BODY ( IR-CTX:ctx -- )
   ...
   CC BB A64SEL:BIND-SOURCE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER 1 1 CALL-CONV A64SEL:SELECT drop ;
...
: SELECTED-TAIL ( n n -- IR-BUILD:module )
   ...
   CC BB A64SEL:BIND-SOURCE
   CC BB IR-BUILD:FREEZE {: m:IR-BUILD:module :}
   CC m A64-BUILDER in out TAIL-CONV A64SEL:SELECT ;
