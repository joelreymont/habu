...
: A64-MOD ( IR-CTX:ctx -- )
   ...
   c 0 W-CTX !
   b 0 W-BLD !
   c b A64IR:MACHINE  c b A64IR:VOCABULARY  A64RA:BIND-DIALECT
   c b  c b A64IR:VOCABULARY  A64RAV:BIND-DIALECT
   c b A64IR:REGISTER
   c b TXT TXT-N IR-BUILD:ADD-SOURCE 0 W-SRC ! ;
...
: A64-MOD-SAVED ( IR-CTX:ctx -- )
   ...
   c 0 W-CTX !
   b 0 W-BLD !
   c b SAVED-MACHINE  c b A64IR:VOCABULARY  A64RA:BIND-DIALECT
   c b  c b A64IR:VOCABULARY  A64RAV:BIND-DIALECT
   c b A64IR:REGISTER
   c b TXT TXT-N IR-BUILD:ADD-SOURCE 0 W-SRC ! ;
...
: A64-MOD-SMALL ( IR-CTX:ctx -- )
   ...
   c 0 W-CTX !
   b 0 W-BLD !
   c b SMALL-MACHINE  c b A64IR:VOCABULARY  A64RA:BIND-DIALECT
   c b  c b A64IR:VOCABULARY  A64RAV:BIND-DIALECT
   c b A64IR:REGISTER
   c b TXT TXT-N IR-BUILD:ADD-SOURCE 0 W-SRC ! ;
