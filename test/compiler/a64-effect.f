...
: STACK-RANGES ( -- )
   0 A64EFF:SEQ-DSTACK A64EFF:SEQ-LEN 0 T=
   2 A64EFF:SEQ-DSTACK A64EFF:SEQ-LEN 2 T=
   2 A64EFF:SEQ-DSTACK 1 A64EFF:SEQ-SLOT@ 1 T=
   64 A64EFF:SEQ-DSTACK A64EFF:SEQ-LEN 64 T=
   64 A64EFF:SEQ-DSTACK 63 A64EFF:SEQ-SLOT@ 63 T=
   64 A64EFF:SEQ-DSTACK A64EFF:SEQ-SLOTS 64 T=
   64 A64EFF:SEQ-DSTACK A64EFF:SEQ-SET A64EFF:GPRS-N 0 T=
   64 A64EFF:SEQ-DSTACK 63 A64EFF:SEQ-KIND@ A64EFF-PKIND:DSLOT A64EFF-PKIND:EQ TTRUE
   [: 64 A64EFF:SEQ-DSTACK 64 A64EFF:SEQ-SLOT@ drop ;] E-A64EFF-SEQ TTHROWSQ
   [: 64 A64EFF:SEQ-DSTACK 0 A64EFF:SEQ-REG@ drop ;] E-A64EFF-KIND TTHROWSQ
   [: -1 A64EFF:SEQ-DSTACK drop ;] E-A64EFF-SEQ TTHROWSQ ;
...
: CONTROL-REJECTS ( -- )
   ...
   [: SQ-NONE D0 A64EFF-NZCV:UNTOUCHED A64EFF-CONTROL:NO-RETURN
      R-RESULT DROP-ROUTINE ;] E-A64EFF-CONTROL TTHROWSQ
   [: SQ-NONE A64EFF:FPR-NONE A64EFF-NZCV:DELIVERED
      A64EFF-CONTROL:NO-RETURN R-RESULT DROP-ROUTINE ;]
      E-A64EFF-CONTROL TTHROWSQ
   SQ-NONE A64EFF:FPR-NONE A64EFF-NZCV:CLOBBERED
      A64EFF-CONTROL:NO-RETURN R-RESULT DROP-ROUTINE
   0 SQ D0 A64EFF-NZCV:DELIVERED A64EFF-CONTROL:RETURNS R-RESULT DROP-ROUTINE
   0 SQ D0 A64EFF-NZCV:DELIVERED A64EFF-CONTROL:TAIL-CALL R-RESULT DROP-ROUTINE ;
...
: A-NZCV ( n -- A64EFF:nzcv )
   ...
   k 2 = if A64EFF-NZCV:DELIVERED exit then
