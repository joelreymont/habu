\ Local names have the same case-insensitive meaning in the checker and both compilers.
...
: RUN ( -- )
   T-RESET
   2 0 do i SHADOW-CASE i SCOPE-CASE i QUOTATION-CASE loop
   T-REPORT ;
