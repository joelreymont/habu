...
bin/hb --load lib/errors.f lib/string.f lib/test.f lib/fs.f lib/fs-mutate.f lib/process.f lib/process-argv.f lib/process-env.f tools/argv.f tools/json.f bench/llm/manifest.f bench/llm/model.f bench/llm/parse-resp-lib.f bench/llm/model-run.f bench/llm/vectors.f lib/json-write.f src/core/sha256.f bench/llm/live-row.f bench/llm/drive-stdlib-lib.f bench/llm/drive-stdlib-test.f || { echo "FAIL: llm stdlib stack driver"; exit 1; }
