...
: MACOS! ( n -- )
   TR-PROFILE-MACOS-ARM64-10X2 PROFILE!
   TR-CAL-MEASURED-MS ! ;

: NOMINAL-KEEPS-BUDGET ( -- )
   TR-CAL-REF-MACOS-MS MACOS!
   TR-CAL-PCT 100 T=
   40000 CAL-SCALED 40000 T= ;

: SLOW-HOST-SCALES ( -- )
   TR-CAL-REF-MACOS-MS 2 * MACOS!
   TR-CAL-PCT 200 T=
   40000 CAL-SCALED 80000 T=
   45000 CAL-SCALED 90000 T= ;
...
: THRASHING-CLAMPS-HIGH ( -- )
   ...
   TR-CAL-PCT 300 T=
   40000 CAL-SCALED 120000 T= ;

: UNCALIBRATED-PROFILE-KEEPS-TABLE ( -- )
   TR-PROFILE-JETSON-ORIN-CLOCKS-4X2 PROFILE!
   TR-CAL-REF-MACOS-MS 10 * TR-CAL-MEASURED-MS !
   TR-CAL-PCT 100 T=
   100000 CAL-SCALED 100000 T= ;
...
: MACOS-POLICY ( -- )
   ...
   -1 TR-COLD-CACHE !
   TR-COLD-BUDGETS
   TR-BUDGET @ RUN-BUDGET:MACOS-COLD-MS T=
   TR-WALL-BUDGET @ RUN-BUDGET:MACOS-COLD-WALL-MS T= ;
...
: MACOS-SLOW-POLICY ( -- )
   ...
   -1 TR-COLD-CACHE !
   TR-COLD-BUDGETS
   TR-BUDGET @ RUN-BUDGET:MACOS-COLD-MS 2 * T=
   TR-WALL-BUDGET @ RUN-BUDGET:MACOS-COLD-WALL-MS 2 * T= ;
...
: NOMINAL-TAIL-POLICY ( -- )
   ...
   2 NESTED-POOL!
   TAIL-POLICY!
   TAIL-BUDGET:GROUP-MS 8000 T=
   TAIL-BUDGET:PROCESS-MS 10000 T=
   TAIL-BUDGET:TIMEOUT-MS 30000 T= ;

: SLOW-TAIL-POLICY ( -- )
   TR-CAL-REF-MACOS-MS 2 * MACOS!
   2 NESTED-POOL!
   TAIL-POLICY!
   TAIL-BUDGET:GROUP-MS 16000 T=
   TAIL-BUDGET:PROCESS-MS 20000 T=
   TAIL-BUDGET:TIMEOUT-MS 30000 T= ;
