\ value-nominal-dup-bad.f - a duplicate NOMINAL: in the SAME package is refused
\ fail-closed. NOMINAL: mints an arity-0 type family; redeclaring the same tail in
...
package CAMERA
NOMINAL: SERIAL
s" VALUE-NOMINAL-DUP-ARMED" type cr
NOMINAL: SERIAL
;package
