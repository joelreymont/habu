...
: GDX-TRUST-FIXTURE ( -- )
   ...
   GDX-TRUST-ROOT$ s" lib" GDX-PATH-BUF JOIN-PATH GDX-PATH-U !
   GDX-PATH$ MAKE-DIRS
   GDX-TRUST-ROOT$ s" maki" GDX-PATH-BUF JOIN-PATH GDX-PATH-U !
   GDX-PATH$ MAKE-DIRS
   GDX-TRUST-ROOT$ s" tools" GDX-PATH-BUF JOIN-PATH GDX-PATH-U !
   GDX-PATH$ MAKE-DIRS
