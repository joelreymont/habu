...
\ byte-for-byte against habu's bootstrap/cg/macho.fs output for the same program.
: GO  ASM-INIT  0 42 MOVZ,  16 1 MOVZ,  $80 SVC,
   BUILD-MACHO
   s" /tmp/sh-macho-got.bin" PATH0 1537 493 open  dup MBUF MLEN @ write drop  close ;
GO
