...
: INSTALL ( -- )
   [: EXEC-EVENT ;] is PROCESS-TRACE:EXEC-HOOK
   [: FORK-EVENT ;] is PROCESS-TRACE:FORK-HOOK
   [: 0 OWNER-U ! ;] is PROCESS-TRACE:CLEAR-HOOK
   [: CHILD-RESET ;] is PROCESS-TRACE:CHILD-HOOK ;
