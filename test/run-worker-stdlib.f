...
: RUN ( -- )
   ...
   TEST:RESIDENT case
      ...
      30 of STDLIB-INLINE:GSI-LINT-LIBS-CORE endof
      31 of STDLIB-INLINE:GSI-LINT-LIBS-PTX endof
      32 of STDLIB-INLINE:GSI-LINT-LIBS-PTX-NEG endof
      33 of STDLIB-INLINE:GSI-LINT-LIBS-PTX-TOOL endof
      34 of STDLIB-INLINE:GSI-LINT-ARTIFACTS-FAST endof
