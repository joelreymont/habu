...
\ uppercase-hex line, four bytes at a time, reading past the engine's stack
\ guards (src/compiler/native/codewalk.f), which precede every complete
\ transfer and are the engine's bytes, not the dispatch's. Each expected line
\ below is CONTAINS?-asserted, so the full per-word byte string must appear
\ verbatim in the dump.
\
\ Re-measured 2026-09-15 on linux-arm64 at the guarded engine: a selected
\ arm's tag/pad pop is now `movz x16,#bytes ; sub x19,x19,x16` (habu2.f
\ EM-COMPILE-ADT-MODE, x16 never pooled) and the arm branches span the guards
\ the dump omits, so their displacements moved with them. con-ok / con-err
\ carry no transfer and are unchanged. The macos strings below were derived
\ from these linux strings by the same syscall-tail substitution as before.
...
: PIN-PROG! ( -- )
   ...
   \ The engine's stack guards are read past (src/compiler/native/codewalk.f):
   \ they precede every transfer the dispatch makes and are not its own bytes.
   s\" require src/compiler/native/codewalk.f\n" PP+
   s\" variable MFP-A\n" PP+
   s\" variable MFP-C\n" PP+
   ...
   s\" : MFP-MARK ( -- ) cp@ MFP-A ! ;\n" PP+
   s\" : MFP-GUARDED? ( -- bool ) MFP-A @ cp@ MFP-A @ - MFP-C @ MFP-A @ - 4 / NWALK:SPAN-GUARDED? ;\n" PP+
   s\" : MFP-SHOW ( -- ) cp@ {: e:n :} MFP-A @ MFP-C ! begin MFP-C @ e < while MFP-GUARDED? 0= if MFP-WORD then MFP-C @ 4 + MFP-C ! repeat cr ;\n" PP+
...
\ measured on macos-aarch64 at this tree's fixpoint. con-ok / con-err have no
\ die block and are pinned unconditionally in PIN-CASES.
: MATCH-2-PIN$ ( -- ptr u8 n )     \ scalar 2-variant eliminator + per-target die
   HB-TARGET-MACOS? if
      s" "
   else
      s" "
   then ;

: MATCH-WIDE-PIN$ ( -- ptr u8 n )  \ wide (ptr u8 n n) arm + per-target die
   HB-TARGET-MACOS? if
      s" "
   else
      s" "
   then ;

: MATCH-3-PIN$ ( -- ptr u8 n )     \ three-variant dispatch + per-target die
   HB-TARGET-MACOS? if
      s" "
   else
      s" "
   then ;
