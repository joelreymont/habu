...
\ cap (exit 77 at ~1620 words), 17th local (exit 75), and a 1500-deep data stack
...
\ 1900 tiny definitions -> dictionary-full death (cap ~1620), not corruption
: MANY ( -- a u )  0 CL !
   1900 0 do  s" : W" +B  i 0 <# #s #> +B  s"  1 ; " +B  loop
   s" 42 ." +B  CBUF CL @ ;
T{ MANY RC-OF -> 77 }T
