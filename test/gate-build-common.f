...
$400000 constant GB-ELF-VMBASE
$B0 constant GB-ELF-DLOPEN-SLOT-OFF
$B8 constant GB-ELF-DLSYM-SLOT-OFF
...
: GB-REPORT-BUF ( -- ptr u8 )
   GB-REPORT-BUF-A@ 0= if
      GB-REPORT-CAP MEM:BYTES-ALLOC-LEN MEM:ALLOC-BYTES drop GB-REPORT-BUF-A!
   then
   GB-REPORT-BUF-A@ ;
