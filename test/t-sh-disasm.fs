\ t-sh-disasm.fs — the standalone's own ARM64 disassembler (selfhost/disasm.f) decodes
...
: DIS-OUT ( -- a u )
   0 CL !
   s" selfhost/disasm.f"      slurp-file +B   s"  " +B
   s" selfhost/disasm-demo.f" slurp-file +B
