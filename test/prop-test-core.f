...
: AX-NOEXEC-C ( -- ptr u8 n )
   s"  seal-capture prot-wid-add wf-tokix@ wf-pos@ wf-fam@ wf-width@ tfam-width@ locw-hw@ p2-carve-w p2-live-w@ p2-live-cum@ p2-locseq-reset wide-mark rec-wide-publish tfam-name$ tfam-arity@ tfam-kind@ tfam-public? tfam-var-start@ tfam-var-count@ sumv-name$ sumv-ctor-pkg$ " ;
