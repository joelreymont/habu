...
: AX-NOEXEC-A ( -- ptr u8 n )
   s"  open openat read read-fd write-fd entropy ioctl mmap path0 open-rd access unlink unlinkat rename renameat link chmod symlink readlink mkdir mkdirat rmdir stat64 fstat64 fstatat64 lstat64 getdirentries64 pipe dup2 fcntl poll kill setpgid write close close-rc fsync " ;
