...
: AX-NOEXEC-A ( -- ptr u8 n )
   s"  open open-errno openat read read-fd write-fd entropy ioctl mmap path0 open-rd access unlink unlinkat mkdirat rename renameat link fchmod chmod symlink readlink mkdir rmdir stat64 fstat64 fstatat-nofollow lstat64 getdirentries64 pipe dup2 fcntl poll kill setpgid write close close-rc fsync " ;
