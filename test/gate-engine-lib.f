...
: GE-PROMOTE-CANDIDATE ( -- )
   GE-CANDIDATE!
   GE-SRC-CANDIDATE!
   GE-SRC-CANDIDATE$ GE-CANDIDATE$ STR= 0= if
      GE-REMOVE-CANDIDATE
      GE-SRC-CANDIDATE$ GE-CANDIDATE$ RENAME-FILE
      GE-CANDIDATE$ CHMOD-X
   then
   GE-CANDIDATE$ s" -host" GE-SRC-CAND-PATH FS-MUT-SUFFIX-PATH GE-SRC-CAND-U !
   s" hb-host" BF-A$ GE-SRC-CANDIDATE$ RENAME-FILE ;
