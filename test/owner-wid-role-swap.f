...
\ DEFTYPE types render through the type-family substrate, so the diagnostic
...
\ DEFTYPE indices are a faithful toy stand-in that pins the checker mechanism;
...
DEFTYPE OWNER-ROW-IDX
DEFTYPE PROT-ROW-IDX
