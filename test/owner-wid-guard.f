...
\ whose cold prefix restores OWNER-WID-COLD-TEST's public/private WID pair,
\ then runs the read-only suites under that image. A plain
\ `bin/hb --load test/owner-wid-<x>.f`
