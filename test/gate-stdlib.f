...
TEST-SUITE ptx-stdlib
   lib/errors.f lib/string.f lib/test.f lib/ptx.f lib/ptx-test.f lib/ptx-tile.f lib/ptx-tile-test.f lib/ptx-collective.f lib/ptx-collective-test.f lib/ptx-autograd-test.f lib/ptx-ad.f lib/ptx-ad-test.f
;TEST-SUITE
