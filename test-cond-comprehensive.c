/* Comprehensive cond expression tests */
...
int main() {
    ...
    printf("========================================\n");
    printf("Cond Comprehensive Tests\n");
    printf("========================================\n");

    /* Test 1: (cond (1 42)) - simple truthy test */
    {
        printf("\n=== Test 1: (cond (1 42)) ===\n");
        printf("Expected: 42\n");
    ...
    /* Test 2: (cond (0 42)) - falsy test, should return 0 */
    {
        printf("\n=== Test 2: (cond (0 42)) ===\n");
        printf("Expected: 0\n");
        ...
        unsigned char code[] = {
            0xFD, 0x7B, 0xBF, 0xA9, 0xFD, 0x03, 0x00, 0x91,
            0x00, 0x00, 0x80, 0xD2,  // movz x0, #0 (0 << 4)
            0x1F, 0x00, 0x1F, 0xEB,  // cmp x0, xzr
            0x60, 0x00, 0x00, 0x54,  // beq +3
