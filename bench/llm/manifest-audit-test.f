...
: BMA-AUDIT-TEST-MAIN ( -- )
   ...
   [: BMA-EXPECT-BAD-HEADER ;] E-BM-SCHEMA TTHROWSQ
   [: BMA-EXPECT-BAD-FIELDS ;] E-BM-SCHEMA TTHROWSQ
   [: BMA-EXPECT-MISSING-ROW ;] E-BM-SCHEMA TTHROWSQ
   [: BMA-EXPECT-MISSING-TAG ;] E-BM-SCHEMA TTHROWSQ
