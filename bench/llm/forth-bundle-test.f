...
: FBT-MAIN ( -- )
   T-RESET
   FBT-EXPECT-BUNDLE
   ['] FBT-EXPECT-MISSING-REF E-FB-MISSING TTHROWS
   CLEANUP-RUN
   ['] FBT-EXPECT-MISSING-CAND E-FB-MISSING TTHROWS
   CLEANUP-RUN
   ['] FBT-EXPECT-MISSING-TARGET E-FB-MISSING TTHROWS
   CLEANUP-RUN
   ['] FBT-EXPECT-DUPLICATE E-FB-DUPLICATE TTHROWS
   CLEANUP-RUN
   ['] FBT-EXPECT-BAD-SCHEMA E-BM-SCHEMA TTHROWS
   CLEANUP-RUN
   ['] FBT-EXPECT-CAPACITY E-FB-CAPACITY TTHROWS
   CLEANUP-RUN
   T-REPORT
