...
: AST-MAIN ( -- )
   ...
   AST-EXPECT-BUILD-TASKS-BALANCED
   AST-EXPECT-VALID
   [: AST-EXPECT-EXTRA ;] E-AS-EXTRA TTHROWSQ
   [: AST-EXPECT-MISSING ;] E-AS-MISSING TTHROWSQ
   [: AST-EXPECT-DUP-SOL ;] E-AS-DUPLICATE TTHROWSQ
   [: AST-EXPECT-DUP-TASK ;] E-AS-DUPLICATE TTHROWSQ
   CLEANUP-RUN
