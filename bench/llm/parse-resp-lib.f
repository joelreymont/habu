...
variable PR-ITEM
variable PR-NUM-I
variable PR-PARSER-A
variable PR-PARSER-U
variable PR-TF-A
variable PR-TF-U
...
: PR-TF$ ( -- ptr u8 n )
   PR-TF-SET @ IF PR-TF-CONFIG$ exit THEN
...
: PR-PARSER$ ( -- ptr u8 n )
   PR-PARSER-SET @ IF PR-PARSER-CONFIG$ exit THEN
...
: PR-PARSE-BUFFER ( ptr u8 n ptr u8 n ptr u8 n -- )
   ...
   parser parseru PR-PARSER!
   fields fieldsu PR-TOKEN-FIELDS!
   input inputu PR-IN!
   PR-PARSE-RESP
