...
DTH-SRC-RESET
DTH-SRC-TASK-HEAD
s" PROC-FIX-RC-PATH$ >LEN RUN-RC RC>N 0= " DTH-SRC+
...
s" >LEN PROC-FIX-OUT PROC-FIX-CAP >LEN " DTH-SRC+
s" PROC-FIX-ERR PROC-FIX-CAP >LEN " DTH-SRC+
s" PROC-FIX-TIMEOUT-MS >MS RUN-CAPTURE " DTH-SRC+
s" {: outu erru rc :} " DTH-SRC+
s" rc RC>N 0 <> if STR-FALSE exit then " DTH-SRC+
s" outu LEN>N 3 <> if STR-FALSE exit then " DTH-SRC+
s" erru LEN>N 3 <> if STR-FALSE exit then " DTH-SRC+
s" PROC-FIX-OUT outu LEN>N PROC-FIX-OUT-WANT$ STR= 0= if STR-FALSE exit then " DTH-SRC+
s" PROC-FIX-ERR erru LEN>N PROC-FIX-ERR-WANT$ STR= " DTH-SRC+
DTH-SRC-END DP-RUN-TEXT
LR-OUTCOME$ s" pass" T$=
LR-FIRST-CHECKER$ s" certified" T$=
LR-TESTS-PASSED @ -1 T=
...
s" PROC-FIX-TIMEOUT-MS >MS RUN-CAPTURE " DTH-SRC+
s" {: outu erru rc :} " DTH-SRC+
s" rc RC>N 7 = outu LEN>N 0= and erru LEN>N 0= and " DTH-SRC+
DTH-SRC-END DP-RUN-TEXT
LR-OUTCOME$ s" pass" T$=
LR-FIRST-CHECKER$ s" certified" T$=
LR-TESTS-PASSED @ -1 T=
...
DTH-SRC-RESET
s" : PROC-CAPTURE-TIMEOUT ( -- len len rc ) " DTH-SRC+
s" PROC-FIX-HANG-PATH$ >LEN PROC-FIX-OUT PROC-FIX-CAP >LEN " DTH-SRC+
s" PROC-FIX-ERR PROC-FIX-CAP >LEN " DTH-SRC+
s" PROC-FIX-SHORT-TIMEOUT-MS >MS RUN-CAPTURE " DTH-SRC+
DTH-SRC-END DP-RUN-TEXT
LR-OUTCOME$ s" reject" T$=
LR-FIRST-CHECKER$ s" certified" T$=
LR-TESTS-PASSED @ 0 T=
...
DTH-SRC-RESET
s" : PROC-CAPTURE-TRUNCATED ( -- len len rc ) " DTH-SRC+
s" PROC-FIX-LONG-PATH$ >LEN PROC-FIX-OUT PROC-FIX-SMALL-CAP >LEN " DTH-SRC+
s" PROC-FIX-ERR PROC-FIX-CAP >LEN " DTH-SRC+
s" PROC-FIX-TIMEOUT-MS >MS RUN-CAPTURE " DTH-SRC+
DTH-SRC-END DP-RUN-TEXT
LR-OUTCOME$ s" reject" T$=
