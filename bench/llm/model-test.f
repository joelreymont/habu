...
: MR-MODEL-TEST-MAIN ( -- )
   ...
   s" " MR-REQUIRE
   MR-ID$ s" alpha" T$=
   [: MR-EXPECT-BAD-HEADER ;] E-BM-SCHEMA TTHROWSQ
   [: MR-EXPECT-BAD-TIMEOUT ;] E-BM-FIELD TTHROWSQ
   [: MR-EXPECT-BAD-MISSING ;] E-BM-FIELD TTHROWSQ
   [: MR-EXPECT-MISSING ;] E-BM-MODEL-NOT-FOUND TTHROWSQ
