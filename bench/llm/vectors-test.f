...
T{ 1 2 PLUS -> 2 1 }T
" T$=
   [: BV-EXPECT-BAD-ARROW ;] E-BM-SCHEMA TTHROWSQ
   [: BV-EXPECT-BAD-ARRAY ;] E-BM-FIELD TTHROWSQ
   [: BV-EXPECT-BAD-SCALAR ;] E-BM-FIELD TTHROWSQ
   [: BV-EXPECT-BAD-MISMATCH ;] E-BM-SCHEMA TTHROWSQ
   [: BV-EXPECT-BAD-CONV ;] E-BM-FIELD TTHROWSQ
   T-REPORT
