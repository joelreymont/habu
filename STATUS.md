...
Gate: passing; 1m43.35s on 2026-06-27 on Linux/aarch64 with warm checker/tool images, shared hb-build maker cache, two-build positive AOT coverage, direct repair JSON assertions, deduplicated AOT negative coverage, and the checked DAG pool
