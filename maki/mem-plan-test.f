...
: MP-EW ( n n layout -- )                          \ x:rows x cols (input layout) -> GELU RELU
   ...
   r c SHAPE  MAKI-DATATYPE:DF32  r>  MIR-INPUT+ drop
   ...
   rows cols MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
...
MIR-RESET
2 4 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
1 1 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
...
MIR-RESET
2 4 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop  0 MIR-SLOT-ID MAKI-ALIGN:A16 MIR-SLOT-AL!    \ slot0 x  (2x4)
1 4 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop  1 MIR-SLOT-ID MAKI-ALIGN:A16 MIR-SLOT-AL!    \ slot1 b  (1x4)
MAKI-OPKIND:ADD MIR-OP-BEGIN 0 MIR-SLOT-ID MIR-IN-REF MIR-IN+ 1 MIR-SLOT-ID MIR-IN-REF MIR-IN+ 2 4 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
FP-BUILD
REPORT:NEW MEM-PLAN-INTO
...
MIR-RESET
4 8 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop  0 MIR-SLOT-ID MAKI-ALIGN:A16 MIR-SLOT-AL!    \ slot0 x   (data)
3 1 SHAPE MAKI-DATATYPE:DI32 MAKI-LAYOUT:ROW MIR-INPUT+ drop  1 MIR-SLOT-ID MAKI-ALIGN:A16 MIR-SLOT-AL!    \ slot1 idx
MAKI-OPKIND:GATHER MIR-OP-BEGIN 0 MIR-SLOT-ID MIR-IN-REF MIR-IN+ 1 MIR-SLOT-ID MIR-IN-REF MIR-IN+
   3 8 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW  MV-GATHER MVV-GATHERED 0 0 MV-PACK  1  MIR-OP+ drop
FP-BUILD
REPORT:NEW MEM-PLAN-INTO
dup 0 REPORT:HOT-NAME@   s" i0" T$=
