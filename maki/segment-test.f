...
: SGT-IR ( bool -- ) {: causal:bool :}
   MIR-RESET
   SGT-ROWS SGT-D SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
   SGT-ROWS SGT-D SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
   SGT-ROWS SGT-D SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
   MAKI-OPKIND:SEG-ATTN MIR-OP-BEGIN
      ...
      SGT-ROWS SGT-D SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW  SGT-T causal SEG-PACK  1  MIR-OP+ drop ;
