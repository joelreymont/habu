...
MAKI-OPKIND:ADD MIR-OP-BEGIN 0 MIR-NODE-ID MIR-NODE-REF MIR-IN+ 1 MIR-SLOT-ID MIR-IN-REF MIR-IN+ 2 4 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
FP-BUILD
FP-REGION-COUNT 1 T=
