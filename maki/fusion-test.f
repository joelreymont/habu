...
\ Reopens `package FUSION` so the fusion words resolve by bare name (the test is part of
\ the module); the harness words (T-*) and E-FUSE resolve via the package global fallback.
