...
s" LMT-LEW-A-EF ( CAD-KIND:target-id -- ) LEW-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LEW-A-ST ( CAD-KIND:numeric-policy-id -- ) LEW-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LEW-A-ND ( CAD-KIND:node-id -- ) LEW-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LEW-E-EF ( CAD-KIND:target-id -- ) LEW-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LEW-E-ST ( CAD-KIND:numeric-policy-id -- ) LEW-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LEW-E-ND ( CAD-KIND:node-id -- ) LEW-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LRED-A-EF ( CAD-KIND:target-id -- ) LRED-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LRED-A-ST ( CAD-KIND:numeric-policy-id -- ) LRED-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LRED-A-ND ( CAD-KIND:node-id -- ) LRED-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LRED-E-EF ( CAD-KIND:target-id -- ) LRED-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LRED-E-ST ( CAD-KIND:numeric-policy-id -- ) LRED-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LRED-E-ND ( CAD-KIND:node-id -- ) LRED-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMM-A-EF ( CAD-KIND:target-id -- ) LMM-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMM-A-ST ( CAD-KIND:numeric-policy-id -- ) LMM-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMM-A-ND ( CAD-KIND:node-id -- ) LMM-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMM-E-EF ( CAD-KIND:target-id -- ) LMM-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMM-E-ST ( CAD-KIND:numeric-policy-id -- ) LMM-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMM-E-ND ( CAD-KIND:node-id -- ) LMM-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMV-A-EF ( CAD-KIND:target-id -- ) LMV-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMV-A-ST ( CAD-KIND:numeric-policy-id -- ) LMV-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMV-A-ND ( CAD-KIND:node-id -- ) LMV-ANALYZE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMV-E-EF ( CAD-KIND:target-id -- ) LMV-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LMV-E-ST ( CAD-KIND:numeric-policy-id -- ) LMV-EMIT" CHECK-QUIET-CANDIDATE! 0 T=
...
s" LMT-LD-EF ( ptr u8 n ptr u8 n ptr u8 n CAD-KIND:target-id ptr u8 n -- ) LOWER-DRIVER!" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-LD-ST ( ptr u8 n ptr u8 n ptr u8 n CAD-KIND:numeric-policy-id ptr u8 n -- ) LOWER-DRIVER!" CHECK-QUIET-CANDIDATE! 0 T=
...
s" LMT-WD-EF ( ptr u8 n CAD-KIND:target-id ptr u8 n -- ) LEW-WRITE-DRIVER" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-WD-ST ( ptr u8 n CAD-KIND:numeric-policy-id ptr u8 n -- ) LEW-WRITE-DRIVER" CHECK-QUIET-CANDIDATE! 0 T=
...
s" LMT-RMM-EF ( CAD-KIND:target-id -- bool ) LLA-REGION-MATMUL?" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RMM-ST ( CAD-KIND:numeric-policy-id -- bool ) LLA-REGION-MATMUL?" CHECK-QUIET-CANDIDATE! 0 T=
...
s" LMT-RRD-EF ( CAD-KIND:target-id -- bool ) LLA-REGION-REDUCE?" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RRD-ST ( CAD-KIND:numeric-policy-id -- bool ) LLA-REGION-REDUCE?" CHECK-QUIET-CANDIDATE! 0 T=
...
s" LMT-RMV-EF ( CAD-KIND:target-id -- bool ) LLA-REGION-MOVE?" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RMV-ST ( CAD-KIND:numeric-policy-id -- bool ) LLA-REGION-MOVE?" CHECK-QUIET-CANDIDATE! 0 T=
...
s" LMT-CU-EF ( ptr u8 n CAD-KIND:target-id -- ) MDL-CUBIN!" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-CU-ST ( ptr u8 n CAD-KIND:numeric-policy-id -- ) MDL-CUBIN!" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-CU-ND ( ptr u8 n CAD-KIND:node-id -- ) MDL-CUBIN!" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-REW-EF ( CAD-KIND:target-id -- ) LLA-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-REW-ST ( CAD-KIND:numeric-policy-id -- ) LLA-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-REW-ND ( CAD-KIND:node-id -- ) LLA-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RR-EF ( CAD-KIND:target-id -- ) LRED-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RR-ST ( CAD-KIND:numeric-policy-id -- ) LRED-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RR-ND ( CAD-KIND:node-id -- ) LRED-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RM-EF ( CAD-KIND:target-id -- ) LMM-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RM-ST ( CAD-KIND:numeric-policy-id -- ) LMM-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RM-ND ( CAD-KIND:node-id -- ) LMM-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RV-EF ( CAD-KIND:target-id -- ) LMV-RUN" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-RV-ST ( CAD-KIND:numeric-policy-id -- ) LMV-RUN" CHECK-QUIET-CANDIDATE! 0 T=
...
s" LMT-MS-EF ( CAD-KIND:target-id -- ) MDL-STAGE" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-MS-ST ( CAD-KIND:numeric-policy-id -- ) MDL-STAGE" CHECK-QUIET-CANDIDATE! 0 T=
...
s" LMT-MD-EF ( CAD-KIND:target-id -- ) MDL-DISPATCH" CHECK-QUIET-CANDIDATE! 0 T=
s" LMT-MD-ST ( CAD-KIND:numeric-policy-id -- ) MDL-DISPATCH" CHECK-QUIET-CANDIDATE! 0 T=
