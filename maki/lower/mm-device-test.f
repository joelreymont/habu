...
\
\ docs/archive/cad-plan.md section 11 device-vs-host GOLDEN, slice 3. For each matmul model (MATMUL,
...
: LMD-EMIT ( ptr u8 n -- ) {: sa:ptr su:n :}
   sa su  s" require maki/lower/mm.f"  s" LMM-EMIT"  0 FP-REGION-ID  MAKI-GRADE:DRIVER$  LOWER-DRIVER!
   PROC-ARGV-RESET
...
: LMD-PTXAS ( -- n )
   ...
   LMD-QO $1000 >LEN LMD-QE $2000 >LEN PTXTC:ASSEMBLE ;
