...
: TRY-BIAS-BADCOL ( -- )                              \ bias cols != data cols (not 1xC)
   TENSOR:TV-RESET
   2 4 SHAPE DT-F32 LAY-ROW SPACE-HOST TENSOR:TV-DESC
   1 3 SHAPE DT-F32 LAY-ROW SPACE-HOST TENSOR:TV-DESC
   OP-BIAS EW-SHAPE-CHECK ;
: TRY-SCALE-BAD   ( -- )                              \ scale param neither same-shape nor 1x1
   TENSOR:TV-RESET
   2 4 SHAPE DT-F32 LAY-ROW SPACE-HOST TENSOR:TV-DESC
   1 4 SHAPE DT-F32 LAY-ROW SPACE-HOST TENSOR:TV-DESC
   OP-SCALE EW-SHAPE-CHECK ;
...
0 TARGET:SM87 SK-KEY$ SCHED-GET nip TFALSE
0 TARGET:SM87 SK-KEY$ EVID-GET  nip TFALSE
STORE-RESET
