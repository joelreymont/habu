...
: TRY-EW-MISMATCH ( -- )                              \ residual param shape != data shape
   TENSOR:TV-RESET  4 8 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC  2 3 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC  MAKI-OPKIND:RESIDUAL-ADD EW-SHAPE-CHECK ;
: TRY-BIAS-BADCOL ( -- )                              \ bias cols != data cols (not 1xC)
   TENSOR:TV-RESET  2 4 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC  1 3 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC  MAKI-OPKIND:BIAS EW-SHAPE-CHECK ;
...
: TRY-MV-RESHAPE ( -- )                                       \ element count mismatch
   TENSOR:TV-RESET TENSOR:PLAN-RESET  2 3 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC 2 2 SHAPE PLAN-RESHAPE drop ;
