...
: TRY-BIAS-BADCOL ( -- )                              \ bias cols != data cols (not 1xC)
   TENSOR:TV-RESET  2 4 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC  1 3 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC  MAKI-OPKIND:BIAS EW-SHAPE-CHECK ;
: TRY-SCALE-BAD   ( -- )                              \ scale param neither same-shape nor 1x1
   TENSOR:TV-RESET  2 4 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC  1 4 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC  MAKI-OPKIND:SCALE EW-SHAPE-CHECK ;
...
: TRY-MV-RESHAPE ( -- )                                       \ element count mismatch
   TENSOR:TV-RESET TENSOR:PLAN-RESET  2 3 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC 2 2 SHAPE PLAN-RESHAPE drop ;
