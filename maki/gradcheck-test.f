...
: DET-BUILD ( -- )        \ slot0=x, n0=gelu(x), slot1=seed, n1=WRONG relu-bwd(seed,x)
   ...
   2 2 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
   MAKI-OPKIND:RELU-BWD MIR-OP-BEGIN 1 MIR-SLOT-ID MIR-IN-REF MIR-IN+ 0 MIR-SLOT-ID MIR-IN-REF MIR-IN+
...
: DET-BUILD-OK ( -- )     \ same fixture with the CORRECT gelu-bwd adjoint
   ...
   MAKI-OPKIND:GELU MIR-OP-BEGIN 0 MIR-SLOT-ID MIR-IN-REF MIR-IN+ 2 2 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
   2 2 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
   MAKI-OPKIND:GELU-BWD MIR-OP-BEGIN 1 MIR-SLOT-ID MIR-IN-REF MIR-IN+ 0 MIR-SLOT-ID MIR-IN-REF MIR-IN+
      2 2 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop ;

: DET-RUN ( -- )          \ fill x + seed, run the whole hand-built IR
   0.7 GX 0 T-SET 1.3 GX 1 T-SET 0.9 GX 2 T-SET 1.7 GX 3 T-SET
   1.0 GS 4 T-FILL
   EX-RESET  GX 0 MIR-SLOT-ID EX-BIND  GS 1 MIR-SLOT-ID EX-BIND  EX-RUN ;

: DET-ANALYTIC ( -- r )  1 MIR-NODE-ID EX-OUT@ 0 T-GET ;      \ backward node 1, element 0

: DET-FD ( -- r )         \ central diff of the forward gelu node 0 at element 0
   GX 0 T-GET {: base:r :}
   base 0.001 f+ GX 0 T-SET  1 EX-RUN-N  0 MIR-NODE-ID EX-OUT@ 0 T-GET {: yp:r :}
   base 0.001 f- GX 0 T-SET  1 EX-RUN-N  0 MIR-NODE-ID EX-OUT@ 0 T-GET {: ym:r :}
   base GX 0 T-SET
   yp ym f-  0.002 f/ ;
