...
: LNAO-DXHAT-MUL ( -- )                                   \ dy 3x4 * gamma 1x4 as OP-MUL -> reject
   TENSOR:TV-RESET
   3 4 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC
   1 4 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC
...
: LNAO-BUILD-LN ( n n -- ) {: at:n k:n :}                 \ LAYERNORM node: k inputs (from slots), form attr `at`
   ...
   1 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
   1 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
   1 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
   MAKI-OPKIND:LAYERNORM MIR-OP-BEGIN
   k 0 ?do  i MIR-SLOT-ID MIR-IN-REF MIR-IN+  loop
   4 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW  at  1  MIR-OP+ drop ;
