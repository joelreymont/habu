...
\ test-local dim literal: n as the elems of an (n,1) shape (public words only)
: TN-DIM ( n -- CAD-KIND:dim )  1 SHAPE SHAPE-ELEMS ;

\ dtype byte sizes (constructed family values -> CAD-KIND:dim)
MAKI-DATATYPE:DF32  DT-SIZE 4 TN-DIM DIM-EQUAL? TTRUE
MAKI-DATATYPE:DF16  DT-SIZE 2 TN-DIM DIM-EQUAL? TTRUE
MAKI-DATATYPE:DBF16 DT-SIZE 2 TN-DIM DIM-EQUAL? TTRUE
MAKI-DATATYPE:DU32  DT-SIZE 4 TN-DIM DIM-EQUAL? TTRUE
MAKI-DATATYPE:DI32  DT-SIZE 4 TN-DIM DIM-EQUAL? TTRUE

\ wire boundaries round-trip: family -> DT-* code / wire text
MAKI-DATATYPE:DF32  DTYPE>N DT-F32  T=
MAKI-DATATYPE:DI32  DTYPE>N DT-I32  T=
MAKI-DATATYPE:DBF16 DT-KEY s" bf16" T$=

\ typed shape element count
3 4 SHAPE SHAPE-ELEMS 12 TN-DIM DIM-EQUAL? TTRUE
1 1 SHAPE SHAPE-ELEMS 1 TN-DIM DIM-EQUAL? TTRUE
...
3 4 SHAPE MAKI-DATATYPE:DF32 SHAPE-BYTES 48 TN-DIM DIM-EQUAL? TTRUE
2 8 SHAPE MAKI-DATATYPE:DF16 SHAPE-BYTES 32 TN-DIM DIM-EQUAL? TTRUE
...
\ row window (slice extent [a,b) of a source extent)
1 3  4 8 SHAPE drop  ROWS-WINDOW  2 1 SHAPE drop ROWS-EQUAL? TTRUE
0 4  4 8 SHAPE drop  ROWS-WINDOW  4 1 SHAPE drop ROWS-EQUAL? TTRUE
: TN-WINDOW-HI  ( -- )  2 9  8 1 SHAPE drop  ROWS-WINDOW drop ;
: TN-WINDOW-INV ( -- )  3 1  8 1 SHAPE drop  ROWS-WINDOW drop ;
: TN-WINDOW-NEG ( -- )  -1 2  8 1 SHAPE drop ROWS-WINDOW drop ;
' TN-WINDOW-HI  E-MK-DIM TTHROWS
' TN-WINDOW-INV E-MK-DIM TTHROWS
' TN-WINDOW-NEG E-MK-DIM TTHROWS

\ dim algebra over the nominal families
3 1 SHAPE SHAPE-ELEMS 1 1 SHAPE SHAPE-ELEMS DIM-BCAST? TTRUE
3 1 SHAPE SHAPE-ELEMS MAKI-DATATYPE:DF32 DT-SIZE DIM-BCAST? TFALSE
3 1 SHAPE SHAPE-ELEMS MAKI-DATATYPE:DF32 DT-SIZE DIM-MAX 4 TN-DIM DIM-EQUAL? TTRUE
...
MAKI-DATATYPE:DF16 DT-SIZE MAKI-DATATYPE:DBF16 DT-SIZE DIM* 4 TN-DIM DIM-EQUAL? TTRUE
...
MAKI-DATATYPE:DF32 MAKI-DATATYPE:DF16 MAKI-DATATYPE:EQ TFALSE
MAKI-DATATYPE:DF32 MAKI-DATATYPE:DF32 MAKI-DATATYPE:EQ TTRUE
...
s" TT-DT-OK   ( datatype -- CAD-KIND:dim ) DT-SIZE"  CHECK-QUIET-CANDIDATE! -1 T=
s" TT-DT-NIN  ( n -- CAD-KIND:dim ) DT-SIZE"      CHECK-QUIET-CANDIDATE! 0 T=
s" TT-DT-NOUT ( datatype -- n ) DTYPE>N 1 +"         CHECK-QUIET-CANDIDATE! -1 T=

\ Same-cell semantic swaps reject before runtime (Model-CAD V2 R3 acceptance).
s" TENSOR-NEG-DIM-DTYPE ( CAD-KIND:dim datatype -- CAD-KIND:dim ) MAKI:DIM*" CHECK-QUIET-CANDIDATE! 0 T=
s" TENSOR-NEG-DIM-FOR-DTYPE ( CAD-KIND:rows CAD-KIND:cols CAD-KIND:dim -- CAD-KIND:dim ) MAKI:SHAPE-BYTES" CHECK-QUIET-CANDIDATE! 0 T=
...
s" TENSOR-ROWS-WINDOW-OK ( n n CAD-KIND:rows -- CAD-KIND:rows ) MAKI:ROWS-WINDOW" CHECK-QUIET-CANDIDATE! -1 T=
s" TENSOR-NEG-WINDOW-COLS ( n n CAD-KIND:cols -- CAD-KIND:rows ) MAKI:ROWS-WINDOW" CHECK-QUIET-CANDIDATE! 0 T=
s" TENSOR-NEG-WINDOW-AS-COLS ( n n CAD-KIND:rows -- CAD-KIND:cols ) MAKI:ROWS-WINDOW" CHECK-QUIET-CANDIDATE! 0 T=
