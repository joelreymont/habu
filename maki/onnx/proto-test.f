...
: BUILD-MIX ( -- )                             \ varint + fixed32 + bytes + fixed64 fields
   ...
   1.5 2 ENC-F32A
   s" ab" 3 ENC-STR
   4 WT-I64 ENC-TAG  8 0 ?do 0 ENC-B loop ;
...
ENC-RESET 0 ENC-VARINT
ENC$ nip 1 T=
ENC$ 0 ONNX:PB-VARINT@ 1 T= 0 T=

ENC-RESET 127 ENC-VARINT
ENC$ nip 1 T=
ENC$ 0 ONNX:PB-VARINT@ 1 T= 127 T=

ENC-RESET 300 ENC-VARINT             \ spec example: 300 = AC 02
ENC$ nip 2 T=
ENC$ drop c@ $AC T=
ENC$ drop 1+ c@ $02 T=
ENC$ 0 ONNX:PB-VARINT@ 2 T= 300 T=

ENC-RESET -1 ENC-VARINT              \ max u64 / int64 -1: ten bytes
ENC$ nip 10 T=
ENC$ drop c@ $FF T=
ENC$ drop 9 + c@ $01 T=
ENC$ 0 ONNX:PB-VARINT@ 10 T= -1 T=

\ ---- tag decode ---------------------------------------------------------------
ENC-RESET 7 WT-LEN ENC-TAG      \ (7 << 3) | 2 = 3A
ENC$ drop c@ $3A T=
ENC$ 0 ONNX:PB-TAG@ 1 T= WT-LEN T= 7 T=

ENC-RESET 1000 WT-VARINT ENC-TAG   \ multibyte tag varint
ENC$ 0 ONNX:PB-TAG@ 2 T= WT-VARINT T= 1000 T=

\ ---- length-delimited slice -----------------------------------------------------
ENC-RESET s" hello" 3 ENC-STR
ENC$ 0 ONNX:PB-TAG@ 1 T= WT-LEN T= 3 T=
ENC$ 1 ONNX:PB-LEN@ 7 T= 5 T= 2 T=        \ off=2 len=5 pos'=7
ENC$ drop 2 + 5 s" hello" STR= TTRUE

\ ---- fixed32 --------------------------------------------------------------------
ENC-RESET 1.0 ENC-F32
ENC$ nip 4 T=
ENC$ 0 ONNX:PB-I32@ 4 T= $3F800000 T=     \ 1.0f bit pattern, LE assembled
