...
\ (GPU:EPOCH -> GPU:SGD -> SAXPY kernel) and the host recomputes grad=2*(w-1) from the
...
GPU:INIT-W
GPU:LOSS LOSS0 !                             \ initial loss = 84

GPU:SETUP
0.25 GPU:EPOCH  0.25 GPU:EPOCH  0.25 GPU:EPOCH    \ 3 device SGD epochs
GPU:RELEASE
