...
dup TENSOR:TV-DTYPE@   MAKI-DATATYPE:DF32 MAKI-DATATYPE:EQ TTRUE
...
TVT-BX 3 5 SHAPE MAKI-DATATYPE:DBF16 MAKI-LAYOUT:COL TENSOR:TV-NEW-HOST
...
2 3 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC
...
1 1 SHAPE MAKI-DATATYPE:DF16 MAKI-LAYOUT:ROW SPACE-SHARED TENSOR:TV-DESC
...
variable TVT-BLDX
TENSOR:PLAN-RESET
2 3 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC TVT-BLDX !
MAKI-OPKIND:GELU TENSOR:PLAN-OP-BEGIN
TVT-BLDX @ TENSOR:PLAN-IN+
2 3 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC TENSOR:PLAN-OP+
TENSOR:PLAN-N@ 1 T=
...
TENSOR:PLAN-RESET
2 3 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC TVT-X !     \ X   2x3
3 4 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC TVT-W1 !    \ W1  3x4
1 4 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC TVT-B1 !    \ b1  1x4
4 5 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC TVT-W2 !    \ W2  4x5
1 5 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC TVT-B2 !    \ b2  1x5
...
: TVT-NODATA    ( -- )
   2 2 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC
   TENSOR:TV-DATA@ drop ;
: TVT-BAD-SHAPE ( -- )
...
: TVT-IN-NB     ( -- )
   TENSOR:PLAN-RESET
   2 2 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC TENSOR:PLAN-IN+ ;
: TVT-OP-NB     ( -- )
   TENSOR:PLAN-RESET
   2 2 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC TENSOR:PLAN-OP+ ;
...
: TVT-STALE ( -- )
   TENSOR:TV-RESET
   2 2 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC {: old:tensor :}
   TENSOR:TV-RESET
   2 2 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC drop
   old TENSOR:TV-ROWS@ drop ;

: TVT-STALE-PLAN ( -- )
   TENSOR:TV-RESET TENSOR:PLAN-RESET
   2 2 SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-GLOBAL TENSOR:TV-DESC {: x:tensor :}
...
s" TVT-OK-NEW   ( ptr r CAD-KIND:rows CAD-KIND:cols datatype layout -- tensor ) TENSOR:TV-NEW-HOST" CHECK-QUIET-CANDIDATE! -1 T=
s" TVT-NEW-N    ( ptr n CAD-KIND:rows CAD-KIND:cols datatype layout -- tensor ) TENSOR:TV-NEW-HOST" CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-NEW-U8   ( ptr u8 CAD-KIND:rows CAD-KIND:cols datatype layout -- tensor ) TENSOR:TV-NEW-HOST" CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-DATA-R   ( tensor -- ptr r ) TENSOR:TV-DATA@" CHECK-QUIET-CANDIDATE! -1 T=
s" TVT-DATA-N   ( tensor -- ptr n ) TENSOR:TV-DATA@" CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-DATA-U8  ( tensor -- ptr u8 ) TENSOR:TV-DATA@" CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-N-ROWS   ( ptr r n n datatype layout -- tensor ) TENSOR:TV-NEW-HOST"                         CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-N-DT     ( ptr r CAD-KIND:rows CAD-KIND:cols n layout -- tensor ) TENSOR:TV-NEW-HOST"     CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-N-LAY    ( ptr r CAD-KIND:rows CAD-KIND:cols datatype n -- tensor ) TENSOR:TV-NEW-HOST"      CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-SWAP-NEW ( ptr r CAD-KIND:rows CAD-KIND:cols layout datatype -- tensor ) TENSOR:TV-NEW-HOST" CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-NEG-ROWS-COLS ( CAD-KIND:cols CAD-KIND:rows datatype layout CAD-KIND:address-space -- tensor ) TENSOR:TV-DESC" CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-NEG-DTYPE-LAYOUT ( CAD-KIND:rows CAD-KIND:cols layout datatype CAD-KIND:address-space -- tensor ) TENSOR:TV-DESC" CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-NEG-LAYOUT-SPACE ( CAD-KIND:rows CAD-KIND:cols datatype CAD-KIND:address-space layout -- tensor ) TENSOR:TV-DESC" CHECK-QUIET-CANDIDATE! 0 T=
...
s" TVT-OP-DT    ( datatype -- ) TENSOR:PLAN-OP-BEGIN"                     CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-OP-NOUT  ( n -- n ) TENSOR:PLAN-OP@"                            CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-OP-ASDT  ( n -- datatype ) TENSOR:PLAN-OP@"                        CHECK-QUIET-CANDIDATE! 0 T=
...
: TVT-FORGED-IDX ( -- )
   TV-RESET
   1 1 MAKI:SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW MAKI:SPACE-GLOBAL TV-DESC drop
