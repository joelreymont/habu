...
s" TVT-N-LAY    ( ptr a CAD-KIND:rows CAD-KIND:cols datatype n -- tensor ) TENSOR:TV-NEW-HOST"      CHECK-QUIET-CANDIDATE! 0 T=
s" TVT-SWAP-NEW ( ptr a CAD-KIND:rows CAD-KIND:cols layout datatype -- tensor ) TENSOR:TV-NEW-HOST" CHECK-QUIET-CANDIDATE! 0 T=
