...
\ authored until certification, reported in both units: raw whitespace source
\ tokens and the GEN-TOK-EST model-token estimate (maki/eval/tokest.f). (This is
\ the Habu-PTX side; the Triton comparison is the external arm.)
...
s" SAXPY authoring: repair-rounds=" type EVAL:REPAIR-ROUNDS@ . s"  tokens-to-green=" type EVAL:REPAIR-TOKENS@ . s"  tok-est=" type EVAL:REPAIR-EST@ . cr
...
s" 1-fix authoring:  repair-rounds=" type EVAL:REPAIR-ROUNDS@ . s"  tokens-to-green=" type EVAL:REPAIR-TOKENS@ . s"  tok-est=" type EVAL:REPAIR-EST@ . cr
