...
: LREDT-IX>N ( CAD-NUM:index -- n )  INDEX>N ;
;package
...
: LREDT-FINDO ( ptr u8 n ptr u8 n -- option<CAD-NUM:index> ) {: ha:ptr hu:n na:ptr nu:n :}
   ha hu STR:LENGTH na nu STR:LENGTH STR:FIND-SUB ;      \ raw byte lengths -> STR byte-len roles
: LREDT-ABSENT ( ptr u8 n -- )   \ needle absent
   LREDT$ 2swap LREDT-FINDO MATCH option
     none OF true ENDOF
...
: LREDT-ONCE? ( ptr u8 n ptr u8 n -- bool ) {: ha:ptr hu:n na:ptr nu:n :}
   ha hu na nu LREDT-FINDO MATCH option
     none OF false exit ENDOF
     some OF CAD-NUM:LREDT-IX>N ENDOF
   ;MATCH {: i1:n :}
   ha i1 + nu +  hu i1 - nu -  na nu LREDT-FINDO MATCH option
     none OF true ENDOF
     some OF drop false ENDOF
   ;MATCH ;
...
4 1 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
MAKI-OPKIND:ADD MIR-OP-BEGIN  0 MIR-SLOT-ID MIR-IN-REF MIR-IN+  1 MIR-SLOT-ID MIR-IN-REF MIR-IN+
   4 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
MAKI-OPKIND:RMSNORM MIR-OP-BEGIN  0 MIR-NODE-ID MIR-NODE-REF MIR-IN+
   4 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
FP-BUILD
LREDT-CAP0
s" .visible .entry REGION_0"        LREDT-ONCE
...
4 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
4 1 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
MAKI-OPKIND:ADD MIR-OP-BEGIN  1 MIR-SLOT-ID MIR-IN-REF MIR-IN+  0 MIR-SLOT-ID MIR-IN-REF MIR-IN+
   4 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
MAKI-OPKIND:RMSNORM MIR-OP-BEGIN  0 MIR-NODE-ID MIR-NODE-REF MIR-IN+
   4 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
FP-BUILD
...
MIR-RESET
4 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
3 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop
MAKI-OPKIND:ADD MIR-OP-BEGIN  0 MIR-SLOT-ID MIR-IN-REF MIR-IN+  1 MIR-SLOT-ID MIR-IN-REF MIR-IN+
   4 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
MAKI-OPKIND:RMSNORM MIR-OP-BEGIN  0 MIR-NODE-ID MIR-NODE-REF MIR-IN+
   4 8 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop
