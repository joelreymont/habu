...
MIR-RESET
0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW MIR-INPUT+ drop                                              \ i0
MAKI-OPKIND:GELU MIR-OP-BEGIN  0 MIR-SLOT-ID MIR-IN-REF MIR-IN+  0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop \ n0=GELU(i0)
MAKI-OPKIND:RELU MIR-OP-BEGIN  0 MIR-NODE-ID MIR-NODE-REF MIR-IN+            0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop  \ n1=RELU(n0)
MAKI-OPKIND:RELU MIR-OP-BEGIN  0 MIR-NODE-ID MIR-NODE-REF MIR-IN+            0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop  \ n2=RELU(n0)
MAKI-OPKIND:RELU MIR-OP-BEGIN  0 MIR-NODE-ID MIR-NODE-REF MIR-IN+            0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop  \ n3=RELU(n0)
MAKI-OPKIND:ADD MIR-OP-BEGIN  1 MIR-NODE-ID MIR-NODE-REF MIR-IN+ 2 MIR-NODE-ID MIR-NODE-REF MIR-IN+  0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop  \ n4=ADD(n1,n2)
MAKI-OPKIND:ADD MIR-OP-BEGIN  4 MIR-NODE-ID MIR-NODE-REF MIR-IN+ 3 MIR-NODE-ID MIR-NODE-REF MIR-IN+  0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop  \ n5=ADD(n4,n3)
FP-BUILD
...
MAKI-OPKIND:GELU MIR-OP-BEGIN  0 MIR-SLOT-ID MIR-IN-REF MIR-IN+  0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop \ n0=GELU(i0)
MAKI-OPKIND:RELU MIR-OP-BEGIN  0 MIR-NODE-ID MIR-NODE-REF MIR-IN+            0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop  \ n1=RELU(n0)
MAKI-OPKIND:SILU MIR-OP-BEGIN  0 MIR-NODE-ID MIR-NODE-REF MIR-IN+            0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop  \ n2=SILU(n0)
MAKI-OPKIND:ADD MIR-OP-BEGIN  1 MIR-NODE-ID MIR-NODE-REF MIR-IN+ 2 MIR-NODE-ID MIR-NODE-REF MIR-IN+  0 0 SHAPE MAKI-DTYPE:DF32 MAKI-LAYOUT:ROW 0 1 MIR-OP+ drop  \ n3=ADD(n1,n2)
FP-BUILD
