...
: TRY-CAST ( -- )
   ...
   OP-CAST MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 2 2 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
...
: TRY-BINDSLOT ( -- )
   MIR-RESET  2 2 DT-F32 LAY-ROW MIR-INPUT+ drop  XB 7 EX-BIND ;

T-RESET

\ ---- MATMUL: X=[[1,2],[3,4]] W=[[5,6],[7,8]] -> Y=[[19,22],[43,50]] ----------
MIR-RESET
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ slot0 x
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ slot1 w
OP-MATMUL MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 MIR-IN-REF MIR-IN+ 2 2 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
...
MIR-RESET
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ x
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ w
1 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ b (1x2)
OP-LINEAR MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 MIR-IN-REF MIR-IN+ 2 MIR-IN-REF MIR-IN+
...
MIR-RESET
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop
1 2 DT-F32 LAY-ROW MIR-INPUT+ drop
OP-BIAS MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 MIR-IN-REF MIR-IN+ 2 2 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
...
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop
OP-MUL MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 MIR-IN-REF MIR-IN+ 2 2 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
...
MIR-RESET
1 3 DT-F32 LAY-ROW MIR-INPUT+ drop
OP-LAYERNORM MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 3 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
...
MIR-RESET
1 2 DT-F32 LAY-ROW MIR-INPUT+ drop
OP-SOFTMAX-ROW MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 2 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
...
MIR-RESET
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop
OP-TRANSPOSE MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+
   2 2 DT-F32 LAY-ROW  MV-TRANSPOSE MV-TRANSPOSE-VERDICT 0 0 MV-PACK  1  MIR-OP+ drop
1.0 XB 4 SEQ
EX-RESET  XB 0 EX-BIND  EX-RUN
0 EX-OUT@ 0 >I 1 T=
0 EX-OUT@ 1 >I 3 T=
...
MIR-RESET
4 2 DT-F32 LAY-ROW MIR-INPUT+ drop
OP-SLICE MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+
   2 2 DT-F32 LAY-ROW  MV-SLICE MVV-FREE 1 3 MV-PACK  1  MIR-OP+ drop
...
MIR-RESET
3 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ data 3x2
2 1 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ idx 2x1
OP-GATHER MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 MIR-IN-REF MIR-IN+
   2 2 DT-F32 LAY-ROW  MV-GATHER MV-GATHER-VERDICT 0 0 MV-PACK  1  MIR-OP+ drop
...
MIR-RESET
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop
OP-ROWSUM-BWD MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 2 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
1.0 XB 4 SEQ
EX-RESET  XB 0 EX-BIND  EX-RUN
0 EX-OUT@ 0 >I 4 T=
0 EX-OUT@ 1 >I 6 T=
...
MIR-RESET
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ ct 2x2
2 1 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ idx 2x1
OP-SCATTER-ADD MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 MIR-IN-REF MIR-IN+
   2 2 DT-F32 LAY-ROW  MV-GATHER MVV-MATERIALIZE 0 0 MV-PACK  1  MIR-OP+ drop
...
MIR-RESET
1 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ x
1 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ cos
1 2 DT-F32 LAY-ROW MIR-INPUT+ drop                   \ sin
OP-ROPE MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 MIR-IN-REF MIR-IN+ 2 MIR-IN-REF MIR-IN+
   1 2 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
...
2 2 DT-F32 LAY-ROW MIR-INPUT+ drop
OP-MATMUL MIR-OP-BEGIN 0 MIR-IN-REF MIR-IN+ 1 MIR-IN-REF MIR-IN+ 2 2 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
OP-GELU MIR-OP-BEGIN 0 MIR-IN+ 2 2 DT-F32 LAY-ROW 0 1 MIR-OP+ drop
