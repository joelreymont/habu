...
: G-GAMMA-BAD ( -- )                 \ pre-LN gamma 2xC vs x 5xC: not 1xC row-broadcast -> reject
   TENSOR:TV-RESET
   GT GC SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC
   2  GC SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC
   MAKI-OPKIND:LAYERNORM EW-SHAPE-CHECK ;
: G-RESID-BAD ( -- )                 \ residual skip 4xC vs running value 5xC: unequal -> reject
   TENSOR:TV-RESET
   GT GC SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC
   4  GC SHAPE MAKI-DATATYPE:DF32 MAKI-LAYOUT:ROW SPACE-HOST TENSOR:TV-DESC
