...
: PLAN-MM-DESC ( tensor tensor -- tensor ) {: x:tensor w:tensor :}
   ...
   LAY-ROW x TENSOR:TV-SPACE@ TENSOR:TV-DESC ;
...
: PLAN-RESHAPE ( tensor CAD-KIND:rows CAD-KIND:cols -- tensor )
   ...
   x TENSOR:TV-LAYOUT@ {: lay:CAD-KIND:layout :}
   tr tc x TENSOR:TV-DTYPE@ lay x TENSOR:TV-SPACE@ TENSOR:TV-DESC {: y:tensor :}
   MV-RESHAPE lay MV-RESHAPE-VERDICT
...
: PLAN-SLICE ( tensor CAD-KIND:rows CAD-KIND:rows -- tensor )
   ...
   r1 r0 ROWS- cols x TENSOR:TV-DTYPE@ x TENSOR:TV-LAYOUT@
   x TENSOR:TV-SPACE@ TENSOR:TV-DESC {: y:tensor :}
   MV-SLICE x TENSOR:TV-LAYOUT@
