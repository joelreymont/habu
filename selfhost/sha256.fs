\ selfhost/sha256.fs — SHA-256 in the STANDALONE's Forth (decimal constants, DO/LOOP,
\ no move/fill/hex). Ported from src/cg/sha256.fs so the standalone can self-sign its
