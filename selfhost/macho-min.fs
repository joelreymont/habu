...
\ HDR ( clen -- ) builds the header + load commands + slack to CODEOFF; clen is the
\ __text section size. Callers then emit clen bytes of code and pad to MPAGE.
: HDR {: clen :}
  here MSTART !
  ...
  CODEOFF MPAD ;
: BUILD  12 HDR  3531605312 M32 3531604016 M32 3556773889 M32  MPAGE MPAD ;
