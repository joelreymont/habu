...
- For repair loops, run the native checker script:
  `bin/hb --load lib/errors.f lib/string.f lib/fs.f lib/fs-mutate.f lib/process.f lib/process-argv.f lib/source.f tools/lint/text.f tools/lint/token.f tools/lint/lib.f tools/diag-origin-core.f tools/argv.f tools/check.f -- --json-errors --all-errors file.f`.
