...
- Work:
  ...
  - implement options actually used upstream, including `:type list`, `:named`, and `:print-function`,
  - implement slot initform/default semantics and constructor defaulting,
